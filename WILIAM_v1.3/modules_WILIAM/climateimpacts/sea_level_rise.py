...
@component.add(
    name="adjusted sensitivity of sea level rise to temperature",
...
@component.add(
    name="adjusted temperature change from preindustrial for SLR estimation",
    units="DegreesC",
    comp_type="Auxiliary",
    comp_subtype="Normal",
...
@component.add(
    name="Change in Relative Temperature",
    units="DegreesC/Year",
    comp_type="Stateful",
    comp_subtype="Smooth",
    depends_on={
...
@component.add(
    name="check shares between two methods of calculation of sea level rise",
    units="DMNL",
    comp_type="Auxiliary",
    comp_subtype="Normal",
...
@component.add(
    name="equilibrium change in sea level",
    units="mm/Year",
    comp_type="Auxiliary",
    comp_subtype="Normal",
    depends_on={
...
@component.add(
    name="instant change in sea level",
    units="mm/Year",
    comp_type="Auxiliary",
    comp_subtype="Normal",
    depends_on={
...
def sea_level_rise_for_world():
    ...
    return (
        sum(
            sea_level_rise_by_region().rename({"REGIONS 9 I": "REGIONS 9 I!"}),
            dim=["REGIONS 9 I!"],
        )
        / 9
    )
...
@component.add(
    name="sea level rise from mm to m",
    units="m",
    comp_type="Auxiliary",
    comp_subtype="Normal",
