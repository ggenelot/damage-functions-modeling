...
def al_costs():
    ...
    """
    return float(al_grade_cost().loc["HIGH GRADE"]) * float(
        mining_al_known_reserves().loc["HIGH GRADE"]
    ) + float(al_grade_cost().loc["LOW GRADE"]) * float(
        mining_al_known_reserves().loc["LOW GRADE"]
    )


@component.add(
    name="Al cumulative mining",
    units="Mt",
    comp_type="Stateful",
    comp_subtype="Integ",
...
@component.add(
    name="Al DEMAND DEVELOPMENT WOLRD 7",
    units="Mt/Year",
    comp_type="Auxiliary",
...
@component.add(
    name="Al DEMAND DEVELOPMENT WORLD ALUMINIUM",
    units="Mt/Year",
    comp_type="Auxiliary",
    comp_subtype="with Lookup",
    depends_on={"time": 1},
...
@component.add(
    name="Al demand HISTORICAL WORLD 7",
    units="Mt/Year",
    comp_type="Data",
    comp_subtype="External",
    depends_on={
...
@component.add(
    name="Al demand including semifinished products",
    units="Mt/Year",
    comp_type="Auxiliary",
    comp_subtype="Normal",
    depends_on={
...
def al_demand_price_reponse():
    ...
    """
    return (
        float(price_sensitivity_s_curve_fit().loc["A S CURVE FIT"])
        * (
            1
            - np.exp(
                -float(price_sensitivity_s_curve_fit().loc["k S CURVE FIT"])
                * al_price_economy()
                ** float(price_sensitivity_s_curve_fit().loc["n S CURVE FIT"])
            )
        )
        + 1
    )
...
@component.add(
    name="Al DEMAND SCALING FACTOR FOR SEMI FINISHED PRODUCTS",
    units="1/Year",
    comp_type="Constant",
    comp_subtype="Normal",
)
...
@component.add(
    name="Al ENERGY NEEDED FOR DIFFERENT GRADE",
    units="TJ/Mt",
...
_ext_constant_al_energy_needed_for_different_grade = ExtConstant(
    ...
    {"Al ORE GRADES I": _subscript_dict["Al ORE GRADES I"]},
    _root,
    {"Al ORE GRADES I": _subscript_dict["Al ORE GRADES I"]},
...
def al_energy_use():
    ...
    """
    return (
        float(al_energy_use_ore_grades_mining().loc["HIGH GRADE"])
        + float(al_energy_use_ore_grades_mining().loc["LOW GRADE"])
        + al_energy_use_recycling()
    )


@component.add(
    name="Al energy use ore grades mining",
    units="TJ/Year",
    subscripts=["Al ORE GRADES I"],
    comp_type="Auxiliary",
    comp_subtype="Normal",
...
def al_energy_use_ore_grades_mining():
    ...
    value.loc[["HIGH GRADE"]] = (
        float(mining_al_known_reserves().loc["HIGH GRADE"])
        * float(al_energy_needed_for_different_grade().loc["HIGH GRADE"])
        / imv_al_energy_efficiency()
    )
    value.loc[["LOW GRADE"]] = (
        float(mining_al_known_reserves().loc["LOW GRADE"])
        * float(al_energy_needed_for_different_grade().loc["LOW GRADE"])
        / imv_al_energy_efficiency()
    )
    return value
...
@component.add(
    name="Al ENERGY USE TOE COEFFICIENT",
    units="Mt*OE/TJ",
    comp_type="Constant",
    comp_subtype="External",
...
@component.add(
    name="Al ENERGY USE TOE COEFFICIENT TWO",
    units="DMNL",
    comp_type="Constant",
    comp_subtype="External",
...
def al_eol_recycling_rate_sp():
    ...
    """
    return float(eol_recycling_rates_minerals_base_metals().loc["Al W"])


@component.add(
    name="Al extraction coefficient",
    units="1/Year",
    comp_type="Auxiliary",
    comp_subtype="Normal",
    depends_on={"coefficients_al_production_rate_factor": 1, "decrease_al_profit": 1},
)
def al_extraction_coefficient():
    ...
    """
    return coefficients_al_production_rate_factor() * decrease_al_profit() * 1
...
@component.add(
    name="Al grades hidden resources to Al reserves",
    units="Mt/Year",
    subscripts=["Al ORE GRADES I"],
    comp_type="Auxiliary",
    comp_subtype="Normal",
...
def al_grades_hidden_resources_to_al_reserves():
    ...
    value.loc[["HIGH GRADE"]] = (
        al_prospecting()
        * float(al_hidden_resources().loc["HIGH GRADE"])
        * change_al_mining_technology_s_curve()
    )
    value.loc[["LOW GRADE"]] = (
        al_prospecting()
        * change_al_mining_technology_s_curve()
        * float(al_hidden_resources().loc["LOW GRADE"])
    )
    return value


@component.add(
    name="Al hidden resources",
    units="Mt",
    subscripts=["Al ORE GRADES I"],
    comp_type="Stateful",
    comp_subtype="Integ",
...
@component.add(
    name="Al in use per person",
    units="Mt/Billion People",
    comp_type="Auxiliary",
    comp_subtype="Normal",
    depends_on={"al_stocks_in_use": 1, "world_population": 1},
)
def al_in_use_per_person():
    """
    Aluminium in use per person.
    """
    return al_stocks_in_use() / world_population()
...
@component.add(
    name="Al low grade change price",
    units="DMNL",
    comp_type="Auxiliary",
    comp_subtype="Normal",
...
def al_low_grade_change_price():
    ...
    """
    return float(coefficients_change_al_grade().loc["A S CURVE FIT"]) * (
        1
        - np.exp(
            -float(coefficients_change_al_grade().loc["k S CURVE FIT"])
            * al_price_economy()
            ** float(coefficients_change_al_grade().loc["n S CURVE FIT"])
        )
    )
...
@component.add(
    name="Al MATERIAL YIELD IN MANUFACTURE",
    units="DMNL",
    comp_type="Constant",
    comp_subtype="External",
...
def al_mined():
    ...
    """
    return float(mining_al_known_reserves().loc["HIGH GRADE"]) + float(
        mining_al_known_reserves().loc["LOW GRADE"]
    )


@component.add(
    name="Al mined and Al recycled EOL",
    units="Mt/Year",
    comp_type="Auxiliary",
    comp_subtype="Normal",
...
@component.add(
    name="Al modified demand WORLD7",
    units="Mt/Year",
    comp_type="Stateful",
    comp_subtype="DelayFixed",
...
def al_price():
    ...
    """
    return float(al_price_exp_fit().loc["A EXP CURVE"]) * np.exp(
        -float(al_price_exp_fit().loc["B EXP CURVE"]) * al_market()
    )


@component.add(
    name="Al price economy",
    units="$/t",
    comp_type="Auxiliary",
    comp_subtype="Normal",
    depends_on={
...
def al_price_economy():
    ...
    return if_then_else(
        ...
        lambda: if_then_else(
            ...
            lambda: np.exp(
                float(coefficients_al_price_economy().loc["A EXP CURVE"])
                + float(coefficients_al_price_economy().loc["B EXP CURVE"])
                * np.log(
                    1 / (1 - al_demand() / al_available_delayed())
                    + float(coefficients_al_price_economy().loc["C EXP CURVE"]) * 0.8
                )
            ),
        ),
    )
...
@component.add(
    name="Al price economy adjusted",
    units="DMNL",
    comp_type="Auxiliary",
    comp_subtype="Normal",
...
def al_price_index_economy():
    ...
    return if_then_else(
        ...
        lambda: 100,
        lambda: (
            float(estimated_price_with_tax_metals().loc["Al W"]) / al_base_price_2006()
        )
...
@component.add(
    name="Al primary share IAI projection",
    units="DMNL",
    comp_type="Auxiliary",
    comp_subtype="Normal",
...
@component.add(
    name="Al profit effect on mining",
    units="Mdollars/Year",
    comp_type="Auxiliary",
    comp_subtype="Normal",
    depends_on={
    ...
    return if_then_else(
        ...
        lambda: if_then_else(
            ...
            * np.exp(
            ...
            lambda: float(
                coefficients_al_profit_effect_on_mining_s_curve().loc["A S CURVE FIT"]
            )
            / (
                1
                + np.exp(
...
def al_recycling_drive():
    ...
    return (
        1
        / float(recycling_drive_exp_fit().loc["B EXP CURVE"])
        * np.exp(
            (float(recycling_drive_exp_fit().loc["A EXP CURVE"]) + al_price_economy())
            / float(recycling_drive_exp_fit().loc["B EXP CURVE"])
        )
    )
...
@component.add(
    name="Al recycling drive scaling",
    units="1/Year",
    comp_type="Auxiliary",
    comp_subtype="Normal",
...
@component.add(
    name="Al RECYCLING SCALING FACTOR",
    units="DMNL",
    comp_type="Constant",
    comp_subtype="Normal",
)
...
@component.add(
    name="Al SCRAP LOSS", units="1/Year", comp_type="Constant", comp_subtype="Normal"
)
def al_scrap_loss():
    """
...
@component.add(
    name="Al secondary share IAI projection",
    units="DMNL",
    comp_type="Auxiliary",
    comp_subtype="Normal",
...
@component.add(
    name="Al share of secondary material",
    units="DMNL",
    comp_type="Auxiliary",
    comp_subtype="Normal",
    depends_on={
...
@component.add(
    name="Al water use for ore extraction",
    units="MtW/Year",
    comp_type="Auxiliary",
    comp_subtype="Normal",
...
def al_water_use_for_ore_extraction():
    ...
    """
    return float(al_water_use_per_per_ore_grade().loc["HIGH GRADE"]) + float(
        al_water_use_per_per_ore_grade().loc["LOW GRADE"]
    )


@component.add(
    name="Al WATER USE PER ORE GRADE",
    units="MtW/Mt",
    subscripts=["Al ORE GRADES I"],
    comp_type="Constant",
    comp_subtype="External",
...
@component.add(
    name="Al water use per per ore grade",
    units="MtW/Year",
    subscripts=["Al ORE GRADES I"],
    comp_type="Auxiliary",
    comp_subtype="Normal",
...
def al_water_use_per_per_ore_grade():
    ...
    value.loc[["HIGH GRADE"]] = (
        float(al_water_use_per_ore_grade().loc["HIGH GRADE"])
        * imv_al_mining_water_use_efficiency()
    ) * float(mining_al_known_reserves().loc["HIGH GRADE"])
    value.loc[["LOW GRADE"]] = (
        float(al_water_use_per_ore_grade().loc["LOW GRADE"])
        * imv_al_mining_water_use_efficiency()
    ) * float(mining_al_known_reserves().loc["LOW GRADE"])
    return value
...
@component.add(
    name="change Al mining technology S curve",
    units="DMNL",
    comp_type="Auxiliary",
    comp_subtype="Normal",
...
def change_al_mining_technology_s_curve():
    ...
    """
    return float(
        coefficients_change_al_mining_technology_s_curve().loc["A S CURVE FIT"]
    ) / (
        1
        + np.exp(
            -float(
                coefficients_change_al_mining_technology_s_curve().loc["k S CURVE FIT"]
            )
            * (
                time()
                - float(
...
@component.add(
    name="COEFFICIENTS Al PRICE ECONOMY",
    units="DMNL",
    subscripts=["EXP CURVE FIT I"],
    comp_type="Constant",
    comp_subtype="External",
...
@component.add(
    name="COEFFICIENTS Al PRODUCTION RATE FACTOR",
    units="DMNL",
    comp_type="Constant",
    comp_subtype="External",
...
@component.add(
    name="COEFFICIENTS Al PROFIT EFFECT ON MINING LOGISTIC",
    units="DMNL",
...
@component.add(
    name="COEFFICIENTS Al PROFIT EFFECT ON MINING S CURVE",
    units="DMNL",
...
@component.add(
    name="COEFFICIENTS CHANGE Al GRADE",
    units="DMNL",
    subscripts=["S CURVE FIT I"],
    comp_type="Constant",
    comp_subtype="External",
...
@component.add(
    name="COEFFICIENTS CHANGE Al MINING TECHNOLOGY S CURVE",
    units="DMNL",
    subscripts=["S CURVE FIT I"],
    comp_type="Constant",
    comp_subtype="External",
...
@component.add(
    name="decrease Al scrapped metal loss",
    units="Mt/Year",
    comp_type="Auxiliary",
    comp_subtype="Normal",
    depends_on={
...
@component.add(
    name="decrease Al scrapped metal recycling",
    units="Mt/Year",
    comp_type="Auxiliary",
    comp_subtype="Normal",
    depends_on={
...
@component.add(
    name="decrease Al stock in use loss",
    units="Mt/Year",
    comp_type="Auxiliary",
    comp_subtype="Normal",
...
@component.add(
    name="DECREASE FAKTOR Al PROFIT",
    units="1/Year",
    comp_type="Constant",
    comp_subtype="External",
...
@component.add(
    name="decrease stock in use scrap",
    units="Mt/Year",
    comp_type="Auxiliary",
    comp_subtype="Normal",
...
@component.add(
    name="delayed TS Al price economy adjusted",
    units="DMNL",
    comp_type="Stateful",
    comp_subtype="DelayFixed",
...
@component.add(
    name="energy use in oil equivalents",
    units="Mt*OE/Year",
    comp_type="Auxiliary",
    comp_subtype="Normal",
...
@component.add(
    name="ENERGY USE IN OIL EQUIVALENTS SCALE",
    units="Mt*OE/TJ",
    comp_type="Constant",
    comp_subtype="External",
...
@component.add(
    name="Energy use per supplied aluminium unit",
    units="Mt*OE/Mt",
    comp_type="Auxiliary",
    comp_subtype="Normal",
...
@component.add(
    name="IMV Al MINING AND REFINING IMPROVEMENT TECHNOLOGY",
    units="Years",
    comp_type="Auxiliary",
    comp_subtype="with Lookup",
    depends_on={"time": 1},
...
@component.add(
    name="IMV AL MINING WATER USE EFFICIENCY",
    units="DMNL",
    comp_type="Auxiliary",
    comp_subtype="with Lookup",
    depends_on={"time": 1},
...
@component.add(
    name="IMV Al TARGET DEMAND PER PERSON",
    units="kg/person",
    comp_type="Auxiliary",
    comp_subtype="with Lookup",
    depends_on={"time": 1},
...
@component.add(
    name="IMV ALUMINUM MINING HISTORICAL",
    units="Mt/Year",
    comp_type="Auxiliary",
    comp_subtype="Normal",
    depends_on={
...
@component.add(
    name="IMV UNIT CONVERSION TON TO MILLION TON",
    units="Mt/t",
    comp_type="Constant",
    comp_subtype="Normal",
)
...
@component.add(
    name="increase Al scrapped metal",
    units="Mt/Year",
    comp_type="Auxiliary",
    comp_subtype="Normal",
...
@component.add(
    name="INITIAL Al CUMULATIVE MINING",
    units="Mt",
    comp_type="Constant",
    comp_subtype="Normal",
)
...
@component.add(
    name="INITIAL Al HIDDEN RESOURCES",
    units="Mt",
    subscripts=["Al ORE GRADES I"],
    comp_type="Constant",
    comp_subtype="External",
...
@component.add(
    name="INITIAL Al KNOWN RESERVES",
    units="Mt",
    subscripts=["Al ORE GRADES I"],
    comp_type="Constant",
    comp_subtype="External",
...
@component.add(
    name="INITIAL Al PRICE", units="$/t", comp_type="Constant", comp_subtype="Normal"
)
def initial_al_price():
    """
    The Aluminium price of the year 2005 in $/t GET DIRECT CONSTANTS('model_parameters/materials/materials.xlsx', 'Aluminium', 'INITIAL_Al_PRICE') 1853
    """
    return 2553


@component.add(
    name="INITIAL Al PROFIT DELAY",
    units="DMNL",
    comp_type="Constant",
    comp_subtype="Normal",
)
...
@component.add(
    name="INITIAL Al SCRAPPED METAL",
    units="Mt",
    comp_type="Constant",
    comp_subtype="Normal",
)
...
def mining_al_known_reserves():
    ...
    value.loc[["HIGH GRADE"]] = np.maximum(
        float(al_known_reseveres().loc["HIGH GRADE"]) * al_extraction_coefficient(), 0
    )
    value.loc[["LOW GRADE"]] = np.maximum(
        al_low_grade_change_price()
        * al_extraction_coefficient()
        * float(al_known_reseveres().loc["LOW GRADE"])
...
@component.add(
    name="PRICE SENSITIVITY S CURVE FIT",
    units="DMNL",
    subscripts=["S CURVE FIT I"],
    comp_type="Constant",
    comp_subtype="External",
...
@component.add(
    name="Scaling Factor low", units="DMNL", comp_type="Constant", comp_subtype="Normal"
)
def scaling_factor_low():
    """
    Scaling Factor to to match historical production
    """
    return 0.75


@component.add(
    name="Share of Primary",
    units="DMNL",
    comp_type="Auxiliary",
    comp_subtype="with Lookup",
    depends_on={"time": 1},
...
@component.add(
    name="SWITCH Al RECYCLING POLICY",
    units="DMNL",
    comp_type="Constant",
    comp_subtype="Normal",
)
...
def total_al_known_reserves():
    ...
    return xr.DataArray(
        sum(
            al_known_reseveres().rename({"Al ORE GRADES I": "Al ORE GRADES I!"}),
            dim=["Al ORE GRADES I!"],
        ),
...
@component.add(
    name="Total Secondary new and old scrap",
    units="Mt/Year",
    comp_type="Auxiliary",
    comp_subtype="Normal",
    depends_on={
