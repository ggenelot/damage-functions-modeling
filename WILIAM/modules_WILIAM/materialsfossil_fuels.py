"""
Module materialsfossil_fuels
Translated using PySD version 3.14.0
"""

@component.add(
    name="actual spare capacity",
    units="DMNL",
    comp_type="Auxiliary",
    comp_subtype="Normal",
...
@component.add(
    name="actual spare capacity gas",
    units="DMNL",
    comp_type="Auxiliary",
    comp_subtype="Normal",
...
@component.add(
    name="AVERAGE COAL MINING CAPACITY",
    units="Mt/mines/Year",
...
_ext_constant_average_coal_mining_capacity = ExtConstant(
    ...
    {"COAL TYPES I": _subscript_dict["COAL TYPES I"]},
    _root,
    {"COAL TYPES I": _subscript_dict["COAL TYPES I"]},
...
@component.add(
    name="BROWN COAL RESOURCE ESTIMATION HIGH SP",
    units="EJ",
    subscripts=["COAL TYPES I"],
    comp_type="Constant",
    comp_subtype="External",
...
@component.add(
    name="BROWN COAL RESOURCE ESTIMATION LOW SP",
    units="EJ",
    subscripts=["COAL TYPES I"],
    comp_type="Constant",
    comp_subtype="External",
...
@component.add(
    name="BROWN COAL RESOURCE ESTIMATION MED SP",
    units="EJ",
    subscripts=["COAL TYPES I"],
    comp_type="Constant",
    comp_subtype="External",
...
def coal_base_price_2015():
    """
    Base price for the year 2015 in $ per ton
    """
    return 75.1643
...
def coal_extraction_in_mt():
    ...
    """
    return float(extraction_of_coal().loc["HARD COAL"]) * float(
        unit_conversion_mt_ej().loc["HARD COAL"]
    ) + float(extraction_of_coal().loc["BROWN COAL"]) * float(
        unit_conversion_mt_ej().loc["BROWN COAL"]
    )


@component.add(
    name="coal gap between total available and demand",
    units="DMNL",
    comp_type="Auxiliary",
    comp_subtype="Normal",
    depends_on={
...
@component.add(
    name="COAL MINE DEPLETION RATE", comp_type="Constant", comp_subtype="Normal"
)
...
@component.add(
    name="COAL MINES INVESTMENT CAP",
    units="DMNL/Year",
    comp_type="Constant",
    comp_subtype="External",
...
@component.add(
    name="Coal price economy adjusted",
    units="DMNL/Year",
...
def coal_price_economy_adjusted():
    return xr.DataArray(
        if_then_else(
            time() < 2015,
            lambda: 100,
            lambda: float(coal_price_index_economy().loc["Coal W"]),
        ),
...
def coal_price_index_economy():
    return xr.DataArray(
        if_then_else(
            ...
            lambda: 100,
            lambda: (
                float(estimated_coal_price_with_tax().loc["Coal W"])
...
def coal_prospecting():
    ...
    value.loc[["HARD COAL"]] = (
        float(coal_resources().loc["HARD COAL"]) * coal_prospecting_rate()
    )
    value.loc[["BROWN COAL"]] = (
        float(coal_resources().loc["BROWN COAL"]) * coal_prospecting_rate()
    )
    return value


@component.add(
    name="COAL PROSPECTING RATE",
    units="1/Year",
    comp_type="Constant",
    comp_subtype="External",
...
def coal_reserves():
    ...
    value.loc[["HARD COAL"]] = _integ_coal_reserves().values
    value.loc[["BROWN COAL"]] = _integ_coal_reserves_1().values
    return value


_integ_coal_reserves = Integ(
    lambda: xr.DataArray(
        float(coal_prospecting().loc["HARD COAL"])
        - float(extraction_of_coal().loc["HARD COAL"]),
        {"COAL TYPES I": ["HARD COAL"]},
        ["COAL TYPES I"],
    ),
    lambda: xr.DataArray(
        float(initial_coal_reserves().loc["HARD COAL"]),
        {"COAL TYPES I": ["HARD COAL"]},
        ["COAL TYPES I"],
    ),
    "_integ_coal_reserves",
...
_integ_coal_reserves_1 = Integ(
    lambda: xr.DataArray(
        float(coal_prospecting().loc["BROWN COAL"])
        - float(extraction_of_coal().loc["BROWN COAL"]),
        {"COAL TYPES I": ["BROWN COAL"]},
        ["COAL TYPES I"],
    ),
    lambda: xr.DataArray(
        float(initial_coal_reserves().loc["BROWN COAL"]),
        {"COAL TYPES I": ["BROWN COAL"]},
        ["COAL TYPES I"],
    ),
    "_integ_coal_reserves_1",
...
@component.add(
    ...
    other_deps={
        "_integ_coal_resources": {
            "initial": {"initial_coal_resources": 1},
...
def coal_resources():
    ...
    value.loc[["HARD COAL"]] = _integ_coal_resources().values
    value.loc[["BROWN COAL"]] = _integ_coal_resources_1().values
    return value
...
_integ_coal_resources = Integ(
    ...
    lambda: xr.DataArray(
        float(initial_coal_resources().loc["HARD COAL"]),
        {"COAL TYPES I": ["HARD COAL"]},
        ["COAL TYPES I"],
    ),
    "_integ_coal_resources",
...
_integ_coal_resources_1 = Integ(
    ...
    lambda: xr.DataArray(
        float(initial_coal_resources().loc["BROWN COAL"]),
        {"COAL TYPES I": ["BROWN COAL"]},
        ["COAL TYPES I"],
    ),
    "_integ_coal_resources_1",
...
@component.add(
    name="COEFFICIENT ESTIMATED OIL PRICE",
    units="DMNL",
...
@component.add(
    name="COEFFICIENT GAS INVESTMENT",
    units="DMNL",
    subscripts=["LINEAR LOG FIT I"],
    comp_type="Constant",
    comp_subtype="External",
...
@component.add(
    name="COEFFICIENT MAX COAL PRICE",
    units="DMNL",
    comp_type="Constant",
    comp_subtype="External",
...
@component.add(
    name="COEFFICIENT MAXIMUM OIL PRICE",
    units="DMNL",
    comp_type="Constant",
    comp_subtype="External",
...
@component.add(
    name="COEFFICIENTS COAL MINE INVESTMENT",
    units="DMNL",
    subscripts=["LINEAR LOG FIT I"],
    comp_type="Constant",
    comp_subtype="External",
...
@component.add(
    name="COEFFICIENTS ESTIMATED PRICE",
    units="DMNL",
    subscripts=["EXP CURVE FIT I"],
    comp_type="Constant",
    comp_subtype="External",
...
_ext_constant_coefficients_estimated_price = ExtConstant(
    ...
    {"EXP CURVE FIT I": _subscript_dict["EXP CURVE FIT I"]},
    _root,
    {"EXP CURVE FIT I": _subscript_dict["EXP CURVE FIT I"]},
...
@component.add(
    name="COEFFICIENTS ESTIMATED PRICE GAS",
    units="DMNL",
    subscripts=["EXP CURVE FIT I"],
    comp_type="Constant",
    comp_subtype="External",
...
@component.add(
    name="COEFFICIENTS ESTIMATED PRICE GAS AFTER 2020",
    units="DMNL",
    subscripts=["EXP CURVE FIT I"],
    comp_type="Constant",
    comp_subtype="External",
    depends_on={
        "__external__": "_ext_constant_coefficients_estimated_price_gas_after_2020"
    },
)
def coefficients_estimated_price_gas_after_2020():
    """
    Parameter of the LN function for calculating the price in $/Btu. The Parameters are derived from fitting the historical data of the Gas. A EXP CURVE -1.326 B EXP CURVE -0.0319 C EXP CURVE 0.814
    """
    return _ext_constant_coefficients_estimated_price_gas_after_2020()


_ext_constant_coefficients_estimated_price_gas_after_2020 = ExtConstant(
    "model_parameters/materials/materials.xlsx",
    "Hydrocarbons",
    "COEFFICIENTS_ESTIMATED_PRICE_GAS_WITHOUT_OIL*",
    {"EXP CURVE FIT I": _subscript_dict["EXP CURVE FIT I"]},
    _root,
    {"EXP CURVE FIT I": _subscript_dict["EXP CURVE FIT I"]},
    "_ext_constant_coefficients_estimated_price_gas_after_2020",
)


@component.add(
    name="COEFFICIENTS WELL INVESTMENT",
    units="DMNL",
    subscripts=["LINEAR LOG FIT I"],
    comp_type="Constant",
    comp_subtype="External",
...
@component.add(
    name="COEFFIECIENTS OPEC SPARE CAP",
    units="DMNL",
    subscripts=["EXP CURVE FIT I"],
    comp_type="Constant",
    comp_subtype="External",
...
@component.add(
    name="cumulative coal extracted",
    units="EJ",
    subscripts=["COAL TYPES I"],
    comp_type="Stateful",
    comp_subtype="Integ",
...
def cumulative_coal_extracted():
    ...
    value.loc[["HARD COAL"]] = _integ_cumulative_coal_extracted().values
    value.loc[["BROWN COAL"]] = _integ_cumulative_coal_extracted_1().values
    return value


_integ_cumulative_coal_extracted = Integ(
    lambda: xr.DataArray(
        float(total_coal_mined().loc["HARD COAL"]),
        {"COAL TYPES I": ["HARD COAL"]},
        ["COAL TYPES I"],
    ),
    lambda: xr.DataArray(
        float(initial_coal_cumulatively_extracted_2005().loc["HARD COAL"]),
        {"COAL TYPES I": ["HARD COAL"]},
        ["COAL TYPES I"],
    ),
    "_integ_cumulative_coal_extracted",
...
_integ_cumulative_coal_extracted_1 = Integ(
    lambda: xr.DataArray(
        float(total_coal_mined().loc["BROWN COAL"]),
        {"COAL TYPES I": ["BROWN COAL"]},
        ["COAL TYPES I"],
    ),
    lambda: xr.DataArray(
        float(initial_coal_cumulatively_extracted_2005().loc["BROWN COAL"]),
        {"COAL TYPES I": ["BROWN COAL"]},
        ["COAL TYPES I"],
    ),
    "_integ_cumulative_coal_extracted_1",
...
@component.add(
    name="cumulative total oil extraction",
    units="bbl",
    comp_type="Stateful",
    comp_subtype="Integ",
...
@component.add(
    name="delayed estimated Gas price",
    units="$/Btu",
    comp_type="Stateful",
    comp_subtype="DelayFixed",
    depends_on={"_delayfixed_delayed_estimated_gas_price": 1},
    other_deps={
        "_delayfixed_delayed_estimated_gas_price": {
            "initial": {"time_step": 1},
            "step": {"estimated_gas_price": 1},
        }
    },
)
def delayed_estimated_gas_price():
    """
    Delayed Gas price
    """
    return _delayfixed_delayed_estimated_gas_price()


_delayfixed_delayed_estimated_gas_price = DelayFixed(
...
@component.add(
    name="delayed estimated Oil price",
    units="$/bbl",
    comp_type="Stateful",
    comp_subtype="DelayFixed",
...
@component.add(
    name="delayed first estimated Gas price",
    comp_type="Stateful",
    comp_subtype="DelayFixed",
    depends_on={"_delayfixed_delayed_first_estimated_gas_price": 1},
    other_deps={
        "_delayfixed_delayed_first_estimated_gas_price": {
            "initial": {"time_step": 1},
            "step": {"first_estimated_gas_price": 1},
        }
    },
)
def delayed_first_estimated_gas_price():
    return _delayfixed_delayed_first_estimated_gas_price()


_delayfixed_delayed_first_estimated_gas_price = DelayFixed(
    lambda: first_estimated_gas_price(),
    lambda: time_step(),
    lambda: 100,
    time_step,
    "_delayfixed_delayed_first_estimated_gas_price",
...
@component.add(
    name="delayed first estimated Oil price",
    units="$/bbl",
    comp_type="Stateful",
    comp_subtype="DelayFixed",
...
@component.add(
    name="delayed TS coal price economy adjusted",
    units="DMNL",
    comp_type="Stateful",
    comp_subtype="DelayFixed",
...
_delayfixed_delayed_ts_coal_price_economy_adjusted = DelayFixed(
    lambda: float(coal_price_economy_adjusted().loc["Coal W"]),
    lambda: time_step(),
    lambda: 100,
    time_step,
    "_delayfixed_delayed_ts_coal_price_economy_adjusted",
...
@component.add(
    name="delayed TS gas price economy adjusted",
    units="DMNL",
    comp_type="Stateful",
    comp_subtype="DelayFixed",
...
@component.add(
    name="delayed TS oil price economy adjusted",
    units="DMNL",
    comp_type="Stateful",
    comp_subtype="DelayFixed",
...
@component.add(
    name="DEPLETION FACTOR AFTER PEAK",
    units="DMNL",
    comp_type="Constant",
    comp_subtype="External",
...
@component.add(
    name="DEPLETION FACTOR AFTER PEAK COAL",
    units="DMNL",
    comp_type="Constant",
    comp_subtype="Normal",
)
...
def depletion_of_coal_mines():
    ...
    value.loc[["HARD COAL"]] = float(
        number_of_operating_coal_mines().loc["HARD COAL"]
    ) * float(increase_in_depletion_after_peak_coal().loc["HARD COAL"])
    value.loc[["BROWN COAL"]] = float(
        number_of_operating_coal_mines().loc["BROWN COAL"]
    ) * float(increase_in_depletion_after_peak_coal().loc["BROWN COAL"])
    return value


@component.add(
    name="depletion of extraction capacity",
    units="EJ/Year",
    comp_type="Auxiliary",
    comp_subtype="Normal",
...
@component.add(
    name="desired desired gas extraction capacity",
    units="EJ/Year",
    comp_type="Auxiliary",
    comp_subtype="Normal",
    depends_on={
...
def desired_desired_gas_extraction_capacity():
    ...
    return if_then_else(
        ...
        lambda: 0,
        lambda: float(coefficient_gas_investment().loc["A LINEAR LOG FIT"])
        + float(coefficient_gas_investment().loc["B LINEAR LOG FIT"])
        * (estimated_gas_price() * 1.1),
    )


@component.add(
    name="desired new coal mines",
    units="mines/Year",
    comp_type="Auxiliary",
    comp_subtype="Normal",
...
def desired_new_coal_mines():
    ...
    """
    return (
        float(coefficients_coal_mine_investment().loc["A LINEAR LOG FIT"])
        + float(coefficients_coal_mine_investment().loc["B LINEAR LOG FIT"])
        * estimated_coal_price()
    )


@component.add(
    name="desired Oil wells",
    units="wells/Year",
    comp_type="Auxiliary",
    comp_subtype="Normal",
    depends_on={
...
def desired_oil_wells():
    ...
    return if_then_else(
        ...
        lambda: 0,
        lambda: float(coefficients_well_investment().loc["A LINEAR LOG FIT"])
        + float(coefficients_well_investment().loc["B LINEAR LOG FIT"])
        * estimated_oil_price(),
    )


@component.add(
    name="estimated coal price",
    units="$/t",
    comp_type="Auxiliary",
    comp_subtype="Normal",
...
def estimated_coal_price():
    ...
    """
    return np.exp(
        float(coefficients_estimated_price().loc["A EXP CURVE"])
        + float(coefficients_estimated_price().loc["B EXP CURVE"])
        * ln_of_the_coal_spare_cap()
    )


@component.add(
    name="estimated coal price with tax",
    units="$/t",
    subscripts=["HYDROCARBONS W I"],
    comp_type="Auxiliary",
    comp_subtype="Normal",
...
def estimated_coal_price_with_tax():
    return xr.DataArray(
        if_then_else(
            ...
            + estimated_coal_price()
            * float(tax_rate_on_extraction_of_resources_sp().loc["Coal W"]),
            lambda: estimated_coal_price(),
        ),
        {"HYDROCARBONS W I": _subscript_dict["HYDROCARBONS W I"]},
        ["HYDROCARBONS W I"],
...
def estimated_gas_price():
    """
    Estimated Gas price, after fluctuation filters.
    """
    return if_then_else(
        np.logical_and(select_gas_price_oil_link_sp() == 1, time() <= 2020),
        lambda: first_estimated_gas_price(),
        lambda: if_then_else(
            time() <= 2015,
            lambda: first_estimated_gas_price(),
            lambda: if_then_else(
                switch_gas_price_growth_limit() == 1,
                lambda: delayed_estimated_gas_price()
                * (1 + estimated_gas_price_variation()),
                lambda: first_estimated_gas_price(),
            ),
        ),
    )
...
@component.add(
    name="estimated Gas price variation",
    units="DMNL",
    comp_type="Auxiliary",
    comp_subtype="Normal",
    depends_on={
        "delayed_first_estimated_gas_price": 4,
        "max_gas_price_for_limit": 1,
        "gas_price_growth_limit": 4,
        "first_estimated_gas_price": 3,
    },
)
def estimated_gas_price_variation():
    """
    Variation in the Gas price, function serves as a filter.
    """
    return if_then_else(
        delayed_first_estimated_gas_price() > max_gas_price_for_limit(),
        lambda: gas_price_growth_limit(),
        lambda: if_then_else(
            zidz(first_estimated_gas_price(), delayed_first_estimated_gas_price()) - 1
            < gas_price_growth_limit(),
            lambda: np.maximum(
                zidz(first_estimated_gas_price(), delayed_first_estimated_gas_price())
                - 1,
                -gas_price_growth_limit(),
            ),
            lambda: np.minimum(
...
@component.add(
    name="estimated gas price with tax",
    units="$/million Btu",
    subscripts=["HYDROCARBONS W I"],
    comp_type="Auxiliary",
    comp_subtype="Normal",
...
def estimated_gas_price_with_tax():
    ...
    return xr.DataArray(
        if_then_else(
            ...
            lambda: estimated_gas_price()
            * float(tax_rate_on_extraction_of_resources_sp().loc["Gas W"])
            + estimated_gas_price(),
            lambda: estimated_gas_price(),
        ),
        {"HYDROCARBONS W I": _subscript_dict["HYDROCARBONS W I"]},
...
@component.add(
    name="estimated Oil price variation",
    units="DMML",
    comp_type="Auxiliary",
    comp_subtype="Normal",
    depends_on={
...
@component.add(
    name="estimated oil price with tax",
    units="$/bbl",
    subscripts=["HYDROCARBONS W I"],
    comp_type="Auxiliary",
    comp_subtype="Normal",
...
def estimated_oil_price_with_tax():
    ...
    return xr.DataArray(
        if_then_else(
            ...
            lambda: estimated_oil_price()
            + estimated_oil_price()
            * float(tax_rate_on_extraction_of_resources_sp().loc["Oil W"]),
            lambda: estimated_oil_price(),
        ),
        {"HYDROCARBONS W I": _subscript_dict["HYDROCARBONS W I"]},
        ["HYDROCARBONS W I"],
...
@component.add(
    name="estimated price with tax metals",
    units="$/t",
...
def estimated_price_with_tax_metals():
    ...
    value.loc[["Cu W"]] = if_then_else(
        ...
        + cu_price_economy()
        * float(tax_rate_on_extraction_of_resources_sp().loc["Cu W"]),
        lambda: cu_price_economy(),
    )
    value.loc[["Al W"]] = if_then_else(
        np.logical_and(
            time() >= initial_year_tax_rate_on_extraction_of_resources_sp(),
            switch_tax_rate_on_extraction_of_resources_sp() == 1,
        ),
        ...
        + al_price_economy()
        * float(tax_rate_on_extraction_of_resources_sp().loc["Al W"]),
        lambda: al_price_economy(),
    )
    value.loc[["Fe W"]] = if_then_else(
        np.logical_and(
            time() >= initial_year_tax_rate_on_extraction_of_resources_sp(),
            switch_tax_rate_on_extraction_of_resources_sp() == 1,
        ),
        ...
        + fe_price_economy()
        * float(tax_rate_on_extraction_of_resources_sp().loc["Fe W"]),
        lambda: fe_price_economy(),
    )
    value.loc[["Ni W"]] = if_then_else(
        np.logical_and(
            time() >= initial_year_tax_rate_on_extraction_of_resources_sp(),
            switch_tax_rate_on_extraction_of_resources_sp() == 1,
        ),
        ...
        + ni_price_economy()
        * float(tax_rate_on_extraction_of_resources_sp().loc["Ni W"]),
        lambda: ni_price_economy(),
    )
    return value
...
@component.add(
    name="extraction capacity of Gas",
    units="EJ",
    comp_type="Stateful",
    comp_subtype="Integ",
...
def extraction_of_coal():
    ...
    value.loc[["HARD COAL"]] = float(
        total_coal_production_capacity_ej().loc["HARD COAL"]
    )
    value.loc[["BROWN COAL"]] = float(
        total_coal_production_capacity_ej().loc["BROWN COAL"]
    )
    return value


@component.add(
    name="extraction of gas",
    units="EJ/Year",
    comp_type="Auxiliary",
    comp_subtype="Normal",
...
@component.add(
    name="first estimated Gas price",
    units="$/million Btu",
    comp_type="Auxiliary",
    comp_subtype="Normal",
    depends_on={
...
def first_estimated_gas_price():
    ...
    return if_then_else(
        np.logical_and(select_gas_price_oil_link_sp() == 1, time() <= 2020),
        lambda: np.exp(
            float(coefficients_estimated_price_gas().loc["A EXP CURVE"])
            + float(coefficients_estimated_price_gas().loc["B EXP CURVE"])
            * np.log(1 / gas_extraction_capacity_excluding_spare_capacity())
            + float(coefficients_estimated_price_gas().loc["C EXP CURVE"])
            * np.log(estimated_oil_price())
        ),
        lambda: np.exp(
            float(coefficients_estimated_price_gas_after_2020().loc["A EXP CURVE"])
            + float(coefficients_estimated_price_gas_after_2020().loc["B EXP CURVE"])
            * np.log(1 / gas_extraction_capacity_excluding_spare_capacity())
        ),
    )
...
@component.add(
    name="first estimated Oil price",
    units="$/bbl",
    comp_type="Auxiliary",
    comp_subtype="Normal",
    depends_on={
...
def first_estimated_oil_price():
    ...
    """
    return np.exp(
        float(coefficient_estimated_oil_price().loc["A LINEAR LOG FIT"])
        + float(coefficient_estimated_oil_price().loc["B LINEAR LOG FIT"])
        * np.log(1 / oil_extraction_spare_capacity_excluding_opec())
    )


@component.add(
    name="Gas base price 2015",
    units="$/million Btu",
    comp_type="Constant",
    comp_subtype="External",
...
@component.add(
    name="Gas extraction capacity excluding spare capacity",
    units="DMNL",
    comp_type="Auxiliary",
    comp_subtype="Normal",
...
@component.add(
    name="Gas extraction without spare cap",
    units="EJ",
    comp_type="Auxiliary",
    comp_subtype="Normal",
    depends_on={"gas_max_extraction_capacity": 1, "actual_spare_capacity_gas": 1},
...
@component.add(
    name="Gas max extraction capacity",
    units="EJ/Year",
    comp_type="Auxiliary",
    comp_subtype="Normal",
...
@component.add(
    name="Gas price econmy adjusted 1",
    units="DMNL",
    comp_type="Auxiliary",
    comp_subtype="Normal",
...
def gas_price_econmy_adjusted_1():
    ...
    return if_then_else(
        time() < 2015,
        lambda: 100,
        lambda: float(gas_price_index_economy_0().loc["Gas W"]),
    )


@component.add(
    name="GAS PRICE GROWTH LIMIT",
    units="DMNL",
    comp_type="Constant",
    comp_subtype="Normal",
)
def gas_price_growth_limit():
    return 0.2


@component.add(
    name="GAS PRICE HISTORICAL",
    units="$/Btu",
    comp_type="Data",
    comp_subtype="External",
    depends_on={
...
@component.add(
    name="Gas price index economy 0",
    units="DMNL",
    subscripts=["HYDROCARBONS W I"],
    comp_type="Auxiliary",
    comp_subtype="Normal",
...
def gas_price_index_economy_0():
    ...
    return xr.DataArray(
        if_then_else(
            ...
            lambda: 100,
            lambda: (
                float(estimated_gas_price_with_tax().loc["Gas W"])
                / gas_base_price_2015()
            )
            * price_transformation(),
        ),
...
@component.add(
    name="GAS RESOURCE ESTIMATION HIGH SP",
    units="EJ",
    comp_type="Constant",
    comp_subtype="External",
...
@component.add(
    name="GAS RESOURCE ESTIMATION LOW SP",
    units="EJ",
    comp_type="Constant",
    comp_subtype="External",
...
@component.add(
    name="GAS RESOURCE ESTIMATION MED SP",
    units="EJ",
    comp_type="Constant",
    comp_subtype="External",
...
@component.add(
    name="GAS RESOURCE ESTIMATION USER DEFINED SP",
    units="EJ",
    comp_type="Constant",
    comp_subtype="External",
    depends_on={
...
@component.add(
    name="HARD COAL RESOURCE ESTIMATION HIGH SP",
    units="EJ",
    comp_type="Constant",
    comp_subtype="External",
...
@component.add(
    name="HARD COAL RESOURCE ESTIMATION LOW SP",
    units="EJ",
    comp_type="Constant",
    comp_subtype="External",
...
@component.add(
    name="HARD COAL RESOURCE ESTIMATION MED SP",
    units="EJ",
    comp_type="Constant",
    comp_subtype="External",
...
@component.add(
    name="HISTORICAL COAL DEMAND TWO",
    units="EJ/Year",
    comp_type="Data",
    comp_subtype="External",
    depends_on={
...
@component.add(
    name="HISTORICAL CONSUMPTION COAL PER YEAR",
    units="EJ/Year",
    comp_type="Auxiliary",
    comp_subtype="with Lookup",
    depends_on={"time": 1},
...
@component.add(
    name="increase in depletion after peak coal",
    units="1/Year",
    subscripts=["COAL TYPES I"],
    comp_type="Auxiliary",
    comp_subtype="Normal",
...
def increase_in_depletion_after_peak_coal():
    ...
    value.loc[["HARD COAL"]] = if_then_else(
        float(urr_coal_int().loc["HARD COAL"]) / 2
        <= float(cumulative_coal_extracted().loc["HARD COAL"]),
        lambda: (
            float(cumulative_coal_extracted().loc["HARD COAL"])
            / float(urr_coal_int().loc["HARD COAL"])
        )
        / 3,
        lambda: 0.03,
    )
    value.loc[["BROWN COAL"]] = if_then_else(
        float(urr_coal_int().loc["BROWN COAL"]) / 2
        <= float(cumulative_coal_extracted().loc["BROWN COAL"]),
        lambda: (
            float(cumulative_coal_extracted().loc["BROWN COAL"])
            / float(urr_coal_int().loc["BROWN COAL"])
        )
        / 3,
        lambda: 0.03,
    )
...
@component.add(
    name="increase in depletion gas",
    units="1/Year",
    comp_type="Auxiliary",
    comp_subtype="Normal",
...
@component.add(
    name="INITIAL COAL CUMULATIVELY EXTRACTED 2005",
    units="EJ",
    subscripts=["COAL TYPES I"],
    comp_type="Auxiliary",
    comp_subtype="Normal",
...
def initial_coal_cumulatively_extracted_2005():
    ...
    value.loc[["HARD COAL"]] = initial_total_coal_extracted() * float(
        share_of_coal_type().loc["HARD COAL"]
    )
    value.loc[["BROWN COAL"]] = initial_total_coal_extracted() * float(
        share_of_coal_type().loc["BROWN COAL"]
    )
    return value


@component.add(
    name="INITIAL COAL HIDDEN 2005",
    units="EJ",
    subscripts=["COAL TYPES I"],
    comp_type="Auxiliary",
    comp_subtype="Normal",
    depends_on={"initial_coal_resources": 2},
)
def initial_coal_hidden_2005():
    """
    INITIAL value for the remaining Coal which still needs to be discovered.
    """
    value = xr.DataArray(
        np.nan, {"COAL TYPES I": _subscript_dict["COAL TYPES I"]}, ["COAL TYPES I"]
    )
    value.loc[["HARD COAL"]] = float(initial_coal_resources().loc["HARD COAL"])
    value.loc[["BROWN COAL"]] = float(initial_coal_resources().loc["BROWN COAL"])
    return value


@component.add(
    name="INITIAL COAL RESERVES",
    units="EJ",
    subscripts=["COAL TYPES I"],
    comp_type="Constant",
    comp_subtype="External",
...
def initial_coal_resources():
    ...
    value.loc[["BROWN COAL"]] = if_then_else(
        ...
        lambda: float(brown_coal_resource_estimation_low_sp().loc["BROWN COAL"]),
        lambda: if_then_else(
            select_brown_coal_resource_estimation_sp() == 1,
            lambda: float(brown_coal_resource_estimation_med_sp().loc["BROWN COAL"]),
            lambda: if_then_else(
                select_brown_coal_resource_estimation_sp() == 2,
                lambda: float(
                    brown_coal_resource_estimation_high_sp().loc["BROWN COAL"]
                ),
                lambda: 0,
            ),
        ),
...
@component.add(
    name="INITIAL EXTRACTION CAPACITY",
    units="EJ",
    comp_type="Constant",
    comp_subtype="External",
...
@component.add(
    name="INITIAL NUMBER OF OPERATING COAL MINES 2008",
    units="mines",
    subscripts=["COAL TYPES I"],
    comp_type="Constant",
    comp_subtype="External",
...
@component.add(
    name="INITIAL OIL CUMULATIVELY EXTRACTED 2005",
    units="bbl",
    comp_type="Constant",
    comp_subtype="External",
    depends_on={
...
@component.add(
    name="INITIAL OIL PRODUCTION PER YEAR",
    units="bbl/Year",
    comp_type="Constant",
    comp_subtype="External",
...
@component.add(
    name="INITIAL OIL RESERVES 2005",
    units="bbl",
    comp_type="Constant",
    comp_subtype="External",
...
@component.add(
    name="INITIAL TOTAL COAL EXTRACTED",
    units="EJ",
    comp_type="Constant",
    comp_subtype="External",
...
@component.add(
    name="INITIAL TOTAL GAS EXTRACTED",
    units="EJ",
    comp_type="Constant",
    comp_subtype="External",
...
@component.add(
    name="INITIAL YEAR TAX RATE ON EXTRACTION OF RESOURCES SP",
    units="Year",
    comp_type="Constant",
    comp_subtype="External",
    depends_on={
...
def investment_in_coal_mines():
    ...
    value.loc[["HARD COAL"]] = if_then_else(
        float(reserves_in_operating_coal_mines().loc["HARD COAL"])
        < float(coal_reserves().loc["HARD COAL"]),
        lambda: float(seperation_of_mining_types().loc["HARD COAL"]),
        lambda: 0,
    )
    value.loc[["BROWN COAL"]] = if_then_else(
        float(reserves_in_operating_coal_mines().loc["BROWN COAL"])
        < float(coal_reserves().loc["BROWN COAL"]),
        lambda: float(seperation_of_mining_types().loc["BROWN COAL"]),
        lambda: 0,
    )
    return value
...
@component.add(
    name="investment in Gas extraction capacity",
    units="EJ/Year",
    comp_type="Auxiliary",
    comp_subtype="Normal",
    depends_on={
        "actual_spare_capacity_gas": 1,
        "min_spare_cap_gas": 1,
        "max_invest_in_gas_extraction_capacity": 3,
...
def investment_in_gas_extraction_capacity():
    ...
    """
    return if_then_else(
        actual_spare_capacity_gas() <= min_spare_cap_gas(),
...
@component.add(
    name="Laherrere 2018 estimate per year",
    units="bbl/Year",
    comp_type="Auxiliary",
    comp_subtype="Normal",
...
@component.add(
    name="Laherrere CURVE 2018 total oil",
    units="Mbbl/Year",
    comp_type="Auxiliary",
    comp_subtype="with Lookup",
    depends_on={"time": 1},
...
@component.add(
    name="MAX GAS PRICE FOR LIMIT",
    units="$/Btu",
    comp_type="Constant",
    comp_subtype="External",
    depends_on={"__external__": "_ext_constant_max_gas_price_for_limit"},
)
def max_gas_price_for_limit():
    """
    Maximum of the gas price, before the gas price growth limit is kicking in.
    """
    return _ext_constant_max_gas_price_for_limit()


_ext_constant_max_gas_price_for_limit = ExtConstant(
    "model_parameters/materials/materials.xlsx",
    "Hydrocarbons",
    "MAX_GAS_PRICE_FOR_LIMIT",
    {},
    _root,
    {},
    "_ext_constant_max_gas_price_for_limit",
)


@component.add(
    name="max invest in Gas extraction capacity",
    units="EJ/Year",
    comp_type="Stateful",
    comp_subtype="Delay",
    depends_on={
...
@component.add(
    name="max investment in Coal mines",
    units="mines/Year",
    comp_type="Stateful",
    comp_subtype="Delay",
    depends_on={
...
_delay_max_investment_in_coal_mines = Delay(
    lambda: float(number_of_operating_coal_mines().loc["HARD COAL"])
    + float(number_of_operating_coal_mines().loc["BROWN COAL"]),
    lambda: 1,
    lambda: float(number_of_operating_coal_mines().loc["HARD COAL"])
    + float(number_of_operating_coal_mines().loc["BROWN COAL"]),
    lambda: 1,
...
@component.add(
    name="MIN SPARE CAP GAS",
    units="DMNL",
    comp_type="Constant",
    comp_subtype="External",
    depends_on={"__external__": "_ext_constant_min_spare_cap_gas"},
)
def min_spare_cap_gas():
    """
    Min spare capacity, if spare cap falls below this capacity maximum investement in gas extraction capacity is triggered.
    """
    return _ext_constant_min_spare_cap_gas()


_ext_constant_min_spare_cap_gas = ExtConstant(
    "model_parameters/materials/materials.xlsx",
    "Hydrocarbons",
    "MIN_SPARE_CAP_GAS",
    {},
    _root,
    {},
    "_ext_constant_min_spare_cap_gas",
)


@component.add(
    name="MINIMUM GAS PRICE FOR INVESTMENT",
    units="$/million Btu",
    comp_type="Constant",
    comp_subtype="External",
...
@component.add(
    name="MINIMUM OIL PRICE FOR INVESTMENT",
    units="$/bbl",
    comp_type="Constant",
    comp_subtype="External",
...
@component.add(
    name="Number of operating coal mines",
    units="mines",
    subscripts=["COAL TYPES I"],
    comp_type="Stateful",
    comp_subtype="Integ",
...
def number_of_operating_coal_mines():
    ...
    value.loc[["HARD COAL"]] = _integ_number_of_operating_coal_mines().values
    value.loc[["BROWN COAL"]] = _integ_number_of_operating_coal_mines_1().values
    return value


_integ_number_of_operating_coal_mines = Integ(
    lambda: xr.DataArray(
        float(investment_in_coal_mines().loc["HARD COAL"])
        - float(depletion_of_coal_mines().loc["HARD COAL"]),
        {"COAL TYPES I": ["HARD COAL"]},
        ["COAL TYPES I"],
    ),
    lambda: xr.DataArray(
        float(initial_number_of_operating_coal_mines_2008().loc["HARD COAL"]),
        {"COAL TYPES I": ["HARD COAL"]},
        ["COAL TYPES I"],
    ),
    "_integ_number_of_operating_coal_mines",
...
_integ_number_of_operating_coal_mines_1 = Integ(
    lambda: xr.DataArray(
        float(investment_in_coal_mines().loc["BROWN COAL"])
        - float(depletion_of_coal_mines().loc["BROWN COAL"]),
        {"COAL TYPES I": ["BROWN COAL"]},
        ["COAL TYPES I"],
    ),
    lambda: xr.DataArray(
        float(initial_number_of_operating_coal_mines_2008().loc["BROWN COAL"]),
        {"COAL TYPES I": ["BROWN COAL"]},
        ["COAL TYPES I"],
    ),
    "_integ_number_of_operating_coal_mines_1",
...
@component.add(
    name="Oil available daily without OPEC spare cap",
    units="bbl/day",
    comp_type="Auxiliary",
    comp_subtype="Normal",
...
@component.add(
    name="Oil extraction spare capacity excluding OPEC",
    units="DMNL",
    comp_type="Auxiliary",
    comp_subtype="Normal",
    depends_on={
...
@component.add(
    name="OIL Laherrere 2018 modified",
    comp_type="Auxiliary",
    comp_subtype="with Lookup",
    depends_on={"time": 1},
)
...
@component.add(
    name="Oil max extraction capacity",
    units="bbl/Year",
    comp_type="Auxiliary",
    comp_subtype="Normal",
...
@component.add(
    name="Oil price economy adjusted",
    units="DMNL",
    comp_type="Auxiliary",
    comp_subtype="Normal",
...
def oil_price_economy_adjusted():
    ...
    return if_then_else(
        time() < 2015,
        lambda: 100,
        lambda: float(oil_price_index_economy().loc["Oil W"]),
    )


@component.add(
    name="OIL PRICE GROWTH LIMIT",
    units="DMNL",
    comp_type="Constant",
    comp_subtype="External",
...
def oil_price_index_economy():
    ...
    return xr.DataArray(
        if_then_else(
            ...
            lambda: (
                float(estimated_oil_price_with_tax().loc["Oil W"])
                / oil_base_price_2006()
            )
            * price_transformation(),
        ),
...
@component.add(
    name="OIL RESOURCE ESTIMATION HIGH SP",
    units="bbl",
    comp_type="Constant",
    comp_subtype="External",
...
@component.add(
    name="OIL RESOURCE ESTIMATION LOW SP",
    units="bbl",
    comp_type="Constant",
    comp_subtype="External",
...
@component.add(
    name="OIL RESOURCE ESTIMATION MED SP",
    units="bbl",
    comp_type="Constant",
    comp_subtype="External",
...
@component.add(
    name="OIL RESOURCE ESTIMATION USER DEFINED SP",
    units="bbl",
    comp_type="Constant",
    comp_subtype="External",
    depends_on={
...
@component.add(
    name="Oil resources to known reserves",
    units="bbl/Year",
    comp_type="Auxiliary",
    comp_subtype="Normal",
...
@component.add(
    name="OIL WELL DEPLETION RATE BEFORE PEAK",
    units="1/Year",
    comp_type="Constant",
    comp_subtype="External",
    ...
    return if_then_else(
            ...
            lambda: if_then_else(
                ...
                lambda: if_then_else(
                    ...
                    lambda: if_then_else(
                        ...
                        lambda: if_then_else(
                            (
                                float(coeffiecients_opec_spare_cap().loc["A EXP CURVE"])
                                + float(
                                    coeffiecients_opec_spare_cap().loc["B EXP CURVE"]
                                )
                                * select_opec_target_price()
                                + float(
                                    coeffiecients_opec_spare_cap().loc["C EXP CURVE"]
                                )
        ...
        lambda: if_then_else(
            ...
            lambda: if_then_else(
                (
                    float(coeffiecients_opec_spare_cap().loc["A EXP CURVE"])
                    + float(coeffiecients_opec_spare_cap().loc["B EXP CURVE"])
                    * select_opec_target_price()
                    + float(coeffiecients_opec_spare_cap().loc["C EXP CURVE"])
                    * (1 - oil_demand_per_day() / oil_max_daily())
                )
                * 1000000.0
                <= 0,
...
@component.add(
    name="OPEC TARGET PRICE LOW MED HIGH OTHER SP",
    units="$/bbl",
    comp_type="Data",
    comp_subtype="External",
    depends_on={
...
@component.add(
    name="reserves in operating coal mines",
    units="EJ",
    subscripts=["COAL TYPES I"],
    comp_type="Auxiliary",
    comp_subtype="Normal",
...
def reserves_in_operating_coal_mines():
    ...
    value.loc[["HARD COAL"]] = float(
        total_coal_production_capacity_ej().loc["HARD COAL"]
    ) * (1 / float(increase_in_depletion_after_peak_coal().loc["HARD COAL"]))
    value.loc[["BROWN COAL"]] = float(
        total_coal_production_capacity_ej().loc["BROWN COAL"]
    ) * (1 / float(increase_in_depletion_after_peak_coal().loc["BROWN COAL"]))
    return value


@component.add(
    name="SELECT BROWN COAL RESOURCE ESTIMATION SP",
    units="DMML",
    comp_type="Constant",
    comp_subtype="External",
    depends_on={
...
@component.add(
    name="SELECT GAS PRICE OIL LINK SP",
    units="DMNL",
    comp_type="Constant",
    comp_subtype="External",
    depends_on={"__external__": "_ext_constant_select_gas_price_oil_link_sp"},
)
def select_gas_price_oil_link_sp():
    """
    SELECT, it can take two values: 0: the link between the gas and oil price is switched off 1: the link between the gas and the oil price is switched on (better corresponding to past trends).
    """
    return _ext_constant_select_gas_price_oil_link_sp()


_ext_constant_select_gas_price_oil_link_sp = ExtConstant(
    "scenario_parameters/scenario_parameters.xlsx",
    "materials",
    "SELECT_GAS_PRICE_OIL_LINK_SP",
    {},
    _root,
    {},
    "_ext_constant_select_gas_price_oil_link_sp",
)


@component.add(
    name="SELECT GAS RESOURCE ESTIMATION SP",
    units="DMNL",
    comp_type="Constant",
    comp_subtype="External",
...
@component.add(
    name="SELECT HARD COAL RESOURCE ESTIMATION SP",
    units="DMML",
    comp_type="Constant",
    comp_subtype="External",
    depends_on={
...
@component.add(
    name="SELECT OIL RESOURCE ESTIMATION SP",
    units="DMNL",
    comp_type="Constant",
    comp_subtype="External",
...
@component.add(
    name="SELECT OPEC SCENARIO FOSSIL FUEL PAPER SP",
    units="DMNL",
    comp_type="Constant",
    comp_subtype="External",
    depends_on={
        "__external__": "_ext_constant_select_opec_scenario_fossil_fuel_paper_sp"
    },
)
def select_opec_scenario_fossil_fuel_paper_sp():
    """
    SELECT for the OPEC scenario used in the FOSSIL FUEL paper among 2 options: = 1 OPEC spare capacity is set to 3mbbl/day between 2017 to 2025. Than modified to either 0 mbbl/day or 6 mbbl/day. After 2030 the spare capacity is set to 3 mbbl/day. = 0 Opec spare capacity is determined by the OPEC target price.
    """
    return _ext_constant_select_opec_scenario_fossil_fuel_paper_sp()


_ext_constant_select_opec_scenario_fossil_fuel_paper_sp = ExtConstant(
    "scenario_parameters/scenario_parameters.xlsx",
    "materials",
    "SELECT_OPEC_SCENARIO_FOSSIL_FUEL_PAPER_SP",
    {},
    _root,
    {},
    "_ext_constant_select_opec_scenario_fossil_fuel_paper_sp",
)


@component.add(
    name="SELECT OPEC TARGET PRICE",
    units="$/bbl",
    comp_type="Auxiliary",
    comp_subtype="Normal",
    depends_on={
...
@component.add(
    name="seperation of mining types",
    units="mines/Year",
    subscripts=["COAL TYPES I"],
    comp_type="Auxiliary",
    comp_subtype="Normal",
...
def seperation_of_mining_types():
    ...
    value.loc[["HARD COAL"]] = if_then_else(
        ...
        * float(share_of_coal_type().loc["HARD COAL"]),
        lambda: np.maximum(
            desired_new_coal_mines() * float(share_of_coal_type().loc["HARD COAL"]), 0
        ),
    )
    value.loc[["BROWN COAL"]] = if_then_else(
        desired_new_coal_mines() > max_investment_in_coal_mines(),
        lambda: max_investment_in_coal_mines()
        * float(share_of_coal_type().loc["BROWN COAL"]),
        lambda: np.maximum(
            desired_new_coal_mines() * float(share_of_coal_type().loc["BROWN COAL"]), 0
        ),
    )
    return value
...
@component.add(
    name="SET OPEC SPARE CAPACITY BEFORE AND AFTER SCENARIO SP",
    units="bbl/day",
    comp_type="Constant",
    comp_subtype="External",
    depends_on={
...
@component.add(
    name="SET OPEC SPARE CAPACITY SP",
    units="bbl/day",
    comp_type="Constant",
    comp_subtype="External",
...
@component.add(
    name="sum of new coal mines per year",
    units="mines/Year",
    comp_type="Auxiliary",
    comp_subtype="Normal",
...
def sum_of_new_coal_mines_per_year():
    ...
    """
    return float(investment_in_coal_mines().loc["HARD COAL"]) + float(
        investment_in_coal_mines().loc["BROWN COAL"]
    )


@component.add(
    name="SWITCH GAS PRICE GROWTH LIMIT",
    units="DMNL",
    comp_type="Constant",
    comp_subtype="Normal",
)
def switch_gas_price_growth_limit():
    """
    Switch for the grothw limit of the Gas price Intermodule links SWITCH, it can take two values: 0: the gas price as no growth limit. 1: the gas price has a growth limit.
    """
    return 1


@component.add(
    name="SWITCH MAT2ECO COAL PRICE",
    units="DMNL",
    comp_type="Constant",
    comp_subtype="External",
...
@component.add(
    name="SWITCH NRG2MAT COAL DEMAND",
    units="DMNL",
    comp_type="Constant",
    comp_subtype="External",
...
@component.add(
    name="SWITCH NRG2MAT GAS DEMAND",
    units="DMNL",
    comp_type="Constant",
    comp_subtype="External",
...
def switch_nrg2mat_gas_demand():
    """
    Intermodule links SWITCH, it can take two values: 0: the link is broken, the intermodule variable is replaced by an exogenous parameter. 1: the link between modules is operational. GET DIRECT CONSTANTS('scenario_parameters/switches.xlsx', 'SWITCHES', 'SWITCH_NRG2MAT_GAS_DEMAND')
    """
...
@component.add(
    name="SWITCH NRG2MAT OIL DEMAND",
    units="DMNL",
    comp_type="Constant",
    comp_subtype="External",
...
@component.add(
    name="SWITCH OIL PRICE GROWTH LIMIT",
    units="DMNL",
    comp_type="Constant",
    comp_subtype="Normal",
)
...
@component.add(
    name="SWITCH TAX RATE ON EXTRACTION OF RESOURCES SP",
    units="DMNL",
    comp_type="Constant",
    comp_subtype="External",
    depends_on={
...
@component.add(
    name="TARGET PRICE 2020", units="$/bbl", comp_type="Constant", comp_subtype="Normal"
)
...
@component.add(
    name="TAX RATE ON EXTRACTION OF RESOURCES SP",
...
@component.add(
    name="tax revenue from hydrocarbons",
    units="Mdollars/Year",
    subscripts=["HYDROCARBONS W I"],
    comp_type="Auxiliary",
    comp_subtype="Normal",
...
def tax_revenue_from_hydrocarbons():
    ...
    value.loc[["Oil W"]] = (
        extraction_of_oil()
        * (float(estimated_oil_price_with_tax().loc["Oil W"]) - estimated_oil_price())
    ) / unit_conversion_dollars_mdollars()
    value.loc[["Gas W"]] = (
        unit_conversion_mmbtu_ej()
        * total_gas_extracted()
        * (float(estimated_gas_price_with_tax().loc["Gas W"]) - estimated_gas_price())
        / unit_conversion_dollars_mdollars()
    )
    value.loc[["Coal W"]] = (
...
def tax_revenue_from_metals():
    ...
    value.loc[["Cu W"]] = (
        unit_conversion_mdollarmt_dollart()
        * cu_market_sales()
        * (float(estimated_price_with_tax_metals().loc["Cu W"]) - cu_price_economy())
    )
    value.loc[["Al W"]] = (
        unit_conversion_mdollarmt_dollart()
        * al_market_sales()
        * (float(estimated_price_with_tax_metals().loc["Al W"]) - al_price_economy())
    )
    value.loc[["Fe W"]] = (
        unit_conversion_mdollarmt_dollart()
        * fe_market_sales()
        * (float(estimated_price_with_tax_metals().loc["Fe W"]) - fe_price_economy())
    )
    value.loc[["Ni W"]] = (
        unit_conversion_mdollarmt_dollart()
        * ni_market_sales()
        * (float(estimated_price_with_tax_metals().loc["Ni W"]) - ni_price_economy())
    )
    return value


@component.add(
    name="taxes on resources",
    units="Mdollars/Year",
    subscripts=["MATERIALS W I"],
    comp_type="Auxiliary",
    comp_subtype="Normal",
...
def taxes_on_resources():
    ...
    """
    value = xr.DataArray(
        np.nan, {"MATERIALS W I": _subscript_dict["MATERIALS W I"]}, ["MATERIALS W I"]
    )
    value.loc[["Oil W"]] = float(tax_revenue_from_hydrocarbons().loc["Oil W"])
    value.loc[["Gas W"]] = float(tax_revenue_from_hydrocarbons().loc["Gas W"])
    value.loc[["Coal W"]] = float(tax_revenue_from_hydrocarbons().loc["Coal W"])
    value.loc[["Cu W"]] = float(tax_revenue_from_metals().loc["Cu W"])
    value.loc[["Al W"]] = float(tax_revenue_from_metals().loc["Al W"])
    value.loc[["Fe W"]] = float(tax_revenue_from_metals().loc["Fe W"])
    value.loc[["Ni W"]] = float(tax_revenue_from_metals().loc["Ni W"])
    return value


@component.add(
    name="total coal available",
    units="EJ/Year",
    comp_type="Auxiliary",
    comp_subtype="Normal",
    depends_on={"total_coal_production_capacity_ej": 2},
...
def total_coal_available():
    ...
    """
    return float(total_coal_production_capacity_ej().loc["HARD COAL"]) + float(
        total_coal_production_capacity_ej().loc["BROWN COAL"]
    )


@component.add(
    name="total coal mined",
    units="EJ/Year",
    subscripts=["COAL TYPES I"],
    comp_type="Auxiliary",
    comp_subtype="Normal",
...
def total_coal_mined():
    ...
    value.loc[["HARD COAL"]] = float(extraction_of_coal().loc["HARD COAL"])
    value.loc[["BROWN COAL"]] = float(extraction_of_coal().loc["BROWN COAL"])
    return value


@component.add(
    name="total coal production capacity",
    units="Mt/Year",
    subscripts=["COAL TYPES I"],
    comp_type="Auxiliary",
    comp_subtype="Normal",
...
def total_coal_production_capacity():
    ...
    value.loc[["HARD COAL"]] = float(
        number_of_operating_coal_mines().loc["HARD COAL"]
    ) * float(average_coal_mining_capacity().loc["HARD COAL"])
    value.loc[["BROWN COAL"]] = float(
        number_of_operating_coal_mines().loc["BROWN COAL"]
    ) * float(average_coal_mining_capacity().loc["BROWN COAL"])
    return value


@component.add(
    name="total coal production capacity EJ",
    units="EJ/Year",
    subscripts=["COAL TYPES I"],
    comp_type="Auxiliary",
    comp_subtype="Normal",
...
def total_coal_production_capacity_ej():
    ...
    value.loc[["HARD COAL"]] = float(
        total_coal_production_capacity().loc["HARD COAL"]
    ) / float(unit_conversion_mt_ej().loc["HARD COAL"])
    value.loc[["BROWN COAL"]] = float(
        total_coal_production_capacity().loc["BROWN COAL"]
    ) / float(unit_conversion_mt_ej().loc["BROWN COAL"])
    return value


@component.add(
    name="total coal remaining resources",
    units="EJ",
    comp_type="Auxiliary",
    comp_subtype="Normal",
...
def total_coal_remaining_resources():
    ...
    """
    return sum(
        coal_resources().rename({"COAL TYPES I": "COAL TYPES I!"}),
        dim=["COAL TYPES I!"],
    )


@component.add(
    name="total coal reserves",
    units="EJ",
    subscripts=["COAL TYPES I"],
    comp_type="Auxiliary",
    comp_subtype="Normal",
...
def total_coal_reserves():
    ...
    return xr.DataArray(
        sum(
            coal_reserves().rename({"COAL TYPES I": "COAL TYPES I!"}),
            dim=["COAL TYPES I!"],
        ),
        {"COAL TYPES I": _subscript_dict["COAL TYPES I"]},
        ["COAL TYPES I"],
...
@component.add(
    name="total production capacity of coal",
    units="EJ/Year",
    comp_type="Auxiliary",
    comp_subtype="Normal",
    depends_on={"total_coal_production_capacity_ej": 2},
...
@component.add(
    name="UNIT CONVERSION MdollarMt dollart",
    units="(Mdollars/Mt)/($/t)",
    comp_type="Constant",
    comp_subtype="Normal",
)
...
@component.add(
    name="UNIT CONVERSION MMBTU EJ",
    units="million Btu/EJ",
    comp_type="Constant",
    comp_subtype="Normal",
)
...
@component.add(
    name="UNIT CONVERSION OIL bbl PER EJ",
    units="bbl/EJ",
    comp_type="Constant",
    comp_subtype="External",
    depends_on={"__external__": "_ext_constant_unit_conversion_oil_bbl_per_ej"},
)
def unit_conversion_oil_bbl_per_ej():
    """
    ...
    """
    return _ext_constant_unit_conversion_oil_bbl_per_ej()


_ext_constant_unit_conversion_oil_bbl_per_ej = ExtConstant(
    "model_parameters/materials/materials.xlsx",
    "Hydrocarbons",
    "oil_bbl_per_EJ",
    {},
    _root,
    {},
    "_ext_constant_unit_conversion_oil_bbl_per_ej",
)
...
def urr_coal_int():
    ...
    value.loc[["HARD COAL"]] = (
        float(initial_coal_cumulatively_extracted_2005().loc["HARD COAL"])
        + float(initial_coal_reserves().loc["HARD COAL"])
        + float(initial_coal_hidden_2005().loc["HARD COAL"])
    )
    value.loc[["BROWN COAL"]] = (
        float(initial_coal_hidden_2005().loc["BROWN COAL"])
        + float(initial_coal_reserves().loc["BROWN COAL"])
        + float(initial_coal_cumulatively_extracted_2005().loc["BROWN COAL"])
    )
    return value
...
def world_pe_coal_ej():
    ...
    """
    return float(world_pe_by_commodity().loc["PE coal"])


@component.add(
    name="world PE gas EJ",
    units="EJ/Year",
    comp_type="Auxiliary",
    comp_subtype="Normal",
    depends_on={"world_pe_by_commodity": 1},
...
def world_pe_gas_ej():
    ...
    """
    return float(world_pe_by_commodity().loc["PE natural gas"])


@component.add(
    name="world PE oil bbl",
    units="bbl/Year",
    comp_type="Auxiliary",
    comp_subtype="Normal",
    depends_on={"world_pe_by_commodity": 1, "unit_conversion_oil_bbl_per_ej": 1},
)
def world_pe_oil_bbl():
    ...
    """
    return (
        float(world_pe_by_commodity().loc["PE oil"]) * unit_conversion_oil_bbl_per_ej()
    )
