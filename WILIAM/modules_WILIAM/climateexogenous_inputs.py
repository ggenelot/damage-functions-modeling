"""
Module climateexogenous_inputs
Translated using PySD version 3.14.0
"""

@component.add(
    name="ARAGONITE SATURATION CONSTANT 1",
    units="1/(pH*pH)",
    comp_type="Constant",
    comp_subtype="Normal",
)
...
@component.add(
    name="ARAGONITE SATURATION CONSTANT 2",
    units="1/pH",
    comp_type="Constant",
    comp_subtype="Normal",
)
...
@component.add(
    name="BIOSTIMULATION COEFF INDEX",
    units="DMNL",
    limits=(0.6, 1.7),
    comp_type="Constant",
...
@component.add(
    name="BIOSTIMULATION COEFF MEAN",
    units="DMNL",
    limits=(0.3, 0.7),
    comp_type="Constant",
    comp_subtype="External",
...
@component.add(
    name="CH4 N2O INTERACTION COEFFIENT",
    units="w/(m*m)",
    comp_type="Constant",
    comp_subtype="External",
...
@component.add(
    name="CH4 RADIATIVE EFFICIENCY COEFFICIENT",
    units="w/(m*m)",
    comp_type="Constant",
    comp_subtype="External",
...
@component.add(
    name="CH4 TOTAL ANTHRO REST OF EMISSIONS RCP",
    units="Mt/Year",
    subscripts=["REGIONS 9 I", "RCP Scenario"],
    comp_type="Data",
    comp_subtype="Normal",
...
@component.add(
    name="CO2 RAD FORCE COEFFICIENT",
    units="w/(m*m)",
    comp_type="Constant",
    comp_subtype="External",
...
@component.add(
    name="CUMULATIVE CO2 EMISSIONS TO 2005",
    units="Gt",
...
@component.add(
    name="CUMULATIVE CO2 EMISSIONS TO 2005 W",
    units="GtonsCO2",
    comp_type="Constant",
    comp_subtype="External",
...
_ext_data_global_ch4_anthro_emissions_rcp = ExtData(
    ...
    "CH4_emissions",
    "interpolate",
    {"RCP SCENARIO I": _subscript_dict["RCP SCENARIO I"]},
    _root,
    {"RCP SCENARIO I": _subscript_dict["RCP SCENARIO I"]},
...
@component.add(
    name="GLOBAL HFC EMISSIONS RCP 2 6",
    units="t/Year",
...
@component.add(
    name="GLOBAL HFC EMISSIONS RCP 4 5",
    units="t/Year",
    subscripts=["HFC TYPE I"],
    comp_type="Data",
    comp_subtype="External",
...
@component.add(
    name="GLOBAL HFC EMISSIONS RCP 6 0",
    units="t/Year",
    subscripts=["HFC TYPE I"],
    comp_type="Data",
    comp_subtype="External",
...
@component.add(
    name="GLOBAL HFC EMISSIONS RCP 8 5",
    units="t/Year",
    subscripts=["HFC TYPE I"],
    comp_type="Data",
    comp_subtype="External",
...
_ext_constant_init_c_in_deep_ocean_per_meter = ExtConstant(
    ...
    {"LAYERS I": _subscript_dict["LAYERS I"]},
    _root,
    {"LAYERS I": _subscript_dict["LAYERS I"]},
...
@component.add(
    name="INIT C IN MIXED OCEAN PER METER",
    units="Gt/m",
    comp_type="Constant",
    comp_subtype="External",
...
@component.add(
    name="INIT CO2 IN ATMOSPHERE PPM",
    units="ppm",
    comp_type="Constant",
    comp_subtype="External",
...
@component.add(
    name="INITIAL SEA LEVEL RISE IN 2005",
    units="mm",
    limits=(-400.0, 400.0),
    comp_type="Constant",
    comp_subtype="External",
...
@component.add(
    name="N2O RADIATIVE EFFICIENCY COEFFICIENT",
    units="w/(m*m)",
    comp_type="Constant",
    comp_subtype="External",
...
@component.add(
    name="N2O TOTAL ANTHRO REST OF EMISSIONS RCP",
    units="Mt/Year",
    subscripts=["REGIONS 9 I", "RCP Scenario"],
    comp_type="Data",
    comp_subtype="Normal",
...
@component.add(
    name="PPM TO CALCULATE OCEANIC PH THRESHOLD",
    units="ppm",
    comp_type="Constant",
    comp_subtype="Normal",
)
...
@component.add(
    name="PROB AMAZ TP 2010 2200 C1",
    units="1/Year",
    comp_type="Constant",
    comp_subtype="External",
...
@component.add(
    name="PROB AMOC WEAKENING TP 2010 2100 C1",
    units="1/Year",
    comp_type="Constant",
    comp_subtype="Normal",
)
...
@component.add(
    name="PROB DAIS TP 2010 2200 C1",
    units="1/Year",
    comp_type="Constant",
    comp_subtype="External",
...
@component.add(
    name="PROB MGIS TP 2010 2200 C1",
    units="1/Year",
    comp_type="Constant",
    comp_subtype="External",
...
@component.add(
    name="PROB NINO TP 2010 2200 C1",
    units="1/Year",
    comp_type="Constant",
    comp_subtype="External",
...
@component.add(
    name="RESIDENTIAL TIME OF BIOMASS",
    units="Year",
    comp_type="Constant",
    comp_subtype="External",
...
@component.add(
    name="SAMPLE FOR MONTE CARLO ECS",
    units="DMNL",
    comp_type="Constant",
    comp_subtype="Normal",
)
...
@component.add(
    name="SEA LEVEL SENSITIVITY FROM ICE SHEET MELTING",
    units="DMNL",
    limits=(0.0, 1.0),
    comp_type="Constant",
    comp_subtype="External",
...
@component.add(
    name="SELECT RCP FOR EXOGENOUS GHG EMISSIONS SP",
    units="DMNL",
    comp_type="Constant",
    comp_subtype="External",
    depends_on={
...
@component.add(
    name="SELECTION ECS INPUT METHOD",
    units="DMNL",
    comp_type="Constant",
    comp_subtype="External",
...
@component.add(
    name="SENSITIVITY OF SEA LEVEL RISE TO TEMPERATURE",
...
@component.add(
    name="SENSITIVITY OF SLR RATE TO TEMP RATE",
    units="mm/DegreesC",
    limits=(-100.0, 100.0),
    comp_type="Constant",
    comp_subtype="External",
...
@component.add(
    name="SLR ICE SHEET MELTING YEAR",
    units="Year",
    comp_type="Constant",
    comp_subtype="External",
...
@component.add(
    name="TEMPERATURE CHANGE IN 1995",
    units="DegreesC",
    comp_type="Constant",
    comp_subtype="External",
