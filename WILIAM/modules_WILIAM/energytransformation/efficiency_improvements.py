...
@component.add(
    name="ANNUAL EFFICIENCY INCREASE PV SP",
    units="DMNL/Year",
    comp_type="Constant",
...
@component.add(
    name="EFFICIENCES MAX PV TECHNOLOGY",
    units="DMNL",
    subscripts=["PROTRA PP SOLAR PV SUBTECHNOLOGIES I"],
    comp_type="Constant",
    comp_subtype="External",
...
@component.add(
    name="efficiences PV technology panels",
    units="DMNL",
    subscripts=["PROTRA PP SOLAR PV SUBTECHNOLOGIES I"],
    comp_type="Stateful",
    comp_subtype="Integ",
...
@component.add(
    name="efficiency increase PV panels",
    units="1/Year",
    subscripts=["PROTRA PP SOLAR PV SUBTECHNOLOGIES I"],
    comp_type="Auxiliary",
    comp_subtype="Normal",
...
@component.add(
    name="HISTORIC PV MODULES EFFICIENCY",
    units="DMNL",
    subscripts=["PROTRA PP SOLAR PV SUBTECHNOLOGIES I"],
    comp_type="Lookup",
    comp_subtype="External",
...
@component.add(
    name="INITIAL AREA PV PANEL PER POWER",
    subscripts=["PROTRA PP SOLAR PV SUBTECHNOLOGIES I"],
    comp_type="Auxiliary",
    comp_subtype="Normal",
...
@component.add(
    name="INITIAL PV MODULES EFFICIENCY",
    units="DMNL",
    subscripts=["PROTRA PP SOLAR PV SUBTECHNOLOGIES I"],
    comp_type="Constant",
    comp_subtype="External",
...
@component.add(
    name="INITIAL YEAR EFFICIENCY INCREASE RATE PV SP",
    units="DMNL/Year",
    comp_type="Constant",
    comp_subtype="External",
    depends_on={
...
@component.add(
    name="IRRADIANCE STANDAR CONDITIONS",
    units="w/(m*m)",
    comp_type="Constant",
    comp_subtype="External",
...
@component.add(
    name="power per panel by PV technology",
    units="w/panel",
    subscripts=["PROTRA PP SOLAR PV SUBTECHNOLOGIES I"],
    comp_type="Auxiliary",
    comp_subtype="Normal",
