...
@component.add(
    name="AVERAGING TIME", units="Years", comp_type="Constant", comp_subtype="Normal"
)
def averaging_time():
    """
...
@component.add(
    name="COEFFICIENT Fe PROSPECTING",
    units="DMNL",
    comp_type="Constant",
    comp_subtype="External",
...
@component.add(
    name="COEFFICIENTS CHANGE GRADE",
    units="DMNL",
    subscripts=["S CURVE FIT ABC I", "ORE GRADES I"],
    comp_type="Constant",
    comp_subtype="Normal",
)
def coefficients_change_grade():
    ...
    value = xr.DataArray(
        ...
        ["S CURVE FIT ABC I", "ORE GRADES I"],
    )
    value.loc[["A S CURVE"], ["RICH GRADE"]] = 0
    value.loc[["A S CURVE"], ["HIGH GRADE"]] = 1.00059
    value.loc[["A S CURVE"], ["LOW GRADE"]] = 0.998491
    value.loc[["A S CURVE"], ["ULTRALOW GRADE"]] = 0.99849
    value.loc[["A S CURVE"], ["TRACE GRADE"]] = 0
    value.loc[["A S CURVE"], ["OCEANS GRADE"]] = 0
    value.loc[["B S CURVE"], ["RICH GRADE"]] = 0
    value.loc[["B S CURVE"], ["HIGH GRADE"]] = 0.0353348
    value.loc[["B S CURVE"], ["LOW GRADE"]] = 0.0760302
    value.loc[["B S CURVE"], ["ULTRALOW GRADE"]] = 0.0608257
    value.loc[["B S CURVE"], ["TRACE GRADE"]] = 0
    value.loc[["B S CURVE"], ["OCEANS GRADE"]] = 0
    value.loc[["C S CURVE"], ["RICH GRADE"]] = 0
    value.loc[["C S CURVE"], ["HIGH GRADE"]] = 136.818
    value.loc[["C S CURVE"], ["LOW GRADE"]] = 279.469
    value.loc[["C S CURVE"], ["ULTRALOW GRADE"]] = 524.335
    value.loc[["C S CURVE"], ["TRACE GRADE"]] = 0
    value.loc[["C S CURVE"], ["OCEANS GRADE"]] = 0
    return value


@component.add(
    name="COEFFICIENTS DEMAND BRAKES",
    units="DMNL",
...
@component.add(
    name="COEFFICIENTS Fe ENERGY USE",
    units="MJ/kg",
...
@component.add(
    name="COEFFICIENTS Fe MINING TECHNOLOGY",
    units="DMNL",
...
@component.add(
    name="COEFFICIENTS Fe PRODUCTION PRICE",
    units="DMNL",
    subscripts=["S CURVE FIT ABC I"],
    comp_type="Constant",
    comp_subtype="External",
...
@component.add(
    name="COEFFICIENTS Fe PROFIT RESPONSE",
    units="DMNL",
    subscripts=["S CURVE FIT ABC I"],
    comp_type="Constant",
    comp_subtype="External",
...
@component.add(
    name="COEFFICIENTS Fe PROSPECTING SHUT DOWN",
    units="DMNL",
    subscripts=["S CURVE FIT ABC I"],
    comp_type="Constant",
    comp_subtype="External",
...
@component.add(
    name="COEFFICIENTS Fe SOCIETY IN",
    units="DMNL",
    subscripts=["Fe SOCIETY I"],
    comp_type="Constant",
    comp_subtype="External",
...
_ext_constant_coefficients_fe_society_in = ExtConstant(
    ...
    {"Fe SOCIETY I": _subscript_dict["Fe SOCIETY I"]},
    _root,
    {"Fe SOCIETY I": _subscript_dict["Fe SOCIETY I"]},
...
@component.add(
    name="COEFFICIENTS Fe TECHNOLOGY",
    units="DMNL",
    subscripts=["S CURVE FIT ABC I"],
    comp_type="Constant",
    comp_subtype="External",
...
@component.add(
    name="coefficients global steel demand",
    units="DMNL",
    subscripts=["EQUATION SPLIT I", "S CURVE FIT ABC I"],
    comp_type="Constant",
    comp_subtype="External",
...
@component.add(
    name="COEFFICIENTS WATER PER Fe GRADE",
    units="MtW/Mt",
    subscripts=["ORE GRADES I"],
    comp_type="Constant",
    comp_subtype="External",
...
@component.add(
    name="delayed TS Fe price economy adjusted",
    units="DMNL",
    comp_type="Stateful",
...
def demand_brakes():
    ...
    """
    return float(
        coefficients_demand_brakes().loc["A LINEAR LOG FIT"]
    ) * fe_market_feedback_price() + float(
        coefficients_demand_brakes().loc["B LINEAR LOG FIT"]
    )


@component.add(
    name="DEMAND Fe BASE YEAR",
    units="Mt/Year",
    comp_type="Constant",
    comp_subtype="Normal",
)
...
@component.add(
    name="Fe base price 2015", units="$/t", comp_type="Constant", comp_subtype="Normal"
)
...
def fe_change_grade():
    ...
    value.loc[["HIGH GRADE"]] = float(
        coefficients_change_grade().loc["A S CURVE", "HIGH GRADE"]
    ) / (
        1
        + np.exp(
            -float(coefficients_change_grade().loc["B S CURVE", "HIGH GRADE"])
            * (
                fe_market_feedback_price()
                - float(coefficients_change_grade().loc["C S CURVE", "HIGH GRADE"])
            )
        )
    )
    value.loc[["LOW GRADE"]] = float(
        coefficients_change_grade().loc["A S CURVE", "LOW GRADE"]
    ) / (
        1
        + np.exp(
            -float(coefficients_change_grade().loc["B S CURVE", "LOW GRADE"])
            * (
                fe_market_feedback_price()
                - float(coefficients_change_grade().loc["C S CURVE", "LOW GRADE"])
            )
        )
    )
    value.loc[["ULTRALOW GRADE"]] = float(
        coefficients_change_grade().loc["A S CURVE", "ULTRALOW GRADE"]
    ) / (
        1
        + np.exp(
            -float(coefficients_change_grade().loc["B S CURVE", "ULTRALOW GRADE"])
            * (
                fe_market_feedback_price()
                - float(coefficients_change_grade().loc["C S CURVE", "ULTRALOW GRADE"])
            )
        )
    )
    value.loc[["TRACE GRADE"]] = 0
    value.loc[["OCEANS GRADE"]] = 0
    return value


@component.add(
    name="Fe corrosion lost",
    units="Mt/Year",
    subscripts=["Fe SOCIETY I"],
    comp_type="Auxiliary",
    comp_subtype="Normal",
...
@component.add(
    name="Fe DEMAND SHARES",
    units="DMNL",
    subscripts=["Fe DEMAND SHARES I"],
    comp_type="Constant",
    comp_subtype="External",
...
_ext_constant_fe_demand_shares = ExtConstant(
    ...
    "Iron",
    "Fe_DEMAND_SHARES*",
    {"Fe DEMAND SHARES I": _subscript_dict["Fe DEMAND SHARES I"]},
    _root,
    {"Fe DEMAND SHARES I": _subscript_dict["Fe DEMAND SHARES I"]},
...
def fe_discovery():
    ...
    """
    return (
        float(finding_fe().loc["RICH GRADE"])
        + float(finding_fe().loc["HIGH GRADE"])
        + float(finding_fe().loc["LOW GRADE"])
        + float(finding_fe().loc["ULTRALOW GRADE"])
    )
...
def fe_energy_use():
    ...
    value.loc[["RICH GRADE"]] = float(
        coefficients_fe_energy_use().loc["RICH GRADE"]
    ) * float(fe_mining().loc["RICH GRADE"])
    value.loc[["HIGH GRADE"]] = float(fe_mining().loc["HIGH GRADE"]) * float(
        coefficients_fe_energy_use().loc["HIGH GRADE"]
    )
    value.loc[["LOW GRADE"]] = float(fe_mining().loc["LOW GRADE"]) * float(
        coefficients_fe_energy_use().loc["LOW GRADE"]
    )
    value.loc[["ULTRALOW GRADE"]] = float(fe_mining().loc["ULTRALOW GRADE"]) * float(
        coefficients_fe_energy_use().loc["ULTRALOW GRADE"]
    )
    value.loc[["TRACE GRADE"]] = float(fe_mining().loc["TRACE GRADE"]) * float(
        coefficients_fe_energy_use().loc["TRACE GRADE"]
    )
    value.loc[["OCEANS GRADE"]] = 0
    return value
...
def fe_energy_use_extraction():
    ...
    return (
        (
            float(fe_energy_use().loc["HIGH GRADE"])
            + float(fe_energy_use().loc["LOW GRADE"])
            + float(fe_energy_use().loc["ULTRALOW GRADE"])
            + float(fe_energy_use().loc["TRACE GRADE"])
            + float(fe_energy_use().loc["RICH GRADE"])
        )
...
def fe_eol_recycling_rate_sp():
    ...
    """
    return float(eol_recycling_rates_minerals_base_metals().loc["Fe W"])


@component.add(
    name="Fe extraction cost",
    units="M$/Years",
    comp_type="Auxiliary",
    comp_subtype="Normal",
...
def fe_extraction_cost():
    ...
    """
    return (
        float(fe_mining().loc["RICH GRADE"]) * float(fe_grade_cost().loc["RICH GRADE"])
        + float(fe_mining().loc["HIGH GRADE"])
        * float(fe_grade_cost().loc["HIGH GRADE"])
        + float(fe_mining().loc["LOW GRADE"]) * float(fe_grade_cost().loc["LOW GRADE"])
        + float(fe_mining().loc["ULTRALOW GRADE"])
        * float(fe_grade_cost().loc["ULTRALOW GRADE"])
    )


@component.add(
    name="Fe final prospecting",
    units="1/Years",
    comp_type="Auxiliary",
    comp_subtype="Normal",
...
def fe_market_price_index():
    ...
    """
    return if_then_else(
        fe_market() < float(split_equation_fe().loc["EQUATION ONE"]),
        lambda: float(
            coefficients_fe_price_index().loc["A LINEAR LOG FIT", "EQUATION ONE"]
        )
        * fe_market()
        + float(coefficients_fe_price_index().loc["B LINEAR LOG FIT", "EQUATION ONE"]),
        lambda: if_then_else(
            np.logical_and(
                float(split_equation_fe().loc["EQUATION ONE"]) < fe_market(),
                fe_market() < float(split_equation_fe().loc["EQUATION TWO"]),
            ),
            lambda: float(
                coefficients_fe_price_index().loc["A LINEAR LOG FIT", "EQUATION TWO"]
            )
            * np.exp(
                float(
                    coefficients_fe_price_index().loc[
                        "B LINEAR LOG FIT", "EQUATION TWO"
                    ]
                )
                * fe_market()
            ),
            lambda: float(
                coefficients_fe_price_index().loc["A LINEAR LOG FIT", "EQUATION THREE"]
            )
            * np.exp(
                float(
                    coefficients_fe_price_index().loc[
                        "B LINEAR LOG FIT", "EQUATION THREE"
                    ]
                )
                * fe_market()
            ),
...
def fe_mining():
    ...
    value.loc[["RICH GRADE"]] = mining_rate_drive() * float(
        fe_known_reserves().loc["RICH GRADE"]
    )
    value.loc[["HIGH GRADE"]] = (
        float(fe_change_grade().loc["HIGH GRADE"])
        * mining_rate_drive()
        * float(fe_known_reserves().loc["HIGH GRADE"])
    )
    value.loc[["LOW GRADE"]] = (
        float(fe_change_grade().loc["LOW GRADE"])
        * mining_rate_drive()
        * fe_technology()
        * float(fe_known_reserves().loc["LOW GRADE"])
    )
    value.loc[["ULTRALOW GRADE"]] = (
        fe_technology()
        * float(fe_change_grade().loc["ULTRALOW GRADE"])
        * mining_rate_drive()
        * float(fe_known_reserves().loc["ULTRALOW GRADE"])
    )
    value.loc[["TRACE GRADE"]] = 0
    value.loc[["OCEANS GRADE"]] = 0
    return value
...
def fe_mining_technology():
    ...
    """
    return float(coefficients_fe_mining_technology().loc["A S CURVE"]) / (
        1
        + np.exp(
            -float(coefficients_fe_mining_technology().loc["B S CURVE"])
            * (time() - float(coefficients_fe_mining_technology().loc["C S CURVE"]))
        )
    )


@component.add(
    name="Fe modified demand WORLD7",
    units="Mt/Years",
    comp_type="Auxiliary",
    comp_subtype="Normal",
...
@component.add(
    name="Fe price economy adjusted",
    units="DMNL",
    comp_type="Auxiliary",
    comp_subtype="Normal",
...
def fe_price_index_economy():
    ...
    return if_then_else(
        ...
        lambda: 100,
        lambda: (
            float(estimated_price_with_tax_metals().loc["Fe W"]) / fe_base_price_2015()
        )
...
def fe_production_price():
    ...
    Source: Sverdrup, H., and Olafsdottir, A.H., 2019., Assessing the Longâ€Term Global Sustainability of the Production and Supply for Stainless Steel. Biophysical Economics and Resource Quality 1-26. https://doi.org/10.1007/s41247-019-0056-9 Open access publication. Sverdrup, H. and Ragnarsdottir, K.V., 2014. Natural Resources in a planetary perspective. Geochemical Perspectives Vol. 3, number 2, October issue 2014. 2:129-341. European Geochemical Society. Open access
    """
    return float(coefficients_fe_production_price().loc["A S CURVE"]) * (
        fe_extraction_cost()
        * float(coefficients_fe_production_price().loc["B S CURVE"])
        + float(coefficients_fe_production_price().loc["C S CURVE"])
        * imv_energy_price()
    )
...
def fe_profit_responce():
    ...
    return if_then_else(
        mining_signal_out() < 0,
        lambda: 0,
        lambda: float(coefficients_fe_profit_response().loc["A S CURVE"])
        / (
            1
            + np.exp(
                -float(coefficients_fe_profit_response().loc["B S CURVE"])
                * (
                    mining_signal_out()
                    - float(coefficients_fe_profit_response().loc["C S CURVE"])
                )
            )
        ),
    )
...
@component.add(
    name="Fe prospecting decision in",
    units="1/Year",
    comp_type="Auxiliary",
    comp_subtype="Normal",
...
@component.add(
    name="Fe prospecting decision out",
    units="1/Year",
    comp_type="Auxiliary",
    comp_subtype="Normal",
    depends_on={
...
def fe_prospecting_drive():
    ...
    return if_then_else(
        ...
        lambda: float(
            coefficients_prospecting_drive().loc["A LINEAR LOG FIT", "EQUATION ONE"]
        )
        * fe_sum_of_known_rich_and_high_grade()
        + float(
            coefficients_prospecting_drive().loc["B LINEAR LOG FIT", "EQUATION ONE"]
        ),
        lambda: float(
            coefficients_prospecting_drive().loc["A LINEAR LOG FIT", "EQUATION TWO"]
        )
        * fe_sum_of_known_rich_and_high_grade()
        ** float(
            coefficients_prospecting_drive().loc["B LINEAR LOG FIT", "EQUATION TWO"]
        ),
    )


@component.add(
    name="Fe prospecting shut down",
    units="DMNL",
    comp_type="Auxiliary",
    comp_subtype="Normal",
...
def fe_prospecting_shut_down():
    ...
    """
    return float(coefficients_fe_prospecting_shut_down().loc["A S CURVE"]) / (
        1
        + np.exp(
            -float(coefficients_fe_prospecting_shut_down().loc["B S CURVE"])
            * (
                fe_discovery()
                - float(coefficients_fe_prospecting_shut_down().loc["C S CURVE"])
            )
        )
    )
...
@component.add(
    name="Fe RECYCLING RATE SCALING",
    units="DMNL",
    comp_type="Constant",
    comp_subtype="Normal",
)
def fe_recycling_rate_scaling():
    """
    Scaling Factor for recycling
    """
    return 1.5


@component.add(
    name="Fe RESIDENCE TIME",
    units="Years",
    subscripts=["Fe SOCIETY I"],
    comp_type="Constant",
    comp_subtype="External",
...
def fe_scrap_curve():
    ...
    """
    return (
        float(coefficients_scrap_curve().loc["A S CURVE"])
        / (
            1
            + np.exp(
                -float(coefficients_scrap_curve().loc["B S CURVE"])
                * (
                    fe_price_economy()
                    - float(coefficients_scrap_curve().loc["C S CURVE"])
                )
            )
        )
...
def fe_scrapping():
    ...
    """
    return (
        float(fe_society_out().loc["LONG TERM"])
        + float(fe_society_out().loc["INTERMEDIATE TERM"])
        + float(fe_society_out().loc["SHORT TERM"])
...
@component.add(
    name="Fe share of secondary material",
    units="DMNL",
    comp_type="Auxiliary",
    comp_subtype="Normal",
    depends_on={
...
def fe_society():
    ...
    """
    value = xr.DataArray(
        np.nan, {"Fe SOCIETY I": _subscript_dict["Fe SOCIETY I"]}, ["Fe SOCIETY I"]
    )
    value.loc[["SHORT TERM"]] = _integ_fe_society().values
    value.loc[["INTERMEDIATE TERM"]] = _integ_fe_society_1().values
    value.loc[["LONG TERM"]] = _integ_fe_society_2().values
    return value


_integ_fe_society = Integ(
    lambda: xr.DataArray(
        float(fe_society_in().loc["SHORT TERM"])
        - float(fe_society_out().loc["SHORT TERM"])
        - float(fe_corrosion_lost().loc["SHORT TERM"]),
        {"Fe SOCIETY I": ["SHORT TERM"]},
        ["Fe SOCIETY I"],
    ),
    lambda: xr.DataArray(
        initial_fe_short(), {"Fe SOCIETY I": ["SHORT TERM"]}, ["Fe SOCIETY I"]
    ),
    "_integ_fe_society",
)
...
_integ_fe_society_1 = Integ(
    lambda: xr.DataArray(
        float(fe_society_in().loc["INTERMEDIATE TERM"])
        - float(fe_society_out().loc["INTERMEDIATE TERM"])
        - float(fe_corrosion_lost().loc["INTERMEDIATE TERM"]),
        {"Fe SOCIETY I": ["INTERMEDIATE TERM"]},
        ["Fe SOCIETY I"],
    ),
    lambda: xr.DataArray(
...
_integ_fe_society_2 = Integ(
    lambda: xr.DataArray(
        float(fe_society_in().loc["LONG TERM"])
        - float(fe_society_out().loc["LONG TERM"])
        - float(fe_corrosion_lost().loc["LONG TERM"]),
        {"Fe SOCIETY I": ["LONG TERM"]},
        ["Fe SOCIETY I"],
    ),
    lambda: xr.DataArray(
...
def fe_society_in():
    ...
    value.loc[["SHORT TERM"]] = (
        fe_market_sales()
        * (1 - imv_fe_fraction_to_long_term())
        * float(coefficients_fe_society_in().loc["SHORT TERM"])
    )
    value.loc[["INTERMEDIATE TERM"]] = (
        fe_market_sales()
        * (1 - imv_fe_fraction_to_long_term())
        * float(coefficients_fe_society_in().loc["INTERMEDIATE TERM"])
    )
    value.loc[["LONG TERM"]] = fe_market_sales() * imv_fe_fraction_to_long_term()
    return value
...
def fe_society_out():
    ...
    value.loc[["SHORT TERM"]] = float(fe_society().loc["SHORT TERM"]) / float(
        fe_residence_time().loc["SHORT TERM"]
    )
    value.loc[["INTERMEDIATE TERM"]] = float(
        fe_society().loc["INTERMEDIATE TERM"]
    ) / float(fe_residence_time().loc["INTERMEDIATE TERM"])
    value.loc[["LONG TERM"]] = (
        float(fe_society().loc["LONG TERM"])
        * imv_scrapping_rate()
        / float(fe_residence_time().loc["LONG TERM"])
    )
    return value


@component.add(
    name="Fe society output",
    units="Mt/Year",
    comp_type="Auxiliary",
    comp_subtype="Normal",
...
def fe_society_total():
    ...
    """
    return xr.DataArray(
        float(fe_society().loc["SHORT TERM"])
        + float(fe_society().loc["INTERMEDIATE TERM"])
        + float(fe_society().loc["LONG TERM"]),
        {"Fe SOCIETY I": _subscript_dict["Fe SOCIETY I"]},
        ["Fe SOCIETY I"],
    )
...
@component.add(
    name="fe sum of known rich and high grade",
    units="Mt",
    comp_type="Auxiliary",
    comp_subtype="Normal",
...
def fe_sum_of_known_rich_and_high_grade():
    ...
    """
    return float(fe_known_reserves().loc["HIGH GRADE"]) + float(
        fe_known_reserves().loc["RICH GRADE"]
    )
...
def fe_technology():
    ...
    """
    return float(coefficients_fe_technology().loc["A S CURVE"]) / (
        1
        + np.exp(
            -float(coefficients_fe_technology().loc["B S CURVE"])
            * (time() - float(coefficients_fe_technology().loc["C S CURVE"]))
        )
    )
...
def fe_total_known():
    ...
    """
    return (
        float(fe_known_reserves().loc["RICH GRADE"])
        + float(fe_known_reserves().loc["HIGH GRADE"])
        + float(fe_known_reserves().loc["LOW GRADE"])
        + float(fe_known_reserves().loc["ULTRALOW GRADE"])
    )
...
def fe_total_mining():
    ...
    """
    return sum(
        fe_mining().rename({"ORE GRADES I": "ORE GRADES I!"}), dim=["ORE GRADES I!"]
    )
...
def finding_fe():
    ...
    value.loc[["RICH GRADE"]] = (
        float(fe_hidden_resources().loc["RICH GRADE"])
        * fe_prospecting()
        * float(grade_number().loc["RICH GRADE"])
    )
    value.loc[["HIGH GRADE"]] = (
        float(fe_hidden_resources().loc["HIGH GRADE"])
        * fe_prospecting()
        * float(grade_number().loc["HIGH GRADE"])
    )
    value.loc[["LOW GRADE"]] = (
        float(fe_hidden_resources().loc["LOW GRADE"])
        * fe_prospecting()
        * float(grade_number().loc["LOW GRADE"])
    )
    value.loc[["ULTRALOW GRADE"]] = (
        float(grade_number().loc["ULTRALOW GRADE"])
        * fe_technology()
        * fe_prospecting()
        * float(fe_hidden_resources().loc["ULTRALOW GRADE"])
    )
    value.loc[["TRACE GRADE"]] = 0
    value.loc[["OCEANS GRADE"]] = 0
    return value
...
@component.add(
    name="global steel demand",
    units="Bt/Billion persons",
    comp_type="Auxiliary",
    comp_subtype="Normal",
...
def global_steel_demand():
    ...
    return if_then_else(
        ...
        lambda: float(
            coefficients_global_steel_demand().loc["EQUATION ONE", "A S CURVE"]
        )
        / (
            1
            + np.exp(
                -float(
                    coefficients_global_steel_demand().loc["EQUATION ONE", "B S CURVE"]
                )
                * (
                    imv_gdp_per_person()
                    - float(
                        coefficients_global_steel_demand().loc[
                            "EQUATION ONE", "C S CURVE"
                        ]
                    )
                )
            )
        ...
        lambda: float(
            coefficients_global_steel_demand().loc["EQUATION TWO", "A S CURVE"]
        )
        * imv_gdp_per_person()
        + float(coefficients_global_steel_demand().loc["EQUATION TWO", "B S CURVE"]),
    )
...
def implicit_price_fe():
    """
    Unit conversion from monetary unit to physical units.
    """
    return if_then_else(
        time() < 2015,
        lambda: sum(
...
@component.add(
    name="IMV Fe DEMAND FOR REINFORCMENT BARS",
    units="DMNL",
    comp_type="Auxiliary",
    comp_subtype="with Lookup",
    depends_on={"time": 1},
...
@component.add(
    name="IMV Fe FRACTION TO LONG TERM",
    units="1/Years",
    comp_type="Auxiliary",
    comp_subtype="with Lookup",
    depends_on={"time": 1},
...
@component.add(
    name="IMV Fe RECYCLED FROM BUILDINGS HISTORICAL",
    units="Bt",
    comp_type="Auxiliary",
    comp_subtype="with Lookup",
    depends_on={"time": 1},
...
@component.add(
    name="IMV Fe STEEL PRICE HISTORICAL",
    units="$/t",
    comp_type="Auxiliary",
    comp_subtype="with Lookup",
    depends_on={"time": 1},
...
@component.add(
    name="IMV GLOBAL POPULATION",
    units="Billion persons",
    comp_type="Auxiliary",
    comp_subtype="with Lookup",
    depends_on={"time": 1},
)
...
@component.add(
    name="IMV IRON DEMAND PER PERSON",
...
@component.add(
    name="IMV SS MnCrNi FRACTION RECYCLED TO STAINLESS STEEL",
    units="DMNL",
    comp_type="Auxiliary",
    comp_subtype="with Lookup",
    depends_on={"time": 1},
...
@component.add(
    name="IMV STAINLESS STEEL LOST TO IRON SCRAP",
    units="Mt/Years",
    comp_type="Auxiliary",
    comp_subtype="with Lookup",
    depends_on={"time": 1},
...
@component.add(
    name="INITIAL DELAYED TS Fe PRICE",
    units="Mt",
    comp_type="Constant",
    comp_subtype="External",
...
@component.add(
    name="INITIAL Fe CUMULATIVE MINING",
    units="Mt",
    comp_type="Constant",
    comp_subtype="Normal",
)
...
@component.add(
    name="INITIAL Fe HIDDEN RESOURCES",
    units="Mt",
    subscripts=["ORE GRADES I"],
    comp_type="Constant",
    comp_subtype="External",
...
@component.add(
    name="INITIAL Fe KNOWN RESERVES",
    units="Mt",
    subscripts=["ORE GRADES I"],
    comp_type="Constant",
    comp_subtype="External",
...
@component.add(
    name="INITIAL Fe PROFIT AVEREGER",
    units="M$",
    comp_type="Constant",
    comp_subtype="External",
...
@component.add(
    name="INITIAL Fe PROSPECTING DECISION",
    units="DMNL",
    comp_type="Constant",
    comp_subtype="External",
...
@component.add(
    name="INITIAL Fe SOCIETY INTERMEDIATE TERM",
    units="Mt",
    comp_type="Constant",
    comp_subtype="External",
...
@component.add(
    name="INITIAL Fe SOCIETY LONG TERM",
    units="Mt",
    comp_type="Constant",
    comp_subtype="External",
...
def prospecting_activity():
    ...
    return if_then_else(
        fe_price_economy() < 60,
        lambda: float(
            coefficients_prospecting_activity().loc["A LINEAR LOG FIT", "EQUATION ONE"]
        )
        * np.exp(
            float(
                coefficients_prospecting_activity().loc[
                    "B LINEAR LOG FIT", "EQUATION ONE"
                ]
            )
            * fe_price_economy()
        ),
...
def prospecting_average_time():
    """
    Average time until a prospecting decision is carried out.
    """
...
@component.add(
    name="PROSPECTING DECISION SHARE OUT",
    units="DMNL",
    comp_type="Constant",
    comp_subtype="External",
...
@component.add(
    name="split equation Fe",
    units="DMNL",
    subscripts=["EQUATION SPLIT I"],
    comp_type="Constant",
    comp_subtype="External",
...
def total_fe_known_reserves():
    ...
    """
    return sum(
        fe_known_reserves().rename({"ORE GRADES I": "ORE GRADES I!"}),
        dim=["ORE GRADES I!"],
    )


@component.add(
    name="UNIT CONVERSION BILLION TO MILLION",
    units="Million Million persons/Biilion persons",
    comp_type="Constant",
    comp_subtype="Normal",
)
...
@component.add(
    name='"UNIT CONVERSION TO TJ/YEARS"',
    units="TJ/MJ",
    comp_type="Constant",
    comp_subtype="Normal",
)
...
def water_fe_extraction():
    ...
    """
    return (
        float(water_use_fe().loc["TRACE GRADE"])
        + float(water_use_fe().loc["ULTRALOW GRADE"])
        + float(water_use_fe().loc["LOW GRADE"])
        + float(water_use_fe().loc["HIGH GRADE"])
        + float(water_use_fe().loc["RICH GRADE"])
    )
...
def water_per_fe():
    ...
    value.loc[["RICH GRADE"]] = float(
        coefficients_water_per_fe_grade().loc["RICH GRADE"]
    )
    value.loc[["HIGH GRADE"]] = float(
        coefficients_water_per_fe_grade().loc["HIGH GRADE"]
    )
    value.loc[["LOW GRADE"]] = float(coefficients_water_per_fe_grade().loc["LOW GRADE"])
    value.loc[["ULTRALOW GRADE"]] = float(
        coefficients_water_per_fe_grade().loc["ULTRALOW GRADE"]
    )
    value.loc[["TRACE GRADE"]] = float(
        coefficients_water_per_fe_grade().loc["TRACE GRADE"]
    )
    value.loc[["OCEANS GRADE"]] = 0
    return value
...
def water_use_fe():
    ...
    value.loc[["RICH GRADE"]] = float(fe_mining().loc["RICH GRADE"]) * float(
        water_per_fe().loc["RICH GRADE"]
    )
    value.loc[["HIGH GRADE"]] = float(fe_mining().loc["HIGH GRADE"]) * float(
        water_per_fe().loc["HIGH GRADE"]
    )
    value.loc[["LOW GRADE"]] = float(water_per_fe().loc["LOW GRADE"]) * float(
        fe_mining().loc["LOW GRADE"]
    )
    value.loc[["ULTRALOW GRADE"]] = float(fe_mining().loc["ULTRALOW GRADE"]) * float(
        water_per_fe().loc["ULTRALOW GRADE"]
    )
    value.loc[["TRACE GRADE"]] = float(water_per_fe().loc["TRACE GRADE"]) * float(
        fe_mining().loc["TRACE GRADE"]
    )
    value.loc[["OCEANS GRADE"]] = 0
    return value
