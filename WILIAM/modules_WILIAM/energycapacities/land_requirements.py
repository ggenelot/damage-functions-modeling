"""
Module energycapacities.land_requirements
Translated using PySD version 3.14.0
"""

@component.add(
    name="AVERAGE REGIONAL LATITUDE SOLAR PV BY EROI MIN",
    units="arcdegree",
...
@component.add(
    name="AVERAGE REGOINAL LATITUDE SOLAR PV EROImin",
    units="radians",
...
@component.add(
    name="DELAY land use efficiency PROTRA",
    units="MW/km2",
...
_delayfixed_delay_land_use_efficiency_protra = DelayFixed(
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["EU27", "PROTRA CHP gas fuels"]),
        {"REGIONS 36 I": ["EU27"], "NRG PRO I": ["PROTRA CHP gas fuels"]},
        ["REGIONS 36 I", "NRG PRO I"],
    ),
    lambda: float(protra_lifetime().loc["EU27", "PROTRA CHP gas fuels"]),
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["EU27", "PROTRA CHP gas fuels"]),
        {"REGIONS 36 I": ["EU27"], "NRG PRO I": ["PROTRA CHP gas fuels"]},
        ["REGIONS 36 I", "NRG PRO I"],
...
_delayfixed_delay_land_use_efficiency_protra_1 = DelayFixed(
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["EU27", "PROTRA CHP gas fuels CCS"]),
        {"REGIONS 36 I": ["EU27"], "NRG PRO I": ["PROTRA CHP gas fuels CCS"]},
        ["REGIONS 36 I", "NRG PRO I"],
    ),
    lambda: float(protra_lifetime().loc["EU27", "PROTRA CHP gas fuels CCS"]),
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["EU27", "PROTRA CHP gas fuels CCS"]),
        {"REGIONS 36 I": ["EU27"], "NRG PRO I": ["PROTRA CHP gas fuels CCS"]},
        ["REGIONS 36 I", "NRG PRO I"],
    ...
    lambda: xr.DataArray(
        float(
            land_use_efficiency_protra().loc[
                "EU27", "PROTRA CHP geothermal DEACTIVATED"
            ]
        ),
        {"REGIONS 36 I": ["EU27"], "NRG PRO I": ["PROTRA CHP geothermal DEACTIVATED"]},
        ["REGIONS 36 I", "NRG PRO I"],
    ),
    lambda: float(protra_lifetime().loc["EU27", "PROTRA CHP geothermal DEACTIVATED"]),
    lambda: xr.DataArray(
        float(
            land_use_efficiency_protra().loc[
                "EU27", "PROTRA CHP geothermal DEACTIVATED"
...
_delayfixed_delay_land_use_efficiency_protra_3 = DelayFixed(
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["EU27", "PROTRA CHP liquid fuels"]),
        {"REGIONS 36 I": ["EU27"], "NRG PRO I": ["PROTRA CHP liquid fuels"]},
        ["REGIONS 36 I", "NRG PRO I"],
    ),
    lambda: float(protra_lifetime().loc["EU27", "PROTRA CHP liquid fuels"]),
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["EU27", "PROTRA CHP liquid fuels"]),
        {"REGIONS 36 I": ["EU27"], "NRG PRO I": ["PROTRA CHP liquid fuels"]},
        ["REGIONS 36 I", "NRG PRO I"],
...
_delayfixed_delay_land_use_efficiency_protra_4 = DelayFixed(
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["EU27", "PROTRA CHP liquid fuels CCS"]),
        {"REGIONS 36 I": ["EU27"], "NRG PRO I": ["PROTRA CHP liquid fuels CCS"]},
        ["REGIONS 36 I", "NRG PRO I"],
    ),
    lambda: float(protra_lifetime().loc["EU27", "PROTRA CHP liquid fuels CCS"]),
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["EU27", "PROTRA CHP liquid fuels CCS"]),
        {"REGIONS 36 I": ["EU27"], "NRG PRO I": ["PROTRA CHP liquid fuels CCS"]},
        ["REGIONS 36 I", "NRG PRO I"],
...
_delayfixed_delay_land_use_efficiency_protra_5 = DelayFixed(
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["EU27", "PROTRA CHP solid fossil"]),
        {"REGIONS 36 I": ["EU27"], "NRG PRO I": ["PROTRA CHP solid fossil"]},
        ["REGIONS 36 I", "NRG PRO I"],
    ),
    lambda: float(protra_lifetime().loc["EU27", "PROTRA CHP solid fossil"]),
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["EU27", "PROTRA CHP solid fossil"]),
        {"REGIONS 36 I": ["EU27"], "NRG PRO I": ["PROTRA CHP solid fossil"]},
        ["REGIONS 36 I", "NRG PRO I"],
...
_delayfixed_delay_land_use_efficiency_protra_6 = DelayFixed(
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["EU27", "PROTRA CHP solid fossil CCS"]),
        {"REGIONS 36 I": ["EU27"], "NRG PRO I": ["PROTRA CHP solid fossil CCS"]},
        ["REGIONS 36 I", "NRG PRO I"],
    ),
    lambda: float(protra_lifetime().loc["EU27", "PROTRA CHP solid fossil CCS"]),
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["EU27", "PROTRA CHP solid fossil CCS"]),
        {"REGIONS 36 I": ["EU27"], "NRG PRO I": ["PROTRA CHP solid fossil CCS"]},
        ["REGIONS 36 I", "NRG PRO I"],
...
_delayfixed_delay_land_use_efficiency_protra_7 = DelayFixed(
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["EU27", "PROTRA CHP waste"]),
        {"REGIONS 36 I": ["EU27"], "NRG PRO I": ["PROTRA CHP waste"]},
        ["REGIONS 36 I", "NRG PRO I"],
    ),
    lambda: float(protra_lifetime().loc["EU27", "PROTRA CHP waste"]),
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["EU27", "PROTRA CHP waste"]),
        {"REGIONS 36 I": ["EU27"], "NRG PRO I": ["PROTRA CHP waste"]},
        ["REGIONS 36 I", "NRG PRO I"],
...
_delayfixed_delay_land_use_efficiency_protra_8 = DelayFixed(
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["EU27", "PROTRA CHP solid bio"]),
        {"REGIONS 36 I": ["EU27"], "NRG PRO I": ["PROTRA CHP solid bio"]},
        ["REGIONS 36 I", "NRG PRO I"],
    ),
    lambda: float(protra_lifetime().loc["EU27", "PROTRA CHP solid bio"]),
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["EU27", "PROTRA CHP solid bio"]),
        {"REGIONS 36 I": ["EU27"], "NRG PRO I": ["PROTRA CHP solid bio"]},
        ["REGIONS 36 I", "NRG PRO I"],
...
_delayfixed_delay_land_use_efficiency_protra_9 = DelayFixed(
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["EU27", "PROTRA CHP solid bio CCS"]),
        {"REGIONS 36 I": ["EU27"], "NRG PRO I": ["PROTRA CHP solid bio CCS"]},
        ["REGIONS 36 I", "NRG PRO I"],
    ),
    lambda: float(protra_lifetime().loc["EU27", "PROTRA CHP solid bio CCS"]),
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["EU27", "PROTRA CHP solid bio CCS"]),
        {"REGIONS 36 I": ["EU27"], "NRG PRO I": ["PROTRA CHP solid bio CCS"]},
        ["REGIONS 36 I", "NRG PRO I"],
...
_delayfixed_delay_land_use_efficiency_protra_10 = DelayFixed(
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["EU27", "PROTRA HP gas fuels"]),
        {"REGIONS 36 I": ["EU27"], "NRG PRO I": ["PROTRA HP gas fuels"]},
        ["REGIONS 36 I", "NRG PRO I"],
    ),
    lambda: float(protra_lifetime().loc["EU27", "PROTRA HP gas fuels"]),
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["EU27", "PROTRA HP gas fuels"]),
        {"REGIONS 36 I": ["EU27"], "NRG PRO I": ["PROTRA HP gas fuels"]},
        ["REGIONS 36 I", "NRG PRO I"],
...
_delayfixed_delay_land_use_efficiency_protra_11 = DelayFixed(
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["EU27", "PROTRA HP solid bio"]),
        {"REGIONS 36 I": ["EU27"], "NRG PRO I": ["PROTRA HP solid bio"]},
        ["REGIONS 36 I", "NRG PRO I"],
    ),
    lambda: float(protra_lifetime().loc["EU27", "PROTRA HP solid bio"]),
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["EU27", "PROTRA HP solid bio"]),
        {"REGIONS 36 I": ["EU27"], "NRG PRO I": ["PROTRA HP solid bio"]},
        ["REGIONS 36 I", "NRG PRO I"],
...
_delayfixed_delay_land_use_efficiency_protra_12 = DelayFixed(
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["EU27", "PROTRA HP geothermal"]),
        {"REGIONS 36 I": ["EU27"], "NRG PRO I": ["PROTRA HP geothermal"]},
        ["REGIONS 36 I", "NRG PRO I"],
    ),
    lambda: float(protra_lifetime().loc["EU27", "PROTRA HP geothermal"]),
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["EU27", "PROTRA HP geothermal"]),
        {"REGIONS 36 I": ["EU27"], "NRG PRO I": ["PROTRA HP geothermal"]},
        ["REGIONS 36 I", "NRG PRO I"],
...
_delayfixed_delay_land_use_efficiency_protra_13 = DelayFixed(
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["EU27", "PROTRA HP liquid fuels"]),
        {"REGIONS 36 I": ["EU27"], "NRG PRO I": ["PROTRA HP liquid fuels"]},
        ["REGIONS 36 I", "NRG PRO I"],
    ),
    lambda: float(protra_lifetime().loc["EU27", "PROTRA HP liquid fuels"]),
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["EU27", "PROTRA HP liquid fuels"]),
        {"REGIONS 36 I": ["EU27"], "NRG PRO I": ["PROTRA HP liquid fuels"]},
        ["REGIONS 36 I", "NRG PRO I"],
...
_delayfixed_delay_land_use_efficiency_protra_14 = DelayFixed(
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["EU27", "PROTRA HP solar DEACTIVATED"]),
        {"REGIONS 36 I": ["EU27"], "NRG PRO I": ["PROTRA HP solar DEACTIVATED"]},
        ["REGIONS 36 I", "NRG PRO I"],
    ),
    lambda: float(protra_lifetime().loc["EU27", "PROTRA HP solar DEACTIVATED"]),
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["EU27", "PROTRA HP solar DEACTIVATED"]),
        {"REGIONS 36 I": ["EU27"], "NRG PRO I": ["PROTRA HP solar DEACTIVATED"]},
        ["REGIONS 36 I", "NRG PRO I"],
...
_delayfixed_delay_land_use_efficiency_protra_15 = DelayFixed(
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["EU27", "PROTRA HP solid fossil"]),
        {"REGIONS 36 I": ["EU27"], "NRG PRO I": ["PROTRA HP solid fossil"]},
        ["REGIONS 36 I", "NRG PRO I"],
    ),
    lambda: float(protra_lifetime().loc["EU27", "PROTRA HP solid fossil"]),
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["EU27", "PROTRA HP solid fossil"]),
        {"REGIONS 36 I": ["EU27"], "NRG PRO I": ["PROTRA HP solid fossil"]},
        ["REGIONS 36 I", "NRG PRO I"],
...
_delayfixed_delay_land_use_efficiency_protra_16 = DelayFixed(
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["EU27", "PROTRA HP waste"]),
        {"REGIONS 36 I": ["EU27"], "NRG PRO I": ["PROTRA HP waste"]},
        ["REGIONS 36 I", "NRG PRO I"],
    ),
    lambda: float(protra_lifetime().loc["EU27", "PROTRA HP waste"]),
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["EU27", "PROTRA HP waste"]),
        {"REGIONS 36 I": ["EU27"], "NRG PRO I": ["PROTRA HP waste"]},
        ["REGIONS 36 I", "NRG PRO I"],
...
_delayfixed_delay_land_use_efficiency_protra_17 = DelayFixed(
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["EU27", "PROTRA PP solid bio"]),
        {"REGIONS 36 I": ["EU27"], "NRG PRO I": ["PROTRA PP solid bio"]},
        ["REGIONS 36 I", "NRG PRO I"],
    ),
    lambda: float(protra_lifetime().loc["EU27", "PROTRA PP solid bio"]),
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["EU27", "PROTRA PP solid bio"]),
        {"REGIONS 36 I": ["EU27"], "NRG PRO I": ["PROTRA PP solid bio"]},
        ["REGIONS 36 I", "NRG PRO I"],
...
_delayfixed_delay_land_use_efficiency_protra_18 = DelayFixed(
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["EU27", "PROTRA PP solid bio CCS"]),
        {"REGIONS 36 I": ["EU27"], "NRG PRO I": ["PROTRA PP solid bio CCS"]},
        ["REGIONS 36 I", "NRG PRO I"],
    ),
    lambda: float(protra_lifetime().loc["EU27", "PROTRA PP solid bio CCS"]),
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["EU27", "PROTRA PP solid bio CCS"]),
        {"REGIONS 36 I": ["EU27"], "NRG PRO I": ["PROTRA PP solid bio CCS"]},
        ["REGIONS 36 I", "NRG PRO I"],
...
_delayfixed_delay_land_use_efficiency_protra_19 = DelayFixed(
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["EU27", "PROTRA PP gas fuels"]),
        {"REGIONS 36 I": ["EU27"], "NRG PRO I": ["PROTRA PP gas fuels"]},
        ["REGIONS 36 I", "NRG PRO I"],
    ),
    lambda: float(protra_lifetime().loc["EU27", "PROTRA PP gas fuels"]),
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["EU27", "PROTRA PP gas fuels"]),
        {"REGIONS 36 I": ["EU27"], "NRG PRO I": ["PROTRA PP gas fuels"]},
        ["REGIONS 36 I", "NRG PRO I"],
...
_delayfixed_delay_land_use_efficiency_protra_20 = DelayFixed(
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["EU27", "PROTRA PP gas fuels CCS"]),
        {"REGIONS 36 I": ["EU27"], "NRG PRO I": ["PROTRA PP gas fuels CCS"]},
        ["REGIONS 36 I", "NRG PRO I"],
    ),
    lambda: float(protra_lifetime().loc["EU27", "PROTRA PP gas fuels CCS"]),
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["EU27", "PROTRA PP gas fuels CCS"]),
        {"REGIONS 36 I": ["EU27"], "NRG PRO I": ["PROTRA PP gas fuels CCS"]},
        ["REGIONS 36 I", "NRG PRO I"],
...
_delayfixed_delay_land_use_efficiency_protra_21 = DelayFixed(
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["EU27", "PROTRA PP geothermal"]),
        {"REGIONS 36 I": ["EU27"], "NRG PRO I": ["PROTRA PP geothermal"]},
        ["REGIONS 36 I", "NRG PRO I"],
    ),
    lambda: float(protra_lifetime().loc["EU27", "PROTRA PP geothermal"]),
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["EU27", "PROTRA PP geothermal"]),
        {"REGIONS 36 I": ["EU27"], "NRG PRO I": ["PROTRA PP geothermal"]},
        ["REGIONS 36 I", "NRG PRO I"],
...
_delayfixed_delay_land_use_efficiency_protra_22 = DelayFixed(
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["EU27", "PROTRA PP hydropower dammed"]),
        {"REGIONS 36 I": ["EU27"], "NRG PRO I": ["PROTRA PP hydropower dammed"]},
        ["REGIONS 36 I", "NRG PRO I"],
    ),
    lambda: float(protra_lifetime().loc["EU27", "PROTRA PP hydropower dammed"]),
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["EU27", "PROTRA PP hydropower dammed"]),
        {"REGIONS 36 I": ["EU27"], "NRG PRO I": ["PROTRA PP hydropower dammed"]},
        ["REGIONS 36 I", "NRG PRO I"],
...
_delayfixed_delay_land_use_efficiency_protra_23 = DelayFixed(
    lambda: xr.DataArray(
        float(
            land_use_efficiency_protra().loc[
                "EU27", "PROTRA PP hydropower run of river"
            ]
        ),
        {"REGIONS 36 I": ["EU27"], "NRG PRO I": ["PROTRA PP hydropower run of river"]},
        ["REGIONS 36 I", "NRG PRO I"],
    ),
    lambda: float(protra_lifetime().loc["EU27", "PROTRA PP hydropower run of river"]),
    lambda: xr.DataArray(
        float(
            land_use_efficiency_protra().loc[
                "EU27", "PROTRA PP hydropower run of river"
...
_delayfixed_delay_land_use_efficiency_protra_24 = DelayFixed(
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["EU27", "PROTRA PP liquid fuels"]),
        {"REGIONS 36 I": ["EU27"], "NRG PRO I": ["PROTRA PP liquid fuels"]},
        ["REGIONS 36 I", "NRG PRO I"],
    ),
    lambda: float(protra_lifetime().loc["EU27", "PROTRA PP liquid fuels"]),
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["EU27", "PROTRA PP liquid fuels"]),
        {"REGIONS 36 I": ["EU27"], "NRG PRO I": ["PROTRA PP liquid fuels"]},
        ["REGIONS 36 I", "NRG PRO I"],
...
_delayfixed_delay_land_use_efficiency_protra_25 = DelayFixed(
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["EU27", "PROTRA PP liquid fuels CCS"]),
        {"REGIONS 36 I": ["EU27"], "NRG PRO I": ["PROTRA PP liquid fuels CCS"]},
        ["REGIONS 36 I", "NRG PRO I"],
    ),
    lambda: float(protra_lifetime().loc["EU27", "PROTRA PP liquid fuels CCS"]),
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["EU27", "PROTRA PP liquid fuels CCS"]),
        {"REGIONS 36 I": ["EU27"], "NRG PRO I": ["PROTRA PP liquid fuels CCS"]},
        ["REGIONS 36 I", "NRG PRO I"],
...
_delayfixed_delay_land_use_efficiency_protra_26 = DelayFixed(
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["EU27", "PROTRA PP nuclear"]),
        {"REGIONS 36 I": ["EU27"], "NRG PRO I": ["PROTRA PP nuclear"]},
        ["REGIONS 36 I", "NRG PRO I"],
    ),
    lambda: float(protra_lifetime().loc["EU27", "PROTRA PP nuclear"]),
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["EU27", "PROTRA PP nuclear"]),
        {"REGIONS 36 I": ["EU27"], "NRG PRO I": ["PROTRA PP nuclear"]},
        ["REGIONS 36 I", "NRG PRO I"],
...
_delayfixed_delay_land_use_efficiency_protra_27 = DelayFixed(
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["EU27", "PROTRA PP oceanic"]),
        {"REGIONS 36 I": ["EU27"], "NRG PRO I": ["PROTRA PP oceanic"]},
        ["REGIONS 36 I", "NRG PRO I"],
    ),
    lambda: float(protra_lifetime().loc["EU27", "PROTRA PP oceanic"]),
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["EU27", "PROTRA PP oceanic"]),
        {"REGIONS 36 I": ["EU27"], "NRG PRO I": ["PROTRA PP oceanic"]},
        ["REGIONS 36 I", "NRG PRO I"],
...
_delayfixed_delay_land_use_efficiency_protra_28 = DelayFixed(
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["EU27", "PROTRA PP solar CSP"]),
        {"REGIONS 36 I": ["EU27"], "NRG PRO I": ["PROTRA PP solar CSP"]},
        ["REGIONS 36 I", "NRG PRO I"],
    ),
    lambda: float(protra_lifetime().loc["EU27", "PROTRA PP solar CSP"]),
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["EU27", "PROTRA PP solar CSP"]),
        {"REGIONS 36 I": ["EU27"], "NRG PRO I": ["PROTRA PP solar CSP"]},
        ["REGIONS 36 I", "NRG PRO I"],
...
_delayfixed_delay_land_use_efficiency_protra_29 = DelayFixed(
    lambda: xr.DataArray(
        float(
            land_use_efficiency_protra().loc["EU27", "PROTRA PP solar open space PV"]
        ),
        {"REGIONS 36 I": ["EU27"], "NRG PRO I": ["PROTRA PP solar open space PV"]},
        ["REGIONS 36 I", "NRG PRO I"],
    ),
    lambda: float(protra_lifetime().loc["EU27", "PROTRA PP solar open space PV"]),
    lambda: xr.DataArray(
        float(
            land_use_efficiency_protra().loc["EU27", "PROTRA PP solar open space PV"]
        ),
...
_delayfixed_delay_land_use_efficiency_protra_30 = DelayFixed(
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["EU27", "PROTRA PP solar urban PV"]),
        {"REGIONS 36 I": ["EU27"], "NRG PRO I": ["PROTRA PP solar urban PV"]},
        ["REGIONS 36 I", "NRG PRO I"],
    ),
    lambda: float(protra_lifetime().loc["EU27", "PROTRA PP solar urban PV"]),
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["EU27", "PROTRA PP solar urban PV"]),
        {"REGIONS 36 I": ["EU27"], "NRG PRO I": ["PROTRA PP solar urban PV"]},
        ["REGIONS 36 I", "NRG PRO I"],
...
_delayfixed_delay_land_use_efficiency_protra_31 = DelayFixed(
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["EU27", "PROTRA PP solid fossil"]),
        {"REGIONS 36 I": ["EU27"], "NRG PRO I": ["PROTRA PP solid fossil"]},
        ["REGIONS 36 I", "NRG PRO I"],
    ),
    lambda: float(protra_lifetime().loc["EU27", "PROTRA PP solid fossil"]),
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["EU27", "PROTRA PP solid fossil"]),
        {"REGIONS 36 I": ["EU27"], "NRG PRO I": ["PROTRA PP solid fossil"]},
        ["REGIONS 36 I", "NRG PRO I"],
...
_delayfixed_delay_land_use_efficiency_protra_32 = DelayFixed(
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["EU27", "PROTRA PP solid fossil CCS"]),
        {"REGIONS 36 I": ["EU27"], "NRG PRO I": ["PROTRA PP solid fossil CCS"]},
        ["REGIONS 36 I", "NRG PRO I"],
    ),
    lambda: float(protra_lifetime().loc["EU27", "PROTRA PP solid fossil CCS"]),
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["EU27", "PROTRA PP solid fossil CCS"]),
        {"REGIONS 36 I": ["EU27"], "NRG PRO I": ["PROTRA PP solid fossil CCS"]},
        ["REGIONS 36 I", "NRG PRO I"],
...
_delayfixed_delay_land_use_efficiency_protra_33 = DelayFixed(
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["EU27", "PROTRA PP waste"]),
        {"REGIONS 36 I": ["EU27"], "NRG PRO I": ["PROTRA PP waste"]},
        ["REGIONS 36 I", "NRG PRO I"],
    ),
    lambda: float(protra_lifetime().loc["EU27", "PROTRA PP waste"]),
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["EU27", "PROTRA PP waste"]),
        {"REGIONS 36 I": ["EU27"], "NRG PRO I": ["PROTRA PP waste"]},
        ["REGIONS 36 I", "NRG PRO I"],
...
_delayfixed_delay_land_use_efficiency_protra_34 = DelayFixed(
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["EU27", "PROTRA PP waste CCS"]),
        {"REGIONS 36 I": ["EU27"], "NRG PRO I": ["PROTRA PP waste CCS"]},
        ["REGIONS 36 I", "NRG PRO I"],
    ),
    lambda: float(protra_lifetime().loc["EU27", "PROTRA PP waste CCS"]),
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["EU27", "PROTRA PP waste CCS"]),
        {"REGIONS 36 I": ["EU27"], "NRG PRO I": ["PROTRA PP waste CCS"]},
        ["REGIONS 36 I", "NRG PRO I"],
...
_delayfixed_delay_land_use_efficiency_protra_35 = DelayFixed(
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["EU27", "PROTRA PP wind offshore"]),
        {"REGIONS 36 I": ["EU27"], "NRG PRO I": ["PROTRA PP wind offshore"]},
        ["REGIONS 36 I", "NRG PRO I"],
    ),
    lambda: float(protra_lifetime().loc["EU27", "PROTRA PP wind offshore"]),
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["EU27", "PROTRA PP wind offshore"]),
        {"REGIONS 36 I": ["EU27"], "NRG PRO I": ["PROTRA PP wind offshore"]},
        ["REGIONS 36 I", "NRG PRO I"],
...
_delayfixed_delay_land_use_efficiency_protra_36 = DelayFixed(
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["EU27", "PROTRA PP wind onshore"]),
        {"REGIONS 36 I": ["EU27"], "NRG PRO I": ["PROTRA PP wind onshore"]},
        ["REGIONS 36 I", "NRG PRO I"],
    ),
    lambda: float(protra_lifetime().loc["EU27", "PROTRA PP wind onshore"]),
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["EU27", "PROTRA PP wind onshore"]),
        {"REGIONS 36 I": ["EU27"], "NRG PRO I": ["PROTRA PP wind onshore"]},
        ["REGIONS 36 I", "NRG PRO I"],
...
_delayfixed_delay_land_use_efficiency_protra_37 = DelayFixed(
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["EU27", "PROTRA blending gas fuels"]),
        {"REGIONS 36 I": ["EU27"], "NRG PRO I": ["PROTRA blending gas fuels"]},
        ["REGIONS 36 I", "NRG PRO I"],
    ),
    lambda: float(protra_lifetime().loc["EU27", "PROTRA blending gas fuels"]),
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["EU27", "PROTRA blending gas fuels"]),
        {"REGIONS 36 I": ["EU27"], "NRG PRO I": ["PROTRA blending gas fuels"]},
        ["REGIONS 36 I", "NRG PRO I"],
...
_delayfixed_delay_land_use_efficiency_protra_38 = DelayFixed(
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["EU27", "PROTRA blending liquid fuels"]),
        {"REGIONS 36 I": ["EU27"], "NRG PRO I": ["PROTRA blending liquid fuels"]},
        ["REGIONS 36 I", "NRG PRO I"],
    ),
    lambda: float(protra_lifetime().loc["EU27", "PROTRA blending liquid fuels"]),
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["EU27", "PROTRA blending liquid fuels"]),
        {"REGIONS 36 I": ["EU27"], "NRG PRO I": ["PROTRA blending liquid fuels"]},
        ["REGIONS 36 I", "NRG PRO I"],
...
_delayfixed_delay_land_use_efficiency_protra_39 = DelayFixed(
    lambda: xr.DataArray(
        float(
            land_use_efficiency_protra().loc["EU27", "PROTRA no process TI hydrogen"]
        ),
        {"REGIONS 36 I": ["EU27"], "NRG PRO I": ["PROTRA no process TI hydrogen"]},
        ["REGIONS 36 I", "NRG PRO I"],
    ),
    lambda: float(protra_lifetime().loc["EU27", "PROTRA no process TI hydrogen"]),
    lambda: xr.DataArray(
        float(
            land_use_efficiency_protra().loc["EU27", "PROTRA no process TI hydrogen"]
        ),
...
_delayfixed_delay_land_use_efficiency_protra_40 = DelayFixed(
    lambda: xr.DataArray(
        float(
            land_use_efficiency_protra().loc["EU27", "PROTRA no process TI solid bio"]
        ),
        {"REGIONS 36 I": ["EU27"], "NRG PRO I": ["PROTRA no process TI solid bio"]},
        ["REGIONS 36 I", "NRG PRO I"],
    ),
    lambda: float(protra_lifetime().loc["EU27", "PROTRA no process TI solid bio"]),
    lambda: xr.DataArray(
        float(
            land_use_efficiency_protra().loc["EU27", "PROTRA no process TI solid bio"]
        ),
...
_delayfixed_delay_land_use_efficiency_protra_41 = DelayFixed(
    lambda: xr.DataArray(
        float(
            land_use_efficiency_protra().loc[
                "EU27", "PROTRA no process TI solid fossil"
            ]
        ),
        {"REGIONS 36 I": ["EU27"], "NRG PRO I": ["PROTRA no process TI solid fossil"]},
        ["REGIONS 36 I", "NRG PRO I"],
    ),
    lambda: float(protra_lifetime().loc["EU27", "PROTRA no process TI solid fossil"]),
    lambda: xr.DataArray(
        float(
            land_use_efficiency_protra().loc[
                "EU27", "PROTRA no process TI solid fossil"
...
_delayfixed_delay_land_use_efficiency_protra_42 = DelayFixed(
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["UK", "PROTRA CHP gas fuels"]),
        {"REGIONS 35 I": ["UK"], "NRG PRO I": ["PROTRA CHP gas fuels"]},
        ["REGIONS 35 I", "NRG PRO I"],
    ),
    lambda: float(protra_lifetime().loc["UK", "PROTRA CHP gas fuels"]),
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["UK", "PROTRA CHP gas fuels"]),
        {"REGIONS 35 I": ["UK"], "NRG PRO I": ["PROTRA CHP gas fuels"]},
        ["REGIONS 35 I", "NRG PRO I"],
...
_delayfixed_delay_land_use_efficiency_protra_43 = DelayFixed(
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["UK", "PROTRA CHP gas fuels CCS"]),
        {"REGIONS 35 I": ["UK"], "NRG PRO I": ["PROTRA CHP gas fuels CCS"]},
        ["REGIONS 35 I", "NRG PRO I"],
    ),
    lambda: float(protra_lifetime().loc["UK", "PROTRA CHP gas fuels CCS"]),
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["UK", "PROTRA CHP gas fuels CCS"]),
        {"REGIONS 35 I": ["UK"], "NRG PRO I": ["PROTRA CHP gas fuels CCS"]},
        ["REGIONS 35 I", "NRG PRO I"],
...
_delayfixed_delay_land_use_efficiency_protra_44 = DelayFixed(
    lambda: xr.DataArray(
        float(
            land_use_efficiency_protra().loc["UK", "PROTRA CHP geothermal DEACTIVATED"]
        ),
        {"REGIONS 35 I": ["UK"], "NRG PRO I": ["PROTRA CHP geothermal DEACTIVATED"]},
        ["REGIONS 35 I", "NRG PRO I"],
    ),
    lambda: float(protra_lifetime().loc["UK", "PROTRA CHP geothermal DEACTIVATED"]),
    lambda: xr.DataArray(
        float(
            land_use_efficiency_protra().loc["UK", "PROTRA CHP geothermal DEACTIVATED"]
        ),
...
_delayfixed_delay_land_use_efficiency_protra_45 = DelayFixed(
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["UK", "PROTRA CHP liquid fuels"]),
        {"REGIONS 35 I": ["UK"], "NRG PRO I": ["PROTRA CHP liquid fuels"]},
        ["REGIONS 35 I", "NRG PRO I"],
    ),
    lambda: float(protra_lifetime().loc["UK", "PROTRA CHP liquid fuels"]),
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["UK", "PROTRA CHP liquid fuels"]),
        {"REGIONS 35 I": ["UK"], "NRG PRO I": ["PROTRA CHP liquid fuels"]},
        ["REGIONS 35 I", "NRG PRO I"],
...
_delayfixed_delay_land_use_efficiency_protra_46 = DelayFixed(
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["UK", "PROTRA CHP liquid fuels CCS"]),
        {"REGIONS 35 I": ["UK"], "NRG PRO I": ["PROTRA CHP liquid fuels CCS"]},
        ["REGIONS 35 I", "NRG PRO I"],
    ),
    lambda: float(protra_lifetime().loc["UK", "PROTRA CHP liquid fuels CCS"]),
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["UK", "PROTRA CHP liquid fuels CCS"]),
        {"REGIONS 35 I": ["UK"], "NRG PRO I": ["PROTRA CHP liquid fuels CCS"]},
        ["REGIONS 35 I", "NRG PRO I"],
...
_delayfixed_delay_land_use_efficiency_protra_47 = DelayFixed(
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["UK", "PROTRA CHP solid fossil"]),
        {"REGIONS 35 I": ["UK"], "NRG PRO I": ["PROTRA CHP solid fossil"]},
        ["REGIONS 35 I", "NRG PRO I"],
    ),
    lambda: float(protra_lifetime().loc["UK", "PROTRA CHP solid fossil"]),
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["UK", "PROTRA CHP solid fossil"]),
        {"REGIONS 35 I": ["UK"], "NRG PRO I": ["PROTRA CHP solid fossil"]},
        ["REGIONS 35 I", "NRG PRO I"],
...
_delayfixed_delay_land_use_efficiency_protra_48 = DelayFixed(
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["UK", "PROTRA CHP solid fossil CCS"]),
        {"REGIONS 35 I": ["UK"], "NRG PRO I": ["PROTRA CHP solid fossil CCS"]},
        ["REGIONS 35 I", "NRG PRO I"],
    ),
    lambda: float(protra_lifetime().loc["UK", "PROTRA CHP solid fossil CCS"]),
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["UK", "PROTRA CHP solid fossil CCS"]),
        {"REGIONS 35 I": ["UK"], "NRG PRO I": ["PROTRA CHP solid fossil CCS"]},
        ["REGIONS 35 I", "NRG PRO I"],
...
_delayfixed_delay_land_use_efficiency_protra_49 = DelayFixed(
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["UK", "PROTRA CHP waste"]),
        {"REGIONS 35 I": ["UK"], "NRG PRO I": ["PROTRA CHP waste"]},
        ["REGIONS 35 I", "NRG PRO I"],
    ),
    lambda: float(protra_lifetime().loc["UK", "PROTRA CHP waste"]),
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["UK", "PROTRA CHP waste"]),
        {"REGIONS 35 I": ["UK"], "NRG PRO I": ["PROTRA CHP waste"]},
        ["REGIONS 35 I", "NRG PRO I"],
...
_delayfixed_delay_land_use_efficiency_protra_50 = DelayFixed(
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["UK", "PROTRA CHP solid bio"]),
        {"REGIONS 35 I": ["UK"], "NRG PRO I": ["PROTRA CHP solid bio"]},
        ["REGIONS 35 I", "NRG PRO I"],
    ),
    lambda: float(protra_lifetime().loc["UK", "PROTRA CHP solid bio"]),
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["UK", "PROTRA CHP solid bio"]),
        {"REGIONS 35 I": ["UK"], "NRG PRO I": ["PROTRA CHP solid bio"]},
        ["REGIONS 35 I", "NRG PRO I"],
...
_delayfixed_delay_land_use_efficiency_protra_51 = DelayFixed(
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["UK", "PROTRA CHP solid bio CCS"]),
        {"REGIONS 35 I": ["UK"], "NRG PRO I": ["PROTRA CHP solid bio CCS"]},
        ["REGIONS 35 I", "NRG PRO I"],
    ),
    lambda: float(protra_lifetime().loc["UK", "PROTRA CHP solid bio CCS"]),
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["UK", "PROTRA CHP solid bio CCS"]),
        {"REGIONS 35 I": ["UK"], "NRG PRO I": ["PROTRA CHP solid bio CCS"]},
        ["REGIONS 35 I", "NRG PRO I"],
...
_delayfixed_delay_land_use_efficiency_protra_52 = DelayFixed(
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["UK", "PROTRA HP gas fuels"]),
        {"REGIONS 35 I": ["UK"], "NRG PRO I": ["PROTRA HP gas fuels"]},
        ["REGIONS 35 I", "NRG PRO I"],
    ),
    lambda: float(protra_lifetime().loc["UK", "PROTRA HP gas fuels"]),
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["UK", "PROTRA HP gas fuels"]),
        {"REGIONS 35 I": ["UK"], "NRG PRO I": ["PROTRA HP gas fuels"]},
        ["REGIONS 35 I", "NRG PRO I"],
...
_delayfixed_delay_land_use_efficiency_protra_53 = DelayFixed(
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["UK", "PROTRA HP solid bio"]),
        {"REGIONS 35 I": ["UK"], "NRG PRO I": ["PROTRA HP solid bio"]},
        ["REGIONS 35 I", "NRG PRO I"],
    ),
    lambda: float(protra_lifetime().loc["UK", "PROTRA HP solid bio"]),
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["UK", "PROTRA HP solid bio"]),
        {"REGIONS 35 I": ["UK"], "NRG PRO I": ["PROTRA HP solid bio"]},
        ["REGIONS 35 I", "NRG PRO I"],
...
_delayfixed_delay_land_use_efficiency_protra_54 = DelayFixed(
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["UK", "PROTRA HP geothermal"]),
        {"REGIONS 35 I": ["UK"], "NRG PRO I": ["PROTRA HP geothermal"]},
        ["REGIONS 35 I", "NRG PRO I"],
    ),
    lambda: float(protra_lifetime().loc["UK", "PROTRA HP geothermal"]),
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["UK", "PROTRA HP geothermal"]),
        {"REGIONS 35 I": ["UK"], "NRG PRO I": ["PROTRA HP geothermal"]},
        ["REGIONS 35 I", "NRG PRO I"],
...
_delayfixed_delay_land_use_efficiency_protra_55 = DelayFixed(
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["UK", "PROTRA HP liquid fuels"]),
        {"REGIONS 35 I": ["UK"], "NRG PRO I": ["PROTRA HP liquid fuels"]},
        ["REGIONS 35 I", "NRG PRO I"],
    ),
    lambda: float(protra_lifetime().loc["UK", "PROTRA HP liquid fuels"]),
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["UK", "PROTRA HP liquid fuels"]),
        {"REGIONS 35 I": ["UK"], "NRG PRO I": ["PROTRA HP liquid fuels"]},
        ["REGIONS 35 I", "NRG PRO I"],
...
_delayfixed_delay_land_use_efficiency_protra_56 = DelayFixed(
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["UK", "PROTRA HP solar DEACTIVATED"]),
        {"REGIONS 35 I": ["UK"], "NRG PRO I": ["PROTRA HP solar DEACTIVATED"]},
        ["REGIONS 35 I", "NRG PRO I"],
    ),
    lambda: float(protra_lifetime().loc["UK", "PROTRA HP solar DEACTIVATED"]),
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["UK", "PROTRA HP solar DEACTIVATED"]),
        {"REGIONS 35 I": ["UK"], "NRG PRO I": ["PROTRA HP solar DEACTIVATED"]},
        ["REGIONS 35 I", "NRG PRO I"],
...
_delayfixed_delay_land_use_efficiency_protra_57 = DelayFixed(
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["UK", "PROTRA HP solid fossil"]),
        {"REGIONS 35 I": ["UK"], "NRG PRO I": ["PROTRA HP solid fossil"]},
        ["REGIONS 35 I", "NRG PRO I"],
    ),
    lambda: float(protra_lifetime().loc["UK", "PROTRA HP solid fossil"]),
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["UK", "PROTRA HP solid fossil"]),
        {"REGIONS 35 I": ["UK"], "NRG PRO I": ["PROTRA HP solid fossil"]},
        ["REGIONS 35 I", "NRG PRO I"],
...
_delayfixed_delay_land_use_efficiency_protra_58 = DelayFixed(
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["UK", "PROTRA HP waste"]),
        {"REGIONS 35 I": ["UK"], "NRG PRO I": ["PROTRA HP waste"]},
        ["REGIONS 35 I", "NRG PRO I"],
    ),
    lambda: float(protra_lifetime().loc["UK", "PROTRA HP waste"]),
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["UK", "PROTRA HP waste"]),
        {"REGIONS 35 I": ["UK"], "NRG PRO I": ["PROTRA HP waste"]},
        ["REGIONS 35 I", "NRG PRO I"],
...
_delayfixed_delay_land_use_efficiency_protra_59 = DelayFixed(
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["UK", "PROTRA PP solid bio"]),
        {"REGIONS 35 I": ["UK"], "NRG PRO I": ["PROTRA PP solid bio"]},
        ["REGIONS 35 I", "NRG PRO I"],
    ),
    lambda: float(protra_lifetime().loc["UK", "PROTRA PP solid bio"]),
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["UK", "PROTRA PP solid bio"]),
        {"REGIONS 35 I": ["UK"], "NRG PRO I": ["PROTRA PP solid bio"]},
        ["REGIONS 35 I", "NRG PRO I"],
...
_delayfixed_delay_land_use_efficiency_protra_60 = DelayFixed(
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["UK", "PROTRA PP solid bio CCS"]),
        {"REGIONS 35 I": ["UK"], "NRG PRO I": ["PROTRA PP solid bio CCS"]},
        ["REGIONS 35 I", "NRG PRO I"],
    ),
    lambda: float(protra_lifetime().loc["UK", "PROTRA PP solid bio CCS"]),
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["UK", "PROTRA PP solid bio CCS"]),
        {"REGIONS 35 I": ["UK"], "NRG PRO I": ["PROTRA PP solid bio CCS"]},
        ["REGIONS 35 I", "NRG PRO I"],
...
_delayfixed_delay_land_use_efficiency_protra_61 = DelayFixed(
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["UK", "PROTRA PP gas fuels"]),
        {"REGIONS 35 I": ["UK"], "NRG PRO I": ["PROTRA PP gas fuels"]},
        ["REGIONS 35 I", "NRG PRO I"],
    ),
    lambda: float(protra_lifetime().loc["UK", "PROTRA PP gas fuels"]),
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["UK", "PROTRA PP gas fuels"]),
        {"REGIONS 35 I": ["UK"], "NRG PRO I": ["PROTRA PP gas fuels"]},
        ["REGIONS 35 I", "NRG PRO I"],
...
_delayfixed_delay_land_use_efficiency_protra_62 = DelayFixed(
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["UK", "PROTRA PP gas fuels CCS"]),
        {"REGIONS 35 I": ["UK"], "NRG PRO I": ["PROTRA PP gas fuels CCS"]},
        ["REGIONS 35 I", "NRG PRO I"],
    ),
    lambda: float(protra_lifetime().loc["UK", "PROTRA PP gas fuels CCS"]),
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["UK", "PROTRA PP gas fuels CCS"]),
        {"REGIONS 35 I": ["UK"], "NRG PRO I": ["PROTRA PP gas fuels CCS"]},
        ["REGIONS 35 I", "NRG PRO I"],
...
_delayfixed_delay_land_use_efficiency_protra_63 = DelayFixed(
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["UK", "PROTRA PP geothermal"]),
        {"REGIONS 35 I": ["UK"], "NRG PRO I": ["PROTRA PP geothermal"]},
        ["REGIONS 35 I", "NRG PRO I"],
    ),
    lambda: float(protra_lifetime().loc["UK", "PROTRA PP geothermal"]),
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["UK", "PROTRA PP geothermal"]),
        {"REGIONS 35 I": ["UK"], "NRG PRO I": ["PROTRA PP geothermal"]},
        ["REGIONS 35 I", "NRG PRO I"],
...
_delayfixed_delay_land_use_efficiency_protra_64 = DelayFixed(
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["UK", "PROTRA PP hydropower dammed"]),
        {"REGIONS 35 I": ["UK"], "NRG PRO I": ["PROTRA PP hydropower dammed"]},
        ["REGIONS 35 I", "NRG PRO I"],
    ),
    lambda: float(protra_lifetime().loc["UK", "PROTRA PP hydropower dammed"]),
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["UK", "PROTRA PP hydropower dammed"]),
        {"REGIONS 35 I": ["UK"], "NRG PRO I": ["PROTRA PP hydropower dammed"]},
        ["REGIONS 35 I", "NRG PRO I"],
...
_delayfixed_delay_land_use_efficiency_protra_65 = DelayFixed(
    lambda: xr.DataArray(
        float(
            land_use_efficiency_protra().loc["UK", "PROTRA PP hydropower run of river"]
        ),
        {"REGIONS 35 I": ["UK"], "NRG PRO I": ["PROTRA PP hydropower run of river"]},
        ["REGIONS 35 I", "NRG PRO I"],
    ),
    lambda: float(protra_lifetime().loc["UK", "PROTRA PP hydropower run of river"]),
    lambda: xr.DataArray(
        float(
            land_use_efficiency_protra().loc["UK", "PROTRA PP hydropower run of river"]
        ),
...
_delayfixed_delay_land_use_efficiency_protra_66 = DelayFixed(
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["UK", "PROTRA PP liquid fuels"]),
        {"REGIONS 35 I": ["UK"], "NRG PRO I": ["PROTRA PP liquid fuels"]},
        ["REGIONS 35 I", "NRG PRO I"],
    ),
    lambda: float(protra_lifetime().loc["UK", "PROTRA PP liquid fuels"]),
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["UK", "PROTRA PP liquid fuels"]),
        {"REGIONS 35 I": ["UK"], "NRG PRO I": ["PROTRA PP liquid fuels"]},
        ["REGIONS 35 I", "NRG PRO I"],
...
_delayfixed_delay_land_use_efficiency_protra_67 = DelayFixed(
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["UK", "PROTRA PP liquid fuels CCS"]),
        {"REGIONS 35 I": ["UK"], "NRG PRO I": ["PROTRA PP liquid fuels CCS"]},
        ["REGIONS 35 I", "NRG PRO I"],
    ),
    lambda: float(protra_lifetime().loc["UK", "PROTRA PP liquid fuels CCS"]),
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["UK", "PROTRA PP liquid fuels CCS"]),
        {"REGIONS 35 I": ["UK"], "NRG PRO I": ["PROTRA PP liquid fuels CCS"]},
        ["REGIONS 35 I", "NRG PRO I"],
...
_delayfixed_delay_land_use_efficiency_protra_68 = DelayFixed(
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["UK", "PROTRA PP nuclear"]),
        {"REGIONS 35 I": ["UK"], "NRG PRO I": ["PROTRA PP nuclear"]},
        ["REGIONS 35 I", "NRG PRO I"],
    ),
    lambda: float(protra_lifetime().loc["UK", "PROTRA PP nuclear"]),
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["UK", "PROTRA PP nuclear"]),
        {"REGIONS 35 I": ["UK"], "NRG PRO I": ["PROTRA PP nuclear"]},
        ["REGIONS 35 I", "NRG PRO I"],
...
_delayfixed_delay_land_use_efficiency_protra_69 = DelayFixed(
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["UK", "PROTRA PP oceanic"]),
        {"REGIONS 35 I": ["UK"], "NRG PRO I": ["PROTRA PP oceanic"]},
        ["REGIONS 35 I", "NRG PRO I"],
    ),
    lambda: float(protra_lifetime().loc["UK", "PROTRA PP oceanic"]),
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["UK", "PROTRA PP oceanic"]),
        {"REGIONS 35 I": ["UK"], "NRG PRO I": ["PROTRA PP oceanic"]},
        ["REGIONS 35 I", "NRG PRO I"],
...
_delayfixed_delay_land_use_efficiency_protra_70 = DelayFixed(
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["UK", "PROTRA PP solar CSP"]),
        {"REGIONS 35 I": ["UK"], "NRG PRO I": ["PROTRA PP solar CSP"]},
        ["REGIONS 35 I", "NRG PRO I"],
    ),
    lambda: float(protra_lifetime().loc["UK", "PROTRA PP solar CSP"]),
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["UK", "PROTRA PP solar CSP"]),
        {"REGIONS 35 I": ["UK"], "NRG PRO I": ["PROTRA PP solar CSP"]},
        ["REGIONS 35 I", "NRG PRO I"],
...
_delayfixed_delay_land_use_efficiency_protra_71 = DelayFixed(
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["UK", "PROTRA PP solar open space PV"]),
        {"REGIONS 35 I": ["UK"], "NRG PRO I": ["PROTRA PP solar open space PV"]},
        ["REGIONS 35 I", "NRG PRO I"],
    ),
    lambda: float(protra_lifetime().loc["UK", "PROTRA PP solar open space PV"]),
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["UK", "PROTRA PP solar open space PV"]),
        {"REGIONS 35 I": ["UK"], "NRG PRO I": ["PROTRA PP solar open space PV"]},
        ["REGIONS 35 I", "NRG PRO I"],
...
_delayfixed_delay_land_use_efficiency_protra_72 = DelayFixed(
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["UK", "PROTRA PP solar urban PV"]),
        {"REGIONS 35 I": ["UK"], "NRG PRO I": ["PROTRA PP solar urban PV"]},
        ["REGIONS 35 I", "NRG PRO I"],
    ),
    lambda: float(protra_lifetime().loc["UK", "PROTRA PP solar urban PV"]),
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["UK", "PROTRA PP solar urban PV"]),
        {"REGIONS 35 I": ["UK"], "NRG PRO I": ["PROTRA PP solar urban PV"]},
        ["REGIONS 35 I", "NRG PRO I"],
...
_delayfixed_delay_land_use_efficiency_protra_73 = DelayFixed(
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["UK", "PROTRA PP solid fossil"]),
        {"REGIONS 35 I": ["UK"], "NRG PRO I": ["PROTRA PP solid fossil"]},
        ["REGIONS 35 I", "NRG PRO I"],
    ),
    lambda: float(protra_lifetime().loc["UK", "PROTRA PP solid fossil"]),
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["UK", "PROTRA PP solid fossil"]),
        {"REGIONS 35 I": ["UK"], "NRG PRO I": ["PROTRA PP solid fossil"]},
        ["REGIONS 35 I", "NRG PRO I"],
...
_delayfixed_delay_land_use_efficiency_protra_74 = DelayFixed(
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["UK", "PROTRA PP solid fossil CCS"]),
        {"REGIONS 35 I": ["UK"], "NRG PRO I": ["PROTRA PP solid fossil CCS"]},
        ["REGIONS 35 I", "NRG PRO I"],
    ),
    lambda: float(protra_lifetime().loc["UK", "PROTRA PP solid fossil CCS"]),
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["UK", "PROTRA PP solid fossil CCS"]),
        {"REGIONS 35 I": ["UK"], "NRG PRO I": ["PROTRA PP solid fossil CCS"]},
        ["REGIONS 35 I", "NRG PRO I"],
...
_delayfixed_delay_land_use_efficiency_protra_75 = DelayFixed(
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["UK", "PROTRA PP waste"]),
        {"REGIONS 35 I": ["UK"], "NRG PRO I": ["PROTRA PP waste"]},
        ["REGIONS 35 I", "NRG PRO I"],
    ),
    lambda: float(protra_lifetime().loc["UK", "PROTRA PP waste"]),
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["UK", "PROTRA PP waste"]),
        {"REGIONS 35 I": ["UK"], "NRG PRO I": ["PROTRA PP waste"]},
        ["REGIONS 35 I", "NRG PRO I"],
...
_delayfixed_delay_land_use_efficiency_protra_76 = DelayFixed(
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["UK", "PROTRA PP waste CCS"]),
        {"REGIONS 35 I": ["UK"], "NRG PRO I": ["PROTRA PP waste CCS"]},
        ["REGIONS 35 I", "NRG PRO I"],
    ),
    lambda: float(protra_lifetime().loc["UK", "PROTRA PP waste CCS"]),
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["UK", "PROTRA PP waste CCS"]),
        {"REGIONS 35 I": ["UK"], "NRG PRO I": ["PROTRA PP waste CCS"]},
        ["REGIONS 35 I", "NRG PRO I"],
...
_delayfixed_delay_land_use_efficiency_protra_77 = DelayFixed(
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["UK", "PROTRA PP wind offshore"]),
        {"REGIONS 35 I": ["UK"], "NRG PRO I": ["PROTRA PP wind offshore"]},
        ["REGIONS 35 I", "NRG PRO I"],
    ),
    lambda: float(protra_lifetime().loc["UK", "PROTRA PP wind offshore"]),
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["UK", "PROTRA PP wind offshore"]),
        {"REGIONS 35 I": ["UK"], "NRG PRO I": ["PROTRA PP wind offshore"]},
        ["REGIONS 35 I", "NRG PRO I"],
...
_delayfixed_delay_land_use_efficiency_protra_78 = DelayFixed(
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["UK", "PROTRA PP wind onshore"]),
        {"REGIONS 35 I": ["UK"], "NRG PRO I": ["PROTRA PP wind onshore"]},
        ["REGIONS 35 I", "NRG PRO I"],
    ),
    lambda: float(protra_lifetime().loc["UK", "PROTRA PP wind onshore"]),
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["UK", "PROTRA PP wind onshore"]),
        {"REGIONS 35 I": ["UK"], "NRG PRO I": ["PROTRA PP wind onshore"]},
        ["REGIONS 35 I", "NRG PRO I"],
...
_delayfixed_delay_land_use_efficiency_protra_79 = DelayFixed(
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["UK", "PROTRA blending gas fuels"]),
        {"REGIONS 35 I": ["UK"], "NRG PRO I": ["PROTRA blending gas fuels"]},
        ["REGIONS 35 I", "NRG PRO I"],
    ),
    lambda: float(protra_lifetime().loc["UK", "PROTRA blending gas fuels"]),
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["UK", "PROTRA blending gas fuels"]),
        {"REGIONS 35 I": ["UK"], "NRG PRO I": ["PROTRA blending gas fuels"]},
        ["REGIONS 35 I", "NRG PRO I"],
...
_delayfixed_delay_land_use_efficiency_protra_80 = DelayFixed(
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["UK", "PROTRA blending liquid fuels"]),
        {"REGIONS 35 I": ["UK"], "NRG PRO I": ["PROTRA blending liquid fuels"]},
        ["REGIONS 35 I", "NRG PRO I"],
    ),
    lambda: float(protra_lifetime().loc["UK", "PROTRA blending liquid fuels"]),
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["UK", "PROTRA blending liquid fuels"]),
        {"REGIONS 35 I": ["UK"], "NRG PRO I": ["PROTRA blending liquid fuels"]},
        ["REGIONS 35 I", "NRG PRO I"],
...
_delayfixed_delay_land_use_efficiency_protra_81 = DelayFixed(
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["UK", "PROTRA no process TI hydrogen"]),
        {"REGIONS 35 I": ["UK"], "NRG PRO I": ["PROTRA no process TI hydrogen"]},
        ["REGIONS 35 I", "NRG PRO I"],
    ),
    lambda: float(protra_lifetime().loc["UK", "PROTRA no process TI hydrogen"]),
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["UK", "PROTRA no process TI hydrogen"]),
        {"REGIONS 35 I": ["UK"], "NRG PRO I": ["PROTRA no process TI hydrogen"]},
        ["REGIONS 35 I", "NRG PRO I"],
...
_delayfixed_delay_land_use_efficiency_protra_82 = DelayFixed(
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["UK", "PROTRA no process TI solid bio"]),
        {"REGIONS 35 I": ["UK"], "NRG PRO I": ["PROTRA no process TI solid bio"]},
        ["REGIONS 35 I", "NRG PRO I"],
    ),
    lambda: float(protra_lifetime().loc["UK", "PROTRA no process TI solid bio"]),
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["UK", "PROTRA no process TI solid bio"]),
        {"REGIONS 35 I": ["UK"], "NRG PRO I": ["PROTRA no process TI solid bio"]},
        ["REGIONS 35 I", "NRG PRO I"],
...
_delayfixed_delay_land_use_efficiency_protra_83 = DelayFixed(
    lambda: xr.DataArray(
        float(
            land_use_efficiency_protra().loc["UK", "PROTRA no process TI solid fossil"]
        ),
        {"REGIONS 35 I": ["UK"], "NRG PRO I": ["PROTRA no process TI solid fossil"]},
        ["REGIONS 35 I", "NRG PRO I"],
    ),
    lambda: float(protra_lifetime().loc["UK", "PROTRA no process TI solid fossil"]),
    lambda: xr.DataArray(
        float(
            land_use_efficiency_protra().loc["UK", "PROTRA no process TI solid fossil"]
        ),
...
_delayfixed_delay_land_use_efficiency_protra_84 = DelayFixed(
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["CHINA", "PROTRA CHP gas fuels"]),
        {"REGIONS 35 I": ["CHINA"], "NRG PRO I": ["PROTRA CHP gas fuels"]},
        ["REGIONS 35 I", "NRG PRO I"],
    ),
    lambda: float(protra_lifetime().loc["CHINA", "PROTRA CHP gas fuels"]),
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["CHINA", "PROTRA CHP gas fuels"]),
        {"REGIONS 35 I": ["CHINA"], "NRG PRO I": ["PROTRA CHP gas fuels"]},
        ["REGIONS 35 I", "NRG PRO I"],
...
_delayfixed_delay_land_use_efficiency_protra_85 = DelayFixed(
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["CHINA", "PROTRA CHP gas fuels CCS"]),
        {"REGIONS 35 I": ["CHINA"], "NRG PRO I": ["PROTRA CHP gas fuels CCS"]},
        ["REGIONS 35 I", "NRG PRO I"],
    ),
    lambda: float(protra_lifetime().loc["CHINA", "PROTRA CHP gas fuels CCS"]),
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["CHINA", "PROTRA CHP gas fuels CCS"]),
        {"REGIONS 35 I": ["CHINA"], "NRG PRO I": ["PROTRA CHP gas fuels CCS"]},
        ["REGIONS 35 I", "NRG PRO I"],
...
_delayfixed_delay_land_use_efficiency_protra_86 = DelayFixed(
    lambda: xr.DataArray(
        float(
            land_use_efficiency_protra().loc[
                "CHINA", "PROTRA CHP geothermal DEACTIVATED"
            ]
        ),
        {"REGIONS 35 I": ["CHINA"], "NRG PRO I": ["PROTRA CHP geothermal DEACTIVATED"]},
        ["REGIONS 35 I", "NRG PRO I"],
    ),
    lambda: float(protra_lifetime().loc["CHINA", "PROTRA CHP geothermal DEACTIVATED"]),
    lambda: xr.DataArray(
        float(
            land_use_efficiency_protra().loc[
                "CHINA", "PROTRA CHP geothermal DEACTIVATED"
...
_delayfixed_delay_land_use_efficiency_protra_87 = DelayFixed(
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["CHINA", "PROTRA CHP liquid fuels"]),
        {"REGIONS 35 I": ["CHINA"], "NRG PRO I": ["PROTRA CHP liquid fuels"]},
        ["REGIONS 35 I", "NRG PRO I"],
    ),
    lambda: float(protra_lifetime().loc["CHINA", "PROTRA CHP liquid fuels"]),
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["CHINA", "PROTRA CHP liquid fuels"]),
        {"REGIONS 35 I": ["CHINA"], "NRG PRO I": ["PROTRA CHP liquid fuels"]},
        ["REGIONS 35 I", "NRG PRO I"],
...
_delayfixed_delay_land_use_efficiency_protra_88 = DelayFixed(
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["CHINA", "PROTRA CHP liquid fuels CCS"]),
        {"REGIONS 35 I": ["CHINA"], "NRG PRO I": ["PROTRA CHP liquid fuels CCS"]},
        ["REGIONS 35 I", "NRG PRO I"],
    ),
    lambda: float(protra_lifetime().loc["CHINA", "PROTRA CHP liquid fuels CCS"]),
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["CHINA", "PROTRA CHP liquid fuels CCS"]),
        {"REGIONS 35 I": ["CHINA"], "NRG PRO I": ["PROTRA CHP liquid fuels CCS"]},
        ["REGIONS 35 I", "NRG PRO I"],
...
_delayfixed_delay_land_use_efficiency_protra_89 = DelayFixed(
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["CHINA", "PROTRA CHP solid fossil"]),
        {"REGIONS 35 I": ["CHINA"], "NRG PRO I": ["PROTRA CHP solid fossil"]},
        ["REGIONS 35 I", "NRG PRO I"],
    ),
    lambda: float(protra_lifetime().loc["CHINA", "PROTRA CHP solid fossil"]),
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["CHINA", "PROTRA CHP solid fossil"]),
        {"REGIONS 35 I": ["CHINA"], "NRG PRO I": ["PROTRA CHP solid fossil"]},
        ["REGIONS 35 I", "NRG PRO I"],
...
_delayfixed_delay_land_use_efficiency_protra_90 = DelayFixed(
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["CHINA", "PROTRA CHP solid fossil CCS"]),
        {"REGIONS 35 I": ["CHINA"], "NRG PRO I": ["PROTRA CHP solid fossil CCS"]},
        ["REGIONS 35 I", "NRG PRO I"],
    ),
    lambda: float(protra_lifetime().loc["CHINA", "PROTRA CHP solid fossil CCS"]),
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["CHINA", "PROTRA CHP solid fossil CCS"]),
        {"REGIONS 35 I": ["CHINA"], "NRG PRO I": ["PROTRA CHP solid fossil CCS"]},
        ["REGIONS 35 I", "NRG PRO I"],
...
_delayfixed_delay_land_use_efficiency_protra_91 = DelayFixed(
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["CHINA", "PROTRA CHP waste"]),
        {"REGIONS 35 I": ["CHINA"], "NRG PRO I": ["PROTRA CHP waste"]},
        ["REGIONS 35 I", "NRG PRO I"],
    ),
    lambda: float(protra_lifetime().loc["CHINA", "PROTRA CHP waste"]),
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["CHINA", "PROTRA CHP waste"]),
        {"REGIONS 35 I": ["CHINA"], "NRG PRO I": ["PROTRA CHP waste"]},
        ["REGIONS 35 I", "NRG PRO I"],
...
_delayfixed_delay_land_use_efficiency_protra_92 = DelayFixed(
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["CHINA", "PROTRA CHP solid bio"]),
        {"REGIONS 35 I": ["CHINA"], "NRG PRO I": ["PROTRA CHP solid bio"]},
        ["REGIONS 35 I", "NRG PRO I"],
    ),
    lambda: float(protra_lifetime().loc["CHINA", "PROTRA CHP solid bio"]),
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["CHINA", "PROTRA CHP solid bio"]),
        {"REGIONS 35 I": ["CHINA"], "NRG PRO I": ["PROTRA CHP solid bio"]},
        ["REGIONS 35 I", "NRG PRO I"],
...
_delayfixed_delay_land_use_efficiency_protra_93 = DelayFixed(
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["CHINA", "PROTRA CHP solid bio CCS"]),
        {"REGIONS 35 I": ["CHINA"], "NRG PRO I": ["PROTRA CHP solid bio CCS"]},
        ["REGIONS 35 I", "NRG PRO I"],
    ),
    lambda: float(protra_lifetime().loc["CHINA", "PROTRA CHP solid bio CCS"]),
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["CHINA", "PROTRA CHP solid bio CCS"]),
        {"REGIONS 35 I": ["CHINA"], "NRG PRO I": ["PROTRA CHP solid bio CCS"]},
        ["REGIONS 35 I", "NRG PRO I"],
...
_delayfixed_delay_land_use_efficiency_protra_94 = DelayFixed(
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["CHINA", "PROTRA HP gas fuels"]),
        {"REGIONS 35 I": ["CHINA"], "NRG PRO I": ["PROTRA HP gas fuels"]},
        ["REGIONS 35 I", "NRG PRO I"],
    ),
    lambda: float(protra_lifetime().loc["CHINA", "PROTRA HP gas fuels"]),
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["CHINA", "PROTRA HP gas fuels"]),
        {"REGIONS 35 I": ["CHINA"], "NRG PRO I": ["PROTRA HP gas fuels"]},
        ["REGIONS 35 I", "NRG PRO I"],
...
_delayfixed_delay_land_use_efficiency_protra_95 = DelayFixed(
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["CHINA", "PROTRA HP solid bio"]),
        {"REGIONS 35 I": ["CHINA"], "NRG PRO I": ["PROTRA HP solid bio"]},
        ["REGIONS 35 I", "NRG PRO I"],
    ),
    lambda: float(protra_lifetime().loc["CHINA", "PROTRA HP solid bio"]),
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["CHINA", "PROTRA HP solid bio"]),
        {"REGIONS 35 I": ["CHINA"], "NRG PRO I": ["PROTRA HP solid bio"]},
        ["REGIONS 35 I", "NRG PRO I"],
...
_delayfixed_delay_land_use_efficiency_protra_96 = DelayFixed(
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["CHINA", "PROTRA HP geothermal"]),
        {"REGIONS 35 I": ["CHINA"], "NRG PRO I": ["PROTRA HP geothermal"]},
        ["REGIONS 35 I", "NRG PRO I"],
    ),
    lambda: float(protra_lifetime().loc["CHINA", "PROTRA HP geothermal"]),
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["CHINA", "PROTRA HP geothermal"]),
        {"REGIONS 35 I": ["CHINA"], "NRG PRO I": ["PROTRA HP geothermal"]},
        ["REGIONS 35 I", "NRG PRO I"],
...
_delayfixed_delay_land_use_efficiency_protra_97 = DelayFixed(
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["CHINA", "PROTRA HP liquid fuels"]),
        {"REGIONS 35 I": ["CHINA"], "NRG PRO I": ["PROTRA HP liquid fuels"]},
        ["REGIONS 35 I", "NRG PRO I"],
    ),
    lambda: float(protra_lifetime().loc["CHINA", "PROTRA HP liquid fuels"]),
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["CHINA", "PROTRA HP liquid fuels"]),
        {"REGIONS 35 I": ["CHINA"], "NRG PRO I": ["PROTRA HP liquid fuels"]},
        ["REGIONS 35 I", "NRG PRO I"],
...
_delayfixed_delay_land_use_efficiency_protra_98 = DelayFixed(
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["CHINA", "PROTRA HP solar DEACTIVATED"]),
        {"REGIONS 35 I": ["CHINA"], "NRG PRO I": ["PROTRA HP solar DEACTIVATED"]},
        ["REGIONS 35 I", "NRG PRO I"],
    ),
    lambda: float(protra_lifetime().loc["CHINA", "PROTRA HP solar DEACTIVATED"]),
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["CHINA", "PROTRA HP solar DEACTIVATED"]),
        {"REGIONS 35 I": ["CHINA"], "NRG PRO I": ["PROTRA HP solar DEACTIVATED"]},
        ["REGIONS 35 I", "NRG PRO I"],
...
_delayfixed_delay_land_use_efficiency_protra_99 = DelayFixed(
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["CHINA", "PROTRA HP solid fossil"]),
        {"REGIONS 35 I": ["CHINA"], "NRG PRO I": ["PROTRA HP solid fossil"]},
        ["REGIONS 35 I", "NRG PRO I"],
    ),
    lambda: float(protra_lifetime().loc["CHINA", "PROTRA HP solid fossil"]),
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["CHINA", "PROTRA HP solid fossil"]),
        {"REGIONS 35 I": ["CHINA"], "NRG PRO I": ["PROTRA HP solid fossil"]},
        ["REGIONS 35 I", "NRG PRO I"],
...
_delayfixed_delay_land_use_efficiency_protra_100 = DelayFixed(
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["CHINA", "PROTRA HP waste"]),
        {"REGIONS 35 I": ["CHINA"], "NRG PRO I": ["PROTRA HP waste"]},
        ["REGIONS 35 I", "NRG PRO I"],
    ),
    lambda: float(protra_lifetime().loc["CHINA", "PROTRA HP waste"]),
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["CHINA", "PROTRA HP waste"]),
        {"REGIONS 35 I": ["CHINA"], "NRG PRO I": ["PROTRA HP waste"]},
        ["REGIONS 35 I", "NRG PRO I"],
...
_delayfixed_delay_land_use_efficiency_protra_101 = DelayFixed(
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["CHINA", "PROTRA PP solid bio"]),
        {"REGIONS 35 I": ["CHINA"], "NRG PRO I": ["PROTRA PP solid bio"]},
        ["REGIONS 35 I", "NRG PRO I"],
    ),
    lambda: float(protra_lifetime().loc["CHINA", "PROTRA PP solid bio"]),
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["CHINA", "PROTRA PP solid bio"]),
        {"REGIONS 35 I": ["CHINA"], "NRG PRO I": ["PROTRA PP solid bio"]},
        ["REGIONS 35 I", "NRG PRO I"],
...
_delayfixed_delay_land_use_efficiency_protra_102 = DelayFixed(
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["CHINA", "PROTRA PP solid bio CCS"]),
        {"REGIONS 35 I": ["CHINA"], "NRG PRO I": ["PROTRA PP solid bio CCS"]},
        ["REGIONS 35 I", "NRG PRO I"],
    ),
    lambda: float(protra_lifetime().loc["CHINA", "PROTRA PP solid bio CCS"]),
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["CHINA", "PROTRA PP solid bio CCS"]),
        {"REGIONS 35 I": ["CHINA"], "NRG PRO I": ["PROTRA PP solid bio CCS"]},
        ["REGIONS 35 I", "NRG PRO I"],
...
_delayfixed_delay_land_use_efficiency_protra_103 = DelayFixed(
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["CHINA", "PROTRA PP gas fuels"]),
        {"REGIONS 35 I": ["CHINA"], "NRG PRO I": ["PROTRA PP gas fuels"]},
        ["REGIONS 35 I", "NRG PRO I"],
    ),
    lambda: float(protra_lifetime().loc["CHINA", "PROTRA PP gas fuels"]),
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["CHINA", "PROTRA PP gas fuels"]),
        {"REGIONS 35 I": ["CHINA"], "NRG PRO I": ["PROTRA PP gas fuels"]},
        ["REGIONS 35 I", "NRG PRO I"],
...
_delayfixed_delay_land_use_efficiency_protra_104 = DelayFixed(
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["CHINA", "PROTRA PP gas fuels CCS"]),
        {"REGIONS 35 I": ["CHINA"], "NRG PRO I": ["PROTRA PP gas fuels CCS"]},
        ["REGIONS 35 I", "NRG PRO I"],
    ),
    lambda: float(protra_lifetime().loc["CHINA", "PROTRA PP gas fuels CCS"]),
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["CHINA", "PROTRA PP gas fuels CCS"]),
        {"REGIONS 35 I": ["CHINA"], "NRG PRO I": ["PROTRA PP gas fuels CCS"]},
        ["REGIONS 35 I", "NRG PRO I"],
...
_delayfixed_delay_land_use_efficiency_protra_105 = DelayFixed(
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["CHINA", "PROTRA PP geothermal"]),
        {"REGIONS 35 I": ["CHINA"], "NRG PRO I": ["PROTRA PP geothermal"]},
        ["REGIONS 35 I", "NRG PRO I"],
    ),
    lambda: float(protra_lifetime().loc["CHINA", "PROTRA PP geothermal"]),
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["CHINA", "PROTRA PP geothermal"]),
        {"REGIONS 35 I": ["CHINA"], "NRG PRO I": ["PROTRA PP geothermal"]},
        ["REGIONS 35 I", "NRG PRO I"],
...
_delayfixed_delay_land_use_efficiency_protra_106 = DelayFixed(
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["CHINA", "PROTRA PP hydropower dammed"]),
        {"REGIONS 35 I": ["CHINA"], "NRG PRO I": ["PROTRA PP hydropower dammed"]},
        ["REGIONS 35 I", "NRG PRO I"],
    ),
    lambda: float(protra_lifetime().loc["CHINA", "PROTRA PP hydropower dammed"]),
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["CHINA", "PROTRA PP hydropower dammed"]),
        {"REGIONS 35 I": ["CHINA"], "NRG PRO I": ["PROTRA PP hydropower dammed"]},
        ["REGIONS 35 I", "NRG PRO I"],
...
_delayfixed_delay_land_use_efficiency_protra_107 = DelayFixed(
    lambda: xr.DataArray(
        float(
            land_use_efficiency_protra().loc[
                "CHINA", "PROTRA PP hydropower run of river"
            ]
        ),
        {"REGIONS 35 I": ["CHINA"], "NRG PRO I": ["PROTRA PP hydropower run of river"]},
        ["REGIONS 35 I", "NRG PRO I"],
    ),
    lambda: float(protra_lifetime().loc["CHINA", "PROTRA PP hydropower run of river"]),
    lambda: xr.DataArray(
        float(
            land_use_efficiency_protra().loc[
                "CHINA", "PROTRA PP hydropower run of river"
...
_delayfixed_delay_land_use_efficiency_protra_108 = DelayFixed(
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["CHINA", "PROTRA PP liquid fuels"]),
        {"REGIONS 35 I": ["CHINA"], "NRG PRO I": ["PROTRA PP liquid fuels"]},
        ["REGIONS 35 I", "NRG PRO I"],
    ),
    lambda: float(protra_lifetime().loc["CHINA", "PROTRA PP liquid fuels"]),
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["CHINA", "PROTRA PP liquid fuels"]),
        {"REGIONS 35 I": ["CHINA"], "NRG PRO I": ["PROTRA PP liquid fuels"]},
        ["REGIONS 35 I", "NRG PRO I"],
...
_delayfixed_delay_land_use_efficiency_protra_109 = DelayFixed(
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["CHINA", "PROTRA PP liquid fuels CCS"]),
        {"REGIONS 35 I": ["CHINA"], "NRG PRO I": ["PROTRA PP liquid fuels CCS"]},
        ["REGIONS 35 I", "NRG PRO I"],
    ),
    lambda: float(protra_lifetime().loc["CHINA", "PROTRA PP liquid fuels CCS"]),
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["CHINA", "PROTRA PP liquid fuels CCS"]),
        {"REGIONS 35 I": ["CHINA"], "NRG PRO I": ["PROTRA PP liquid fuels CCS"]},
        ["REGIONS 35 I", "NRG PRO I"],
...
_delayfixed_delay_land_use_efficiency_protra_110 = DelayFixed(
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["CHINA", "PROTRA PP nuclear"]),
        {"REGIONS 35 I": ["CHINA"], "NRG PRO I": ["PROTRA PP nuclear"]},
        ["REGIONS 35 I", "NRG PRO I"],
    ),
    lambda: float(protra_lifetime().loc["CHINA", "PROTRA PP nuclear"]),
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["CHINA", "PROTRA PP nuclear"]),
        {"REGIONS 35 I": ["CHINA"], "NRG PRO I": ["PROTRA PP nuclear"]},
        ["REGIONS 35 I", "NRG PRO I"],
...
_delayfixed_delay_land_use_efficiency_protra_111 = DelayFixed(
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["CHINA", "PROTRA PP oceanic"]),
        {"REGIONS 35 I": ["CHINA"], "NRG PRO I": ["PROTRA PP oceanic"]},
        ["REGIONS 35 I", "NRG PRO I"],
    ),
    lambda: float(protra_lifetime().loc["CHINA", "PROTRA PP oceanic"]),
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["CHINA", "PROTRA PP oceanic"]),
        {"REGIONS 35 I": ["CHINA"], "NRG PRO I": ["PROTRA PP oceanic"]},
        ["REGIONS 35 I", "NRG PRO I"],
...
_delayfixed_delay_land_use_efficiency_protra_112 = DelayFixed(
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["CHINA", "PROTRA PP solar CSP"]),
        {"REGIONS 35 I": ["CHINA"], "NRG PRO I": ["PROTRA PP solar CSP"]},
        ["REGIONS 35 I", "NRG PRO I"],
    ),
    lambda: float(protra_lifetime().loc["CHINA", "PROTRA PP solar CSP"]),
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["CHINA", "PROTRA PP solar CSP"]),
        {"REGIONS 35 I": ["CHINA"], "NRG PRO I": ["PROTRA PP solar CSP"]},
        ["REGIONS 35 I", "NRG PRO I"],
...
_delayfixed_delay_land_use_efficiency_protra_113 = DelayFixed(
    lambda: xr.DataArray(
        float(
            land_use_efficiency_protra().loc["CHINA", "PROTRA PP solar open space PV"]
        ),
        {"REGIONS 35 I": ["CHINA"], "NRG PRO I": ["PROTRA PP solar open space PV"]},
        ["REGIONS 35 I", "NRG PRO I"],
    ),
    lambda: float(protra_lifetime().loc["CHINA", "PROTRA PP solar open space PV"]),
    lambda: xr.DataArray(
        float(
            land_use_efficiency_protra().loc["CHINA", "PROTRA PP solar open space PV"]
        ),
...
_delayfixed_delay_land_use_efficiency_protra_114 = DelayFixed(
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["CHINA", "PROTRA PP solar urban PV"]),
        {"REGIONS 35 I": ["CHINA"], "NRG PRO I": ["PROTRA PP solar urban PV"]},
        ["REGIONS 35 I", "NRG PRO I"],
    ),
    lambda: float(protra_lifetime().loc["CHINA", "PROTRA PP solar urban PV"]),
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["CHINA", "PROTRA PP solar urban PV"]),
        {"REGIONS 35 I": ["CHINA"], "NRG PRO I": ["PROTRA PP solar urban PV"]},
        ["REGIONS 35 I", "NRG PRO I"],
...
_delayfixed_delay_land_use_efficiency_protra_115 = DelayFixed(
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["CHINA", "PROTRA PP solid fossil"]),
        {"REGIONS 35 I": ["CHINA"], "NRG PRO I": ["PROTRA PP solid fossil"]},
        ["REGIONS 35 I", "NRG PRO I"],
    ),
    lambda: float(protra_lifetime().loc["CHINA", "PROTRA PP solid fossil"]),
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["CHINA", "PROTRA PP solid fossil"]),
        {"REGIONS 35 I": ["CHINA"], "NRG PRO I": ["PROTRA PP solid fossil"]},
        ["REGIONS 35 I", "NRG PRO I"],
...
_delayfixed_delay_land_use_efficiency_protra_116 = DelayFixed(
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["CHINA", "PROTRA PP solid fossil CCS"]),
        {"REGIONS 35 I": ["CHINA"], "NRG PRO I": ["PROTRA PP solid fossil CCS"]},
        ["REGIONS 35 I", "NRG PRO I"],
    ),
    lambda: float(protra_lifetime().loc["CHINA", "PROTRA PP solid fossil CCS"]),
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["CHINA", "PROTRA PP solid fossil CCS"]),
        {"REGIONS 35 I": ["CHINA"], "NRG PRO I": ["PROTRA PP solid fossil CCS"]},
        ["REGIONS 35 I", "NRG PRO I"],
...
_delayfixed_delay_land_use_efficiency_protra_117 = DelayFixed(
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["CHINA", "PROTRA PP waste"]),
        {"REGIONS 35 I": ["CHINA"], "NRG PRO I": ["PROTRA PP waste"]},
        ["REGIONS 35 I", "NRG PRO I"],
    ),
    lambda: float(protra_lifetime().loc["CHINA", "PROTRA PP waste"]),
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["CHINA", "PROTRA PP waste"]),
        {"REGIONS 35 I": ["CHINA"], "NRG PRO I": ["PROTRA PP waste"]},
        ["REGIONS 35 I", "NRG PRO I"],
...
_delayfixed_delay_land_use_efficiency_protra_118 = DelayFixed(
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["CHINA", "PROTRA PP waste CCS"]),
        {"REGIONS 35 I": ["CHINA"], "NRG PRO I": ["PROTRA PP waste CCS"]},
        ["REGIONS 35 I", "NRG PRO I"],
    ),
    lambda: float(protra_lifetime().loc["CHINA", "PROTRA PP waste CCS"]),
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["CHINA", "PROTRA PP waste CCS"]),
        {"REGIONS 35 I": ["CHINA"], "NRG PRO I": ["PROTRA PP waste CCS"]},
        ["REGIONS 35 I", "NRG PRO I"],
...
_delayfixed_delay_land_use_efficiency_protra_119 = DelayFixed(
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["CHINA", "PROTRA PP wind offshore"]),
        {"REGIONS 35 I": ["CHINA"], "NRG PRO I": ["PROTRA PP wind offshore"]},
        ["REGIONS 35 I", "NRG PRO I"],
    ),
    lambda: float(protra_lifetime().loc["CHINA", "PROTRA PP wind offshore"]),
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["CHINA", "PROTRA PP wind offshore"]),
        {"REGIONS 35 I": ["CHINA"], "NRG PRO I": ["PROTRA PP wind offshore"]},
        ["REGIONS 35 I", "NRG PRO I"],
...
_delayfixed_delay_land_use_efficiency_protra_120 = DelayFixed(
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["CHINA", "PROTRA PP wind onshore"]),
        {"REGIONS 35 I": ["CHINA"], "NRG PRO I": ["PROTRA PP wind onshore"]},
        ["REGIONS 35 I", "NRG PRO I"],
    ),
    lambda: float(protra_lifetime().loc["CHINA", "PROTRA PP wind onshore"]),
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["CHINA", "PROTRA PP wind onshore"]),
        {"REGIONS 35 I": ["CHINA"], "NRG PRO I": ["PROTRA PP wind onshore"]},
        ["REGIONS 35 I", "NRG PRO I"],
...
_delayfixed_delay_land_use_efficiency_protra_121 = DelayFixed(
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["CHINA", "PROTRA blending gas fuels"]),
        {"REGIONS 35 I": ["CHINA"], "NRG PRO I": ["PROTRA blending gas fuels"]},
        ["REGIONS 35 I", "NRG PRO I"],
    ),
    lambda: float(protra_lifetime().loc["CHINA", "PROTRA blending gas fuels"]),
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["CHINA", "PROTRA blending gas fuels"]),
        {"REGIONS 35 I": ["CHINA"], "NRG PRO I": ["PROTRA blending gas fuels"]},
        ["REGIONS 35 I", "NRG PRO I"],
...
_delayfixed_delay_land_use_efficiency_protra_122 = DelayFixed(
    lambda: xr.DataArray(
        float(
            land_use_efficiency_protra().loc["CHINA", "PROTRA blending liquid fuels"]
        ),
        {"REGIONS 35 I": ["CHINA"], "NRG PRO I": ["PROTRA blending liquid fuels"]},
        ["REGIONS 35 I", "NRG PRO I"],
    ),
    lambda: float(protra_lifetime().loc["CHINA", "PROTRA blending liquid fuels"]),
    lambda: xr.DataArray(
        float(
            land_use_efficiency_protra().loc["CHINA", "PROTRA blending liquid fuels"]
        ),
...
_delayfixed_delay_land_use_efficiency_protra_123 = DelayFixed(
    lambda: xr.DataArray(
        float(
            land_use_efficiency_protra().loc["CHINA", "PROTRA no process TI hydrogen"]
        ),
        {"REGIONS 35 I": ["CHINA"], "NRG PRO I": ["PROTRA no process TI hydrogen"]},
        ["REGIONS 35 I", "NRG PRO I"],
    ),
    lambda: float(protra_lifetime().loc["CHINA", "PROTRA no process TI hydrogen"]),
    lambda: xr.DataArray(
        float(
            land_use_efficiency_protra().loc["CHINA", "PROTRA no process TI hydrogen"]
        ),
...
_delayfixed_delay_land_use_efficiency_protra_124 = DelayFixed(
    lambda: xr.DataArray(
        float(
            land_use_efficiency_protra().loc["CHINA", "PROTRA no process TI solid bio"]
        ),
        {"REGIONS 35 I": ["CHINA"], "NRG PRO I": ["PROTRA no process TI solid bio"]},
        ["REGIONS 35 I", "NRG PRO I"],
    ),
    lambda: float(protra_lifetime().loc["CHINA", "PROTRA no process TI solid bio"]),
    lambda: xr.DataArray(
        float(
            land_use_efficiency_protra().loc["CHINA", "PROTRA no process TI solid bio"]
        ),
...
_delayfixed_delay_land_use_efficiency_protra_125 = DelayFixed(
    lambda: xr.DataArray(
        float(
            land_use_efficiency_protra().loc[
                "CHINA", "PROTRA no process TI solid fossil"
            ]
        ),
        {"REGIONS 35 I": ["CHINA"], "NRG PRO I": ["PROTRA no process TI solid fossil"]},
        ["REGIONS 35 I", "NRG PRO I"],
    ),
    lambda: float(protra_lifetime().loc["CHINA", "PROTRA no process TI solid fossil"]),
    lambda: xr.DataArray(
        float(
            land_use_efficiency_protra().loc[
                "CHINA", "PROTRA no process TI solid fossil"
...
_delayfixed_delay_land_use_efficiency_protra_126 = DelayFixed(
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["EASOC", "PROTRA CHP gas fuels"]),
        {"REGIONS 35 I": ["EASOC"], "NRG PRO I": ["PROTRA CHP gas fuels"]},
        ["REGIONS 35 I", "NRG PRO I"],
    ),
    lambda: float(protra_lifetime().loc["EASOC", "PROTRA CHP gas fuels"]),
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["EASOC", "PROTRA CHP gas fuels"]),
        {"REGIONS 35 I": ["EASOC"], "NRG PRO I": ["PROTRA CHP gas fuels"]},
        ["REGIONS 35 I", "NRG PRO I"],
...
_delayfixed_delay_land_use_efficiency_protra_127 = DelayFixed(
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["EASOC", "PROTRA CHP gas fuels CCS"]),
        {"REGIONS 35 I": ["EASOC"], "NRG PRO I": ["PROTRA CHP gas fuels CCS"]},
        ["REGIONS 35 I", "NRG PRO I"],
    ),
    lambda: float(protra_lifetime().loc["EASOC", "PROTRA CHP gas fuels CCS"]),
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["EASOC", "PROTRA CHP gas fuels CCS"]),
        {"REGIONS 35 I": ["EASOC"], "NRG PRO I": ["PROTRA CHP gas fuels CCS"]},
        ["REGIONS 35 I", "NRG PRO I"],
...
_delayfixed_delay_land_use_efficiency_protra_128 = DelayFixed(
    lambda: xr.DataArray(
        float(
            land_use_efficiency_protra().loc[
                "EASOC", "PROTRA CHP geothermal DEACTIVATED"
            ]
        ),
        {"REGIONS 35 I": ["EASOC"], "NRG PRO I": ["PROTRA CHP geothermal DEACTIVATED"]},
        ["REGIONS 35 I", "NRG PRO I"],
    ),
    lambda: float(protra_lifetime().loc["EASOC", "PROTRA CHP geothermal DEACTIVATED"]),
    lambda: xr.DataArray(
        float(
            land_use_efficiency_protra().loc[
                "EASOC", "PROTRA CHP geothermal DEACTIVATED"
...
_delayfixed_delay_land_use_efficiency_protra_129 = DelayFixed(
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["EASOC", "PROTRA CHP liquid fuels"]),
        {"REGIONS 35 I": ["EASOC"], "NRG PRO I": ["PROTRA CHP liquid fuels"]},
        ["REGIONS 35 I", "NRG PRO I"],
    ),
    lambda: float(protra_lifetime().loc["EASOC", "PROTRA CHP liquid fuels"]),
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["EASOC", "PROTRA CHP liquid fuels"]),
        {"REGIONS 35 I": ["EASOC"], "NRG PRO I": ["PROTRA CHP liquid fuels"]},
        ["REGIONS 35 I", "NRG PRO I"],
...
_delayfixed_delay_land_use_efficiency_protra_130 = DelayFixed(
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["EASOC", "PROTRA CHP liquid fuels CCS"]),
        {"REGIONS 35 I": ["EASOC"], "NRG PRO I": ["PROTRA CHP liquid fuels CCS"]},
        ["REGIONS 35 I", "NRG PRO I"],
    ),
    lambda: float(protra_lifetime().loc["EASOC", "PROTRA CHP liquid fuels CCS"]),
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["EASOC", "PROTRA CHP liquid fuels CCS"]),
        {"REGIONS 35 I": ["EASOC"], "NRG PRO I": ["PROTRA CHP liquid fuels CCS"]},
        ["REGIONS 35 I", "NRG PRO I"],
...
_delayfixed_delay_land_use_efficiency_protra_131 = DelayFixed(
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["EASOC", "PROTRA CHP solid fossil"]),
        {"REGIONS 35 I": ["EASOC"], "NRG PRO I": ["PROTRA CHP solid fossil"]},
        ["REGIONS 35 I", "NRG PRO I"],
    ),
    lambda: float(protra_lifetime().loc["EASOC", "PROTRA CHP solid fossil"]),
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["EASOC", "PROTRA CHP solid fossil"]),
        {"REGIONS 35 I": ["EASOC"], "NRG PRO I": ["PROTRA CHP solid fossil"]},
        ["REGIONS 35 I", "NRG PRO I"],
...
_delayfixed_delay_land_use_efficiency_protra_132 = DelayFixed(
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["EASOC", "PROTRA CHP solid fossil CCS"]),
        {"REGIONS 35 I": ["EASOC"], "NRG PRO I": ["PROTRA CHP solid fossil CCS"]},
        ["REGIONS 35 I", "NRG PRO I"],
    ),
    lambda: float(protra_lifetime().loc["EASOC", "PROTRA CHP solid fossil CCS"]),
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["EASOC", "PROTRA CHP solid fossil CCS"]),
        {"REGIONS 35 I": ["EASOC"], "NRG PRO I": ["PROTRA CHP solid fossil CCS"]},
        ["REGIONS 35 I", "NRG PRO I"],
...
_delayfixed_delay_land_use_efficiency_protra_133 = DelayFixed(
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["EASOC", "PROTRA CHP waste"]),
        {"REGIONS 35 I": ["EASOC"], "NRG PRO I": ["PROTRA CHP waste"]},
        ["REGIONS 35 I", "NRG PRO I"],
    ),
    lambda: float(protra_lifetime().loc["EASOC", "PROTRA CHP waste"]),
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["EASOC", "PROTRA CHP waste"]),
        {"REGIONS 35 I": ["EASOC"], "NRG PRO I": ["PROTRA CHP waste"]},
        ["REGIONS 35 I", "NRG PRO I"],
...
_delayfixed_delay_land_use_efficiency_protra_134 = DelayFixed(
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["EASOC", "PROTRA CHP solid bio"]),
        {"REGIONS 35 I": ["EASOC"], "NRG PRO I": ["PROTRA CHP solid bio"]},
        ["REGIONS 35 I", "NRG PRO I"],
    ),
    lambda: float(protra_lifetime().loc["EASOC", "PROTRA CHP solid bio"]),
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["EASOC", "PROTRA CHP solid bio"]),
        {"REGIONS 35 I": ["EASOC"], "NRG PRO I": ["PROTRA CHP solid bio"]},
        ["REGIONS 35 I", "NRG PRO I"],
...
_delayfixed_delay_land_use_efficiency_protra_135 = DelayFixed(
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["EASOC", "PROTRA CHP solid bio CCS"]),
        {"REGIONS 35 I": ["EASOC"], "NRG PRO I": ["PROTRA CHP solid bio CCS"]},
        ["REGIONS 35 I", "NRG PRO I"],
    ),
    lambda: float(protra_lifetime().loc["EASOC", "PROTRA CHP solid bio CCS"]),
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["EASOC", "PROTRA CHP solid bio CCS"]),
        {"REGIONS 35 I": ["EASOC"], "NRG PRO I": ["PROTRA CHP solid bio CCS"]},
        ["REGIONS 35 I", "NRG PRO I"],
...
_delayfixed_delay_land_use_efficiency_protra_136 = DelayFixed(
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["EASOC", "PROTRA HP gas fuels"]),
        {"REGIONS 35 I": ["EASOC"], "NRG PRO I": ["PROTRA HP gas fuels"]},
        ["REGIONS 35 I", "NRG PRO I"],
    ),
    lambda: float(protra_lifetime().loc["EASOC", "PROTRA HP gas fuels"]),
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["EASOC", "PROTRA HP gas fuels"]),
        {"REGIONS 35 I": ["EASOC"], "NRG PRO I": ["PROTRA HP gas fuels"]},
        ["REGIONS 35 I", "NRG PRO I"],
...
_delayfixed_delay_land_use_efficiency_protra_137 = DelayFixed(
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["EASOC", "PROTRA HP solid bio"]),
        {"REGIONS 35 I": ["EASOC"], "NRG PRO I": ["PROTRA HP solid bio"]},
        ["REGIONS 35 I", "NRG PRO I"],
    ),
    lambda: float(protra_lifetime().loc["EASOC", "PROTRA HP solid bio"]),
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["EASOC", "PROTRA HP solid bio"]),
        {"REGIONS 35 I": ["EASOC"], "NRG PRO I": ["PROTRA HP solid bio"]},
        ["REGIONS 35 I", "NRG PRO I"],
...
_delayfixed_delay_land_use_efficiency_protra_138 = DelayFixed(
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["EASOC", "PROTRA HP geothermal"]),
        {"REGIONS 35 I": ["EASOC"], "NRG PRO I": ["PROTRA HP geothermal"]},
        ["REGIONS 35 I", "NRG PRO I"],
    ),
    lambda: float(protra_lifetime().loc["EASOC", "PROTRA HP geothermal"]),
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["EASOC", "PROTRA HP geothermal"]),
        {"REGIONS 35 I": ["EASOC"], "NRG PRO I": ["PROTRA HP geothermal"]},
        ["REGIONS 35 I", "NRG PRO I"],
...
_delayfixed_delay_land_use_efficiency_protra_139 = DelayFixed(
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["EASOC", "PROTRA HP liquid fuels"]),
        {"REGIONS 35 I": ["EASOC"], "NRG PRO I": ["PROTRA HP liquid fuels"]},
        ["REGIONS 35 I", "NRG PRO I"],
    ),
    lambda: float(protra_lifetime().loc["EASOC", "PROTRA HP liquid fuels"]),
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["EASOC", "PROTRA HP liquid fuels"]),
        {"REGIONS 35 I": ["EASOC"], "NRG PRO I": ["PROTRA HP liquid fuels"]},
        ["REGIONS 35 I", "NRG PRO I"],
...
_delayfixed_delay_land_use_efficiency_protra_140 = DelayFixed(
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["EASOC", "PROTRA HP solar DEACTIVATED"]),
        {"REGIONS 35 I": ["EASOC"], "NRG PRO I": ["PROTRA HP solar DEACTIVATED"]},
        ["REGIONS 35 I", "NRG PRO I"],
    ),
    lambda: float(protra_lifetime().loc["EASOC", "PROTRA HP solar DEACTIVATED"]),
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["EASOC", "PROTRA HP solar DEACTIVATED"]),
        {"REGIONS 35 I": ["EASOC"], "NRG PRO I": ["PROTRA HP solar DEACTIVATED"]},
        ["REGIONS 35 I", "NRG PRO I"],
...
_delayfixed_delay_land_use_efficiency_protra_141 = DelayFixed(
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["EASOC", "PROTRA HP solid fossil"]),
        {"REGIONS 35 I": ["EASOC"], "NRG PRO I": ["PROTRA HP solid fossil"]},
        ["REGIONS 35 I", "NRG PRO I"],
    ),
    lambda: float(protra_lifetime().loc["EASOC", "PROTRA HP solid fossil"]),
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["EASOC", "PROTRA HP solid fossil"]),
        {"REGIONS 35 I": ["EASOC"], "NRG PRO I": ["PROTRA HP solid fossil"]},
        ["REGIONS 35 I", "NRG PRO I"],
...
_delayfixed_delay_land_use_efficiency_protra_142 = DelayFixed(
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["EASOC", "PROTRA HP waste"]),
        {"REGIONS 35 I": ["EASOC"], "NRG PRO I": ["PROTRA HP waste"]},
        ["REGIONS 35 I", "NRG PRO I"],
    ),
    lambda: float(protra_lifetime().loc["EASOC", "PROTRA HP waste"]),
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["EASOC", "PROTRA HP waste"]),
        {"REGIONS 35 I": ["EASOC"], "NRG PRO I": ["PROTRA HP waste"]},
        ["REGIONS 35 I", "NRG PRO I"],
...
_delayfixed_delay_land_use_efficiency_protra_143 = DelayFixed(
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["EASOC", "PROTRA PP solid bio"]),
        {"REGIONS 35 I": ["EASOC"], "NRG PRO I": ["PROTRA PP solid bio"]},
        ["REGIONS 35 I", "NRG PRO I"],
    ),
    lambda: float(protra_lifetime().loc["EASOC", "PROTRA PP solid bio"]),
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["EASOC", "PROTRA PP solid bio"]),
        {"REGIONS 35 I": ["EASOC"], "NRG PRO I": ["PROTRA PP solid bio"]},
        ["REGIONS 35 I", "NRG PRO I"],
...
_delayfixed_delay_land_use_efficiency_protra_144 = DelayFixed(
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["EASOC", "PROTRA PP solid bio CCS"]),
        {"REGIONS 35 I": ["EASOC"], "NRG PRO I": ["PROTRA PP solid bio CCS"]},
        ["REGIONS 35 I", "NRG PRO I"],
    ),
    lambda: float(protra_lifetime().loc["EASOC", "PROTRA PP solid bio CCS"]),
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["EASOC", "PROTRA PP solid bio CCS"]),
        {"REGIONS 35 I": ["EASOC"], "NRG PRO I": ["PROTRA PP solid bio CCS"]},
        ["REGIONS 35 I", "NRG PRO I"],
...
_delayfixed_delay_land_use_efficiency_protra_145 = DelayFixed(
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["EASOC", "PROTRA PP gas fuels"]),
        {"REGIONS 35 I": ["EASOC"], "NRG PRO I": ["PROTRA PP gas fuels"]},
        ["REGIONS 35 I", "NRG PRO I"],
    ),
    lambda: float(protra_lifetime().loc["EASOC", "PROTRA PP gas fuels"]),
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["EASOC", "PROTRA PP gas fuels"]),
        {"REGIONS 35 I": ["EASOC"], "NRG PRO I": ["PROTRA PP gas fuels"]},
        ["REGIONS 35 I", "NRG PRO I"],
...
_delayfixed_delay_land_use_efficiency_protra_146 = DelayFixed(
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["EASOC", "PROTRA PP gas fuels CCS"]),
        {"REGIONS 35 I": ["EASOC"], "NRG PRO I": ["PROTRA PP gas fuels CCS"]},
        ["REGIONS 35 I", "NRG PRO I"],
    ),
    lambda: float(protra_lifetime().loc["EASOC", "PROTRA PP gas fuels CCS"]),
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["EASOC", "PROTRA PP gas fuels CCS"]),
        {"REGIONS 35 I": ["EASOC"], "NRG PRO I": ["PROTRA PP gas fuels CCS"]},
        ["REGIONS 35 I", "NRG PRO I"],
...
_delayfixed_delay_land_use_efficiency_protra_147 = DelayFixed(
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["EASOC", "PROTRA PP geothermal"]),
        {"REGIONS 35 I": ["EASOC"], "NRG PRO I": ["PROTRA PP geothermal"]},
        ["REGIONS 35 I", "NRG PRO I"],
    ),
    lambda: float(protra_lifetime().loc["EASOC", "PROTRA PP geothermal"]),
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["EASOC", "PROTRA PP geothermal"]),
        {"REGIONS 35 I": ["EASOC"], "NRG PRO I": ["PROTRA PP geothermal"]},
        ["REGIONS 35 I", "NRG PRO I"],
...
_delayfixed_delay_land_use_efficiency_protra_148 = DelayFixed(
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["EASOC", "PROTRA PP hydropower dammed"]),
        {"REGIONS 35 I": ["EASOC"], "NRG PRO I": ["PROTRA PP hydropower dammed"]},
        ["REGIONS 35 I", "NRG PRO I"],
    ),
    lambda: float(protra_lifetime().loc["EASOC", "PROTRA PP hydropower dammed"]),
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["EASOC", "PROTRA PP hydropower dammed"]),
        {"REGIONS 35 I": ["EASOC"], "NRG PRO I": ["PROTRA PP hydropower dammed"]},
        ["REGIONS 35 I", "NRG PRO I"],
...
_delayfixed_delay_land_use_efficiency_protra_149 = DelayFixed(
    lambda: xr.DataArray(
        float(
            land_use_efficiency_protra().loc[
                "EASOC", "PROTRA PP hydropower run of river"
            ]
        ),
        {"REGIONS 35 I": ["EASOC"], "NRG PRO I": ["PROTRA PP hydropower run of river"]},
        ["REGIONS 35 I", "NRG PRO I"],
    ),
    lambda: float(protra_lifetime().loc["EASOC", "PROTRA PP hydropower run of river"]),
    lambda: xr.DataArray(
        float(
            land_use_efficiency_protra().loc[
                "EASOC", "PROTRA PP hydropower run of river"
...
_delayfixed_delay_land_use_efficiency_protra_150 = DelayFixed(
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["EASOC", "PROTRA PP liquid fuels"]),
        {"REGIONS 35 I": ["EASOC"], "NRG PRO I": ["PROTRA PP liquid fuels"]},
        ["REGIONS 35 I", "NRG PRO I"],
    ),
    lambda: float(protra_lifetime().loc["EASOC", "PROTRA PP liquid fuels"]),
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["EASOC", "PROTRA PP liquid fuels"]),
        {"REGIONS 35 I": ["EASOC"], "NRG PRO I": ["PROTRA PP liquid fuels"]},
        ["REGIONS 35 I", "NRG PRO I"],
...
_delayfixed_delay_land_use_efficiency_protra_151 = DelayFixed(
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["EASOC", "PROTRA PP liquid fuels CCS"]),
        {"REGIONS 35 I": ["EASOC"], "NRG PRO I": ["PROTRA PP liquid fuels CCS"]},
        ["REGIONS 35 I", "NRG PRO I"],
    ),
    lambda: float(protra_lifetime().loc["EASOC", "PROTRA PP liquid fuels CCS"]),
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["EASOC", "PROTRA PP liquid fuels CCS"]),
        {"REGIONS 35 I": ["EASOC"], "NRG PRO I": ["PROTRA PP liquid fuels CCS"]},
        ["REGIONS 35 I", "NRG PRO I"],
...
_delayfixed_delay_land_use_efficiency_protra_152 = DelayFixed(
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["EASOC", "PROTRA PP nuclear"]),
        {"REGIONS 35 I": ["EASOC"], "NRG PRO I": ["PROTRA PP nuclear"]},
        ["REGIONS 35 I", "NRG PRO I"],
    ),
    lambda: float(protra_lifetime().loc["EASOC", "PROTRA PP nuclear"]),
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["EASOC", "PROTRA PP nuclear"]),
        {"REGIONS 35 I": ["EASOC"], "NRG PRO I": ["PROTRA PP nuclear"]},
        ["REGIONS 35 I", "NRG PRO I"],
...
_delayfixed_delay_land_use_efficiency_protra_153 = DelayFixed(
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["EASOC", "PROTRA PP oceanic"]),
        {"REGIONS 35 I": ["EASOC"], "NRG PRO I": ["PROTRA PP oceanic"]},
        ["REGIONS 35 I", "NRG PRO I"],
    ),
    lambda: float(protra_lifetime().loc["EASOC", "PROTRA PP oceanic"]),
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["EASOC", "PROTRA PP oceanic"]),
        {"REGIONS 35 I": ["EASOC"], "NRG PRO I": ["PROTRA PP oceanic"]},
        ["REGIONS 35 I", "NRG PRO I"],
...
_delayfixed_delay_land_use_efficiency_protra_154 = DelayFixed(
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["EASOC", "PROTRA PP solar CSP"]),
        {"REGIONS 35 I": ["EASOC"], "NRG PRO I": ["PROTRA PP solar CSP"]},
        ["REGIONS 35 I", "NRG PRO I"],
    ),
    lambda: float(protra_lifetime().loc["EASOC", "PROTRA PP solar CSP"]),
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["EASOC", "PROTRA PP solar CSP"]),
        {"REGIONS 35 I": ["EASOC"], "NRG PRO I": ["PROTRA PP solar CSP"]},
        ["REGIONS 35 I", "NRG PRO I"],
...
_delayfixed_delay_land_use_efficiency_protra_155 = DelayFixed(
    lambda: xr.DataArray(
        float(
            land_use_efficiency_protra().loc["EASOC", "PROTRA PP solar open space PV"]
        ),
        {"REGIONS 35 I": ["EASOC"], "NRG PRO I": ["PROTRA PP solar open space PV"]},
        ["REGIONS 35 I", "NRG PRO I"],
    ),
    lambda: float(protra_lifetime().loc["EASOC", "PROTRA PP solar open space PV"]),
    lambda: xr.DataArray(
        float(
            land_use_efficiency_protra().loc["EASOC", "PROTRA PP solar open space PV"]
        ),
...
_delayfixed_delay_land_use_efficiency_protra_156 = DelayFixed(
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["EASOC", "PROTRA PP solar urban PV"]),
        {"REGIONS 35 I": ["EASOC"], "NRG PRO I": ["PROTRA PP solar urban PV"]},
        ["REGIONS 35 I", "NRG PRO I"],
    ),
    lambda: float(protra_lifetime().loc["EASOC", "PROTRA PP solar urban PV"]),
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["EASOC", "PROTRA PP solar urban PV"]),
        {"REGIONS 35 I": ["EASOC"], "NRG PRO I": ["PROTRA PP solar urban PV"]},
        ["REGIONS 35 I", "NRG PRO I"],
...
_delayfixed_delay_land_use_efficiency_protra_157 = DelayFixed(
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["EASOC", "PROTRA PP solid fossil"]),
        {"REGIONS 35 I": ["EASOC"], "NRG PRO I": ["PROTRA PP solid fossil"]},
        ["REGIONS 35 I", "NRG PRO I"],
    ),
    lambda: float(protra_lifetime().loc["EASOC", "PROTRA PP solid fossil"]),
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["EASOC", "PROTRA PP solid fossil"]),
        {"REGIONS 35 I": ["EASOC"], "NRG PRO I": ["PROTRA PP solid fossil"]},
        ["REGIONS 35 I", "NRG PRO I"],
...
_delayfixed_delay_land_use_efficiency_protra_158 = DelayFixed(
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["EASOC", "PROTRA PP solid fossil CCS"]),
        {"REGIONS 35 I": ["EASOC"], "NRG PRO I": ["PROTRA PP solid fossil CCS"]},
        ["REGIONS 35 I", "NRG PRO I"],
    ),
    lambda: float(protra_lifetime().loc["EASOC", "PROTRA PP solid fossil CCS"]),
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["EASOC", "PROTRA PP solid fossil CCS"]),
        {"REGIONS 35 I": ["EASOC"], "NRG PRO I": ["PROTRA PP solid fossil CCS"]},
        ["REGIONS 35 I", "NRG PRO I"],
...
_delayfixed_delay_land_use_efficiency_protra_159 = DelayFixed(
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["EASOC", "PROTRA PP waste"]),
        {"REGIONS 35 I": ["EASOC"], "NRG PRO I": ["PROTRA PP waste"]},
        ["REGIONS 35 I", "NRG PRO I"],
    ),
    lambda: float(protra_lifetime().loc["EASOC", "PROTRA PP waste"]),
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["EASOC", "PROTRA PP waste"]),
        {"REGIONS 35 I": ["EASOC"], "NRG PRO I": ["PROTRA PP waste"]},
        ["REGIONS 35 I", "NRG PRO I"],
...
_delayfixed_delay_land_use_efficiency_protra_160 = DelayFixed(
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["EASOC", "PROTRA PP waste CCS"]),
        {"REGIONS 35 I": ["EASOC"], "NRG PRO I": ["PROTRA PP waste CCS"]},
        ["REGIONS 35 I", "NRG PRO I"],
    ),
    lambda: float(protra_lifetime().loc["EASOC", "PROTRA PP waste CCS"]),
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["EASOC", "PROTRA PP waste CCS"]),
        {"REGIONS 35 I": ["EASOC"], "NRG PRO I": ["PROTRA PP waste CCS"]},
        ["REGIONS 35 I", "NRG PRO I"],
...
_delayfixed_delay_land_use_efficiency_protra_161 = DelayFixed(
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["EASOC", "PROTRA PP wind offshore"]),
        {"REGIONS 35 I": ["EASOC"], "NRG PRO I": ["PROTRA PP wind offshore"]},
        ["REGIONS 35 I", "NRG PRO I"],
    ),
    lambda: float(protra_lifetime().loc["EASOC", "PROTRA PP wind offshore"]),
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["EASOC", "PROTRA PP wind offshore"]),
        {"REGIONS 35 I": ["EASOC"], "NRG PRO I": ["PROTRA PP wind offshore"]},
        ["REGIONS 35 I", "NRG PRO I"],
...
_delayfixed_delay_land_use_efficiency_protra_162 = DelayFixed(
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["EASOC", "PROTRA PP wind onshore"]),
        {"REGIONS 35 I": ["EASOC"], "NRG PRO I": ["PROTRA PP wind onshore"]},
        ["REGIONS 35 I", "NRG PRO I"],
    ),
    lambda: float(protra_lifetime().loc["EASOC", "PROTRA PP wind onshore"]),
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["EASOC", "PROTRA PP wind onshore"]),
        {"REGIONS 35 I": ["EASOC"], "NRG PRO I": ["PROTRA PP wind onshore"]},
        ["REGIONS 35 I", "NRG PRO I"],
...
_delayfixed_delay_land_use_efficiency_protra_163 = DelayFixed(
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["EASOC", "PROTRA blending gas fuels"]),
        {"REGIONS 35 I": ["EASOC"], "NRG PRO I": ["PROTRA blending gas fuels"]},
        ["REGIONS 35 I", "NRG PRO I"],
    ),
    lambda: float(protra_lifetime().loc["EASOC", "PROTRA blending gas fuels"]),
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["EASOC", "PROTRA blending gas fuels"]),
        {"REGIONS 35 I": ["EASOC"], "NRG PRO I": ["PROTRA blending gas fuels"]},
        ["REGIONS 35 I", "NRG PRO I"],
...
_delayfixed_delay_land_use_efficiency_protra_164 = DelayFixed(
    lambda: xr.DataArray(
        float(
            land_use_efficiency_protra().loc["EASOC", "PROTRA blending liquid fuels"]
        ),
        {"REGIONS 35 I": ["EASOC"], "NRG PRO I": ["PROTRA blending liquid fuels"]},
        ["REGIONS 35 I", "NRG PRO I"],
    ),
    lambda: float(protra_lifetime().loc["EASOC", "PROTRA blending liquid fuels"]),
    lambda: xr.DataArray(
        float(
            land_use_efficiency_protra().loc["EASOC", "PROTRA blending liquid fuels"]
        ),
...
_delayfixed_delay_land_use_efficiency_protra_165 = DelayFixed(
    lambda: xr.DataArray(
        float(
            land_use_efficiency_protra().loc["EASOC", "PROTRA no process TI hydrogen"]
        ),
        {"REGIONS 35 I": ["EASOC"], "NRG PRO I": ["PROTRA no process TI hydrogen"]},
        ["REGIONS 35 I", "NRG PRO I"],
    ),
    lambda: float(protra_lifetime().loc["EASOC", "PROTRA no process TI hydrogen"]),
    lambda: xr.DataArray(
        float(
            land_use_efficiency_protra().loc["EASOC", "PROTRA no process TI hydrogen"]
        ),
...
_delayfixed_delay_land_use_efficiency_protra_166 = DelayFixed(
    lambda: xr.DataArray(
        float(
            land_use_efficiency_protra().loc["EASOC", "PROTRA no process TI solid bio"]
        ),
        {"REGIONS 35 I": ["EASOC"], "NRG PRO I": ["PROTRA no process TI solid bio"]},
        ["REGIONS 35 I", "NRG PRO I"],
    ),
    lambda: float(protra_lifetime().loc["EASOC", "PROTRA no process TI solid bio"]),
    lambda: xr.DataArray(
        float(
            land_use_efficiency_protra().loc["EASOC", "PROTRA no process TI solid bio"]
        ),
...
_delayfixed_delay_land_use_efficiency_protra_167 = DelayFixed(
    lambda: xr.DataArray(
        float(
            land_use_efficiency_protra().loc[
                "EASOC", "PROTRA no process TI solid fossil"
            ]
        ),
        {"REGIONS 35 I": ["EASOC"], "NRG PRO I": ["PROTRA no process TI solid fossil"]},
        ["REGIONS 35 I", "NRG PRO I"],
    ),
    lambda: float(protra_lifetime().loc["EASOC", "PROTRA no process TI solid fossil"]),
    lambda: xr.DataArray(
        float(
            land_use_efficiency_protra().loc[
                "EASOC", "PROTRA no process TI solid fossil"
...
_delayfixed_delay_land_use_efficiency_protra_168 = DelayFixed(
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["INDIA", "PROTRA CHP gas fuels"]),
        {"REGIONS 35 I": ["INDIA"], "NRG PRO I": ["PROTRA CHP gas fuels"]},
        ["REGIONS 35 I", "NRG PRO I"],
    ),
    lambda: float(protra_lifetime().loc["INDIA", "PROTRA CHP gas fuels"]),
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["INDIA", "PROTRA CHP gas fuels"]),
        {"REGIONS 35 I": ["INDIA"], "NRG PRO I": ["PROTRA CHP gas fuels"]},
        ["REGIONS 35 I", "NRG PRO I"],
...
_delayfixed_delay_land_use_efficiency_protra_169 = DelayFixed(
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["INDIA", "PROTRA CHP gas fuels CCS"]),
        {"REGIONS 35 I": ["INDIA"], "NRG PRO I": ["PROTRA CHP gas fuels CCS"]},
        ["REGIONS 35 I", "NRG PRO I"],
    ),
    lambda: float(protra_lifetime().loc["INDIA", "PROTRA CHP gas fuels CCS"]),
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["INDIA", "PROTRA CHP gas fuels CCS"]),
        {"REGIONS 35 I": ["INDIA"], "NRG PRO I": ["PROTRA CHP gas fuels CCS"]},
        ["REGIONS 35 I", "NRG PRO I"],
...
_delayfixed_delay_land_use_efficiency_protra_170 = DelayFixed(
    lambda: xr.DataArray(
        float(
            land_use_efficiency_protra().loc[
                "INDIA", "PROTRA CHP geothermal DEACTIVATED"
            ]
        ),
        {"REGIONS 35 I": ["INDIA"], "NRG PRO I": ["PROTRA CHP geothermal DEACTIVATED"]},
        ["REGIONS 35 I", "NRG PRO I"],
    ),
    lambda: float(protra_lifetime().loc["INDIA", "PROTRA CHP geothermal DEACTIVATED"]),
    lambda: xr.DataArray(
        float(
            land_use_efficiency_protra().loc[
                "INDIA", "PROTRA CHP geothermal DEACTIVATED"
...
_delayfixed_delay_land_use_efficiency_protra_171 = DelayFixed(
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["INDIA", "PROTRA CHP liquid fuels"]),
        {"REGIONS 35 I": ["INDIA"], "NRG PRO I": ["PROTRA CHP liquid fuels"]},
        ["REGIONS 35 I", "NRG PRO I"],
    ),
    lambda: float(protra_lifetime().loc["INDIA", "PROTRA CHP liquid fuels"]),
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["INDIA", "PROTRA CHP liquid fuels"]),
        {"REGIONS 35 I": ["INDIA"], "NRG PRO I": ["PROTRA CHP liquid fuels"]},
        ["REGIONS 35 I", "NRG PRO I"],
...
_delayfixed_delay_land_use_efficiency_protra_172 = DelayFixed(
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["INDIA", "PROTRA CHP liquid fuels CCS"]),
        {"REGIONS 35 I": ["INDIA"], "NRG PRO I": ["PROTRA CHP liquid fuels CCS"]},
        ["REGIONS 35 I", "NRG PRO I"],
    ),
    lambda: float(protra_lifetime().loc["INDIA", "PROTRA CHP liquid fuels CCS"]),
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["INDIA", "PROTRA CHP liquid fuels CCS"]),
        {"REGIONS 35 I": ["INDIA"], "NRG PRO I": ["PROTRA CHP liquid fuels CCS"]},
        ["REGIONS 35 I", "NRG PRO I"],
...
_delayfixed_delay_land_use_efficiency_protra_173 = DelayFixed(
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["INDIA", "PROTRA CHP solid fossil"]),
        {"REGIONS 35 I": ["INDIA"], "NRG PRO I": ["PROTRA CHP solid fossil"]},
        ["REGIONS 35 I", "NRG PRO I"],
    ),
    lambda: float(protra_lifetime().loc["INDIA", "PROTRA CHP solid fossil"]),
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["INDIA", "PROTRA CHP solid fossil"]),
        {"REGIONS 35 I": ["INDIA"], "NRG PRO I": ["PROTRA CHP solid fossil"]},
        ["REGIONS 35 I", "NRG PRO I"],
...
_delayfixed_delay_land_use_efficiency_protra_174 = DelayFixed(
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["INDIA", "PROTRA CHP solid fossil CCS"]),
        {"REGIONS 35 I": ["INDIA"], "NRG PRO I": ["PROTRA CHP solid fossil CCS"]},
        ["REGIONS 35 I", "NRG PRO I"],
    ),
    lambda: float(protra_lifetime().loc["INDIA", "PROTRA CHP solid fossil CCS"]),
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["INDIA", "PROTRA CHP solid fossil CCS"]),
        {"REGIONS 35 I": ["INDIA"], "NRG PRO I": ["PROTRA CHP solid fossil CCS"]},
        ["REGIONS 35 I", "NRG PRO I"],
...
_delayfixed_delay_land_use_efficiency_protra_175 = DelayFixed(
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["INDIA", "PROTRA CHP waste"]),
        {"REGIONS 35 I": ["INDIA"], "NRG PRO I": ["PROTRA CHP waste"]},
        ["REGIONS 35 I", "NRG PRO I"],
    ),
    lambda: float(protra_lifetime().loc["INDIA", "PROTRA CHP waste"]),
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["INDIA", "PROTRA CHP waste"]),
        {"REGIONS 35 I": ["INDIA"], "NRG PRO I": ["PROTRA CHP waste"]},
        ["REGIONS 35 I", "NRG PRO I"],
...
_delayfixed_delay_land_use_efficiency_protra_176 = DelayFixed(
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["INDIA", "PROTRA CHP solid bio"]),
        {"REGIONS 35 I": ["INDIA"], "NRG PRO I": ["PROTRA CHP solid bio"]},
        ["REGIONS 35 I", "NRG PRO I"],
    ),
    lambda: float(protra_lifetime().loc["INDIA", "PROTRA CHP solid bio"]),
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["INDIA", "PROTRA CHP solid bio"]),
        {"REGIONS 35 I": ["INDIA"], "NRG PRO I": ["PROTRA CHP solid bio"]},
        ["REGIONS 35 I", "NRG PRO I"],
...
_delayfixed_delay_land_use_efficiency_protra_177 = DelayFixed(
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["INDIA", "PROTRA CHP solid bio CCS"]),
        {"REGIONS 35 I": ["INDIA"], "NRG PRO I": ["PROTRA CHP solid bio CCS"]},
        ["REGIONS 35 I", "NRG PRO I"],
    ),
    lambda: float(protra_lifetime().loc["INDIA", "PROTRA CHP solid bio CCS"]),
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["INDIA", "PROTRA CHP solid bio CCS"]),
        {"REGIONS 35 I": ["INDIA"], "NRG PRO I": ["PROTRA CHP solid bio CCS"]},
        ["REGIONS 35 I", "NRG PRO I"],
...
_delayfixed_delay_land_use_efficiency_protra_178 = DelayFixed(
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["INDIA", "PROTRA HP gas fuels"]),
        {"REGIONS 35 I": ["INDIA"], "NRG PRO I": ["PROTRA HP gas fuels"]},
        ["REGIONS 35 I", "NRG PRO I"],
    ),
    lambda: float(protra_lifetime().loc["INDIA", "PROTRA HP gas fuels"]),
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["INDIA", "PROTRA HP gas fuels"]),
        {"REGIONS 35 I": ["INDIA"], "NRG PRO I": ["PROTRA HP gas fuels"]},
        ["REGIONS 35 I", "NRG PRO I"],
...
_delayfixed_delay_land_use_efficiency_protra_179 = DelayFixed(
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["INDIA", "PROTRA HP solid bio"]),
        {"REGIONS 35 I": ["INDIA"], "NRG PRO I": ["PROTRA HP solid bio"]},
        ["REGIONS 35 I", "NRG PRO I"],
    ),
    lambda: float(protra_lifetime().loc["INDIA", "PROTRA HP solid bio"]),
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["INDIA", "PROTRA HP solid bio"]),
        {"REGIONS 35 I": ["INDIA"], "NRG PRO I": ["PROTRA HP solid bio"]},
        ["REGIONS 35 I", "NRG PRO I"],
...
_delayfixed_delay_land_use_efficiency_protra_180 = DelayFixed(
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["INDIA", "PROTRA HP geothermal"]),
        {"REGIONS 35 I": ["INDIA"], "NRG PRO I": ["PROTRA HP geothermal"]},
        ["REGIONS 35 I", "NRG PRO I"],
    ),
    lambda: float(protra_lifetime().loc["INDIA", "PROTRA HP geothermal"]),
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["INDIA", "PROTRA HP geothermal"]),
        {"REGIONS 35 I": ["INDIA"], "NRG PRO I": ["PROTRA HP geothermal"]},
        ["REGIONS 35 I", "NRG PRO I"],
...
_delayfixed_delay_land_use_efficiency_protra_181 = DelayFixed(
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["INDIA", "PROTRA HP liquid fuels"]),
        {"REGIONS 35 I": ["INDIA"], "NRG PRO I": ["PROTRA HP liquid fuels"]},
        ["REGIONS 35 I", "NRG PRO I"],
    ),
    lambda: float(protra_lifetime().loc["INDIA", "PROTRA HP liquid fuels"]),
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["INDIA", "PROTRA HP liquid fuels"]),
        {"REGIONS 35 I": ["INDIA"], "NRG PRO I": ["PROTRA HP liquid fuels"]},
        ["REGIONS 35 I", "NRG PRO I"],
...
_delayfixed_delay_land_use_efficiency_protra_182 = DelayFixed(
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["INDIA", "PROTRA HP solar DEACTIVATED"]),
        {"REGIONS 35 I": ["INDIA"], "NRG PRO I": ["PROTRA HP solar DEACTIVATED"]},
        ["REGIONS 35 I", "NRG PRO I"],
    ),
    lambda: float(protra_lifetime().loc["INDIA", "PROTRA HP solar DEACTIVATED"]),
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["INDIA", "PROTRA HP solar DEACTIVATED"]),
        {"REGIONS 35 I": ["INDIA"], "NRG PRO I": ["PROTRA HP solar DEACTIVATED"]},
        ["REGIONS 35 I", "NRG PRO I"],
...
_delayfixed_delay_land_use_efficiency_protra_183 = DelayFixed(
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["INDIA", "PROTRA HP solid fossil"]),
        {"REGIONS 35 I": ["INDIA"], "NRG PRO I": ["PROTRA HP solid fossil"]},
        ["REGIONS 35 I", "NRG PRO I"],
    ),
    lambda: float(protra_lifetime().loc["INDIA", "PROTRA HP solid fossil"]),
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["INDIA", "PROTRA HP solid fossil"]),
        {"REGIONS 35 I": ["INDIA"], "NRG PRO I": ["PROTRA HP solid fossil"]},
        ["REGIONS 35 I", "NRG PRO I"],
...
_delayfixed_delay_land_use_efficiency_protra_184 = DelayFixed(
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["INDIA", "PROTRA HP waste"]),
        {"REGIONS 35 I": ["INDIA"], "NRG PRO I": ["PROTRA HP waste"]},
        ["REGIONS 35 I", "NRG PRO I"],
    ),
    lambda: float(protra_lifetime().loc["INDIA", "PROTRA HP waste"]),
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["INDIA", "PROTRA HP waste"]),
        {"REGIONS 35 I": ["INDIA"], "NRG PRO I": ["PROTRA HP waste"]},
        ["REGIONS 35 I", "NRG PRO I"],
...
_delayfixed_delay_land_use_efficiency_protra_185 = DelayFixed(
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["INDIA", "PROTRA PP solid bio"]),
        {"REGIONS 35 I": ["INDIA"], "NRG PRO I": ["PROTRA PP solid bio"]},
        ["REGIONS 35 I", "NRG PRO I"],
    ),
    lambda: float(protra_lifetime().loc["INDIA", "PROTRA PP solid bio"]),
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["INDIA", "PROTRA PP solid bio"]),
        {"REGIONS 35 I": ["INDIA"], "NRG PRO I": ["PROTRA PP solid bio"]},
        ["REGIONS 35 I", "NRG PRO I"],
...
_delayfixed_delay_land_use_efficiency_protra_186 = DelayFixed(
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["INDIA", "PROTRA PP solid bio CCS"]),
        {"REGIONS 35 I": ["INDIA"], "NRG PRO I": ["PROTRA PP solid bio CCS"]},
        ["REGIONS 35 I", "NRG PRO I"],
    ),
    lambda: float(protra_lifetime().loc["INDIA", "PROTRA PP solid bio CCS"]),
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["INDIA", "PROTRA PP solid bio CCS"]),
        {"REGIONS 35 I": ["INDIA"], "NRG PRO I": ["PROTRA PP solid bio CCS"]},
        ["REGIONS 35 I", "NRG PRO I"],
...
_delayfixed_delay_land_use_efficiency_protra_187 = DelayFixed(
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["INDIA", "PROTRA PP gas fuels"]),
        {"REGIONS 35 I": ["INDIA"], "NRG PRO I": ["PROTRA PP gas fuels"]},
        ["REGIONS 35 I", "NRG PRO I"],
    ),
    lambda: float(protra_lifetime().loc["INDIA", "PROTRA PP gas fuels"]),
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["INDIA", "PROTRA PP gas fuels"]),
        {"REGIONS 35 I": ["INDIA"], "NRG PRO I": ["PROTRA PP gas fuels"]},
        ["REGIONS 35 I", "NRG PRO I"],
...
_delayfixed_delay_land_use_efficiency_protra_188 = DelayFixed(
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["INDIA", "PROTRA PP gas fuels CCS"]),
        {"REGIONS 35 I": ["INDIA"], "NRG PRO I": ["PROTRA PP gas fuels CCS"]},
        ["REGIONS 35 I", "NRG PRO I"],
    ),
    lambda: float(protra_lifetime().loc["INDIA", "PROTRA PP gas fuels CCS"]),
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["INDIA", "PROTRA PP gas fuels CCS"]),
        {"REGIONS 35 I": ["INDIA"], "NRG PRO I": ["PROTRA PP gas fuels CCS"]},
        ["REGIONS 35 I", "NRG PRO I"],
...
_delayfixed_delay_land_use_efficiency_protra_189 = DelayFixed(
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["INDIA", "PROTRA PP geothermal"]),
        {"REGIONS 35 I": ["INDIA"], "NRG PRO I": ["PROTRA PP geothermal"]},
        ["REGIONS 35 I", "NRG PRO I"],
    ),
    lambda: float(protra_lifetime().loc["INDIA", "PROTRA PP geothermal"]),
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["INDIA", "PROTRA PP geothermal"]),
        {"REGIONS 35 I": ["INDIA"], "NRG PRO I": ["PROTRA PP geothermal"]},
        ["REGIONS 35 I", "NRG PRO I"],
...
_delayfixed_delay_land_use_efficiency_protra_190 = DelayFixed(
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["INDIA", "PROTRA PP hydropower dammed"]),
        {"REGIONS 35 I": ["INDIA"], "NRG PRO I": ["PROTRA PP hydropower dammed"]},
        ["REGIONS 35 I", "NRG PRO I"],
    ),
    lambda: float(protra_lifetime().loc["INDIA", "PROTRA PP hydropower dammed"]),
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["INDIA", "PROTRA PP hydropower dammed"]),
        {"REGIONS 35 I": ["INDIA"], "NRG PRO I": ["PROTRA PP hydropower dammed"]},
        ["REGIONS 35 I", "NRG PRO I"],
...
_delayfixed_delay_land_use_efficiency_protra_191 = DelayFixed(
    lambda: xr.DataArray(
        float(
            land_use_efficiency_protra().loc[
                "INDIA", "PROTRA PP hydropower run of river"
            ]
        ),
        {"REGIONS 35 I": ["INDIA"], "NRG PRO I": ["PROTRA PP hydropower run of river"]},
        ["REGIONS 35 I", "NRG PRO I"],
    ),
    lambda: float(protra_lifetime().loc["INDIA", "PROTRA PP hydropower run of river"]),
    lambda: xr.DataArray(
        float(
            land_use_efficiency_protra().loc[
                "INDIA", "PROTRA PP hydropower run of river"
...
_delayfixed_delay_land_use_efficiency_protra_192 = DelayFixed(
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["INDIA", "PROTRA PP liquid fuels"]),
        {"REGIONS 35 I": ["INDIA"], "NRG PRO I": ["PROTRA PP liquid fuels"]},
        ["REGIONS 35 I", "NRG PRO I"],
    ),
    lambda: float(protra_lifetime().loc["INDIA", "PROTRA PP liquid fuels"]),
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["INDIA", "PROTRA PP liquid fuels"]),
        {"REGIONS 35 I": ["INDIA"], "NRG PRO I": ["PROTRA PP liquid fuels"]},
        ["REGIONS 35 I", "NRG PRO I"],
...
_delayfixed_delay_land_use_efficiency_protra_193 = DelayFixed(
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["INDIA", "PROTRA PP liquid fuels CCS"]),
        {"REGIONS 35 I": ["INDIA"], "NRG PRO I": ["PROTRA PP liquid fuels CCS"]},
        ["REGIONS 35 I", "NRG PRO I"],
    ),
    lambda: float(protra_lifetime().loc["INDIA", "PROTRA PP liquid fuels CCS"]),
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["INDIA", "PROTRA PP liquid fuels CCS"]),
        {"REGIONS 35 I": ["INDIA"], "NRG PRO I": ["PROTRA PP liquid fuels CCS"]},
        ["REGIONS 35 I", "NRG PRO I"],
...
_delayfixed_delay_land_use_efficiency_protra_194 = DelayFixed(
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["INDIA", "PROTRA PP nuclear"]),
        {"REGIONS 35 I": ["INDIA"], "NRG PRO I": ["PROTRA PP nuclear"]},
        ["REGIONS 35 I", "NRG PRO I"],
    ),
    lambda: float(protra_lifetime().loc["INDIA", "PROTRA PP nuclear"]),
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["INDIA", "PROTRA PP nuclear"]),
        {"REGIONS 35 I": ["INDIA"], "NRG PRO I": ["PROTRA PP nuclear"]},
        ["REGIONS 35 I", "NRG PRO I"],
...
_delayfixed_delay_land_use_efficiency_protra_195 = DelayFixed(
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["INDIA", "PROTRA PP oceanic"]),
        {"REGIONS 35 I": ["INDIA"], "NRG PRO I": ["PROTRA PP oceanic"]},
        ["REGIONS 35 I", "NRG PRO I"],
    ),
    lambda: float(protra_lifetime().loc["INDIA", "PROTRA PP oceanic"]),
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["INDIA", "PROTRA PP oceanic"]),
        {"REGIONS 35 I": ["INDIA"], "NRG PRO I": ["PROTRA PP oceanic"]},
        ["REGIONS 35 I", "NRG PRO I"],
...
_delayfixed_delay_land_use_efficiency_protra_196 = DelayFixed(
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["INDIA", "PROTRA PP solar CSP"]),
        {"REGIONS 35 I": ["INDIA"], "NRG PRO I": ["PROTRA PP solar CSP"]},
        ["REGIONS 35 I", "NRG PRO I"],
    ),
    lambda: float(protra_lifetime().loc["INDIA", "PROTRA PP solar CSP"]),
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["INDIA", "PROTRA PP solar CSP"]),
        {"REGIONS 35 I": ["INDIA"], "NRG PRO I": ["PROTRA PP solar CSP"]},
        ["REGIONS 35 I", "NRG PRO I"],
...
_delayfixed_delay_land_use_efficiency_protra_197 = DelayFixed(
    lambda: xr.DataArray(
        float(
            land_use_efficiency_protra().loc["INDIA", "PROTRA PP solar open space PV"]
        ),
        {"REGIONS 35 I": ["INDIA"], "NRG PRO I": ["PROTRA PP solar open space PV"]},
        ["REGIONS 35 I", "NRG PRO I"],
    ),
    lambda: float(protra_lifetime().loc["INDIA", "PROTRA PP solar open space PV"]),
    lambda: xr.DataArray(
        float(
            land_use_efficiency_protra().loc["INDIA", "PROTRA PP solar open space PV"]
        ),
...
_delayfixed_delay_land_use_efficiency_protra_198 = DelayFixed(
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["INDIA", "PROTRA PP solar urban PV"]),
        {"REGIONS 35 I": ["INDIA"], "NRG PRO I": ["PROTRA PP solar urban PV"]},
        ["REGIONS 35 I", "NRG PRO I"],
    ),
    lambda: float(protra_lifetime().loc["INDIA", "PROTRA PP solar urban PV"]),
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["INDIA", "PROTRA PP solar urban PV"]),
        {"REGIONS 35 I": ["INDIA"], "NRG PRO I": ["PROTRA PP solar urban PV"]},
        ["REGIONS 35 I", "NRG PRO I"],
...
_delayfixed_delay_land_use_efficiency_protra_199 = DelayFixed(
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["INDIA", "PROTRA PP solid fossil"]),
        {"REGIONS 35 I": ["INDIA"], "NRG PRO I": ["PROTRA PP solid fossil"]},
        ["REGIONS 35 I", "NRG PRO I"],
    ),
    lambda: float(protra_lifetime().loc["INDIA", "PROTRA PP solid fossil"]),
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["INDIA", "PROTRA PP solid fossil"]),
        {"REGIONS 35 I": ["INDIA"], "NRG PRO I": ["PROTRA PP solid fossil"]},
        ["REGIONS 35 I", "NRG PRO I"],
...
_delayfixed_delay_land_use_efficiency_protra_200 = DelayFixed(
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["INDIA", "PROTRA PP solid fossil CCS"]),
        {"REGIONS 35 I": ["INDIA"], "NRG PRO I": ["PROTRA PP solid fossil CCS"]},
        ["REGIONS 35 I", "NRG PRO I"],
    ),
    lambda: float(protra_lifetime().loc["INDIA", "PROTRA PP solid fossil CCS"]),
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["INDIA", "PROTRA PP solid fossil CCS"]),
        {"REGIONS 35 I": ["INDIA"], "NRG PRO I": ["PROTRA PP solid fossil CCS"]},
        ["REGIONS 35 I", "NRG PRO I"],
...
_delayfixed_delay_land_use_efficiency_protra_201 = DelayFixed(
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["INDIA", "PROTRA PP waste"]),
        {"REGIONS 35 I": ["INDIA"], "NRG PRO I": ["PROTRA PP waste"]},
        ["REGIONS 35 I", "NRG PRO I"],
    ),
    lambda: float(protra_lifetime().loc["INDIA", "PROTRA PP waste"]),
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["INDIA", "PROTRA PP waste"]),
        {"REGIONS 35 I": ["INDIA"], "NRG PRO I": ["PROTRA PP waste"]},
        ["REGIONS 35 I", "NRG PRO I"],
...
_delayfixed_delay_land_use_efficiency_protra_202 = DelayFixed(
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["INDIA", "PROTRA PP waste CCS"]),
        {"REGIONS 35 I": ["INDIA"], "NRG PRO I": ["PROTRA PP waste CCS"]},
        ["REGIONS 35 I", "NRG PRO I"],
    ),
    lambda: float(protra_lifetime().loc["INDIA", "PROTRA PP waste CCS"]),
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["INDIA", "PROTRA PP waste CCS"]),
        {"REGIONS 35 I": ["INDIA"], "NRG PRO I": ["PROTRA PP waste CCS"]},
        ["REGIONS 35 I", "NRG PRO I"],
...
_delayfixed_delay_land_use_efficiency_protra_203 = DelayFixed(
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["INDIA", "PROTRA PP wind offshore"]),
        {"REGIONS 35 I": ["INDIA"], "NRG PRO I": ["PROTRA PP wind offshore"]},
        ["REGIONS 35 I", "NRG PRO I"],
    ),
    lambda: float(protra_lifetime().loc["INDIA", "PROTRA PP wind offshore"]),
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["INDIA", "PROTRA PP wind offshore"]),
        {"REGIONS 35 I": ["INDIA"], "NRG PRO I": ["PROTRA PP wind offshore"]},
        ["REGIONS 35 I", "NRG PRO I"],
...
_delayfixed_delay_land_use_efficiency_protra_204 = DelayFixed(
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["INDIA", "PROTRA PP wind onshore"]),
        {"REGIONS 35 I": ["INDIA"], "NRG PRO I": ["PROTRA PP wind onshore"]},
        ["REGIONS 35 I", "NRG PRO I"],
    ),
    lambda: float(protra_lifetime().loc["INDIA", "PROTRA PP wind onshore"]),
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["INDIA", "PROTRA PP wind onshore"]),
        {"REGIONS 35 I": ["INDIA"], "NRG PRO I": ["PROTRA PP wind onshore"]},
        ["REGIONS 35 I", "NRG PRO I"],
...
_delayfixed_delay_land_use_efficiency_protra_205 = DelayFixed(
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["INDIA", "PROTRA blending gas fuels"]),
        {"REGIONS 35 I": ["INDIA"], "NRG PRO I": ["PROTRA blending gas fuels"]},
        ["REGIONS 35 I", "NRG PRO I"],
    ),
    lambda: float(protra_lifetime().loc["INDIA", "PROTRA blending gas fuels"]),
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["INDIA", "PROTRA blending gas fuels"]),
        {"REGIONS 35 I": ["INDIA"], "NRG PRO I": ["PROTRA blending gas fuels"]},
        ["REGIONS 35 I", "NRG PRO I"],
...
_delayfixed_delay_land_use_efficiency_protra_206 = DelayFixed(
    lambda: xr.DataArray(
        float(
            land_use_efficiency_protra().loc["INDIA", "PROTRA blending liquid fuels"]
        ),
        {"REGIONS 35 I": ["INDIA"], "NRG PRO I": ["PROTRA blending liquid fuels"]},
        ["REGIONS 35 I", "NRG PRO I"],
    ),
    lambda: float(protra_lifetime().loc["INDIA", "PROTRA blending liquid fuels"]),
    lambda: xr.DataArray(
        float(
            land_use_efficiency_protra().loc["INDIA", "PROTRA blending liquid fuels"]
        ),
...
_delayfixed_delay_land_use_efficiency_protra_207 = DelayFixed(
    lambda: xr.DataArray(
        float(
            land_use_efficiency_protra().loc["INDIA", "PROTRA no process TI hydrogen"]
        ),
        {"REGIONS 35 I": ["INDIA"], "NRG PRO I": ["PROTRA no process TI hydrogen"]},
        ["REGIONS 35 I", "NRG PRO I"],
    ),
    lambda: float(protra_lifetime().loc["INDIA", "PROTRA no process TI hydrogen"]),
    lambda: xr.DataArray(
        float(
            land_use_efficiency_protra().loc["INDIA", "PROTRA no process TI hydrogen"]
        ),
...
_delayfixed_delay_land_use_efficiency_protra_208 = DelayFixed(
    lambda: xr.DataArray(
        float(
            land_use_efficiency_protra().loc["INDIA", "PROTRA no process TI solid bio"]
        ),
        {"REGIONS 35 I": ["INDIA"], "NRG PRO I": ["PROTRA no process TI solid bio"]},
        ["REGIONS 35 I", "NRG PRO I"],
    ),
    lambda: float(protra_lifetime().loc["INDIA", "PROTRA no process TI solid bio"]),
    lambda: xr.DataArray(
        float(
            land_use_efficiency_protra().loc["INDIA", "PROTRA no process TI solid bio"]
        ),
...
_delayfixed_delay_land_use_efficiency_protra_209 = DelayFixed(
    lambda: xr.DataArray(
        float(
            land_use_efficiency_protra().loc[
                "INDIA", "PROTRA no process TI solid fossil"
            ]
        ),
        {"REGIONS 35 I": ["INDIA"], "NRG PRO I": ["PROTRA no process TI solid fossil"]},
        ["REGIONS 35 I", "NRG PRO I"],
    ),
    lambda: float(protra_lifetime().loc["INDIA", "PROTRA no process TI solid fossil"]),
    lambda: xr.DataArray(
        float(
            land_use_efficiency_protra().loc[
                "INDIA", "PROTRA no process TI solid fossil"
...
_delayfixed_delay_land_use_efficiency_protra_210 = DelayFixed(
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["LATAM", "PROTRA CHP gas fuels"]),
        {"REGIONS 35 I": ["LATAM"], "NRG PRO I": ["PROTRA CHP gas fuels"]},
        ["REGIONS 35 I", "NRG PRO I"],
    ),
    lambda: float(protra_lifetime().loc["LATAM", "PROTRA CHP gas fuels"]),
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["LATAM", "PROTRA CHP gas fuels"]),
        {"REGIONS 35 I": ["LATAM"], "NRG PRO I": ["PROTRA CHP gas fuels"]},
        ["REGIONS 35 I", "NRG PRO I"],
...
_delayfixed_delay_land_use_efficiency_protra_211 = DelayFixed(
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["LATAM", "PROTRA CHP gas fuels CCS"]),
        {"REGIONS 35 I": ["LATAM"], "NRG PRO I": ["PROTRA CHP gas fuels CCS"]},
        ["REGIONS 35 I", "NRG PRO I"],
    ),
    lambda: float(protra_lifetime().loc["LATAM", "PROTRA CHP gas fuels CCS"]),
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["LATAM", "PROTRA CHP gas fuels CCS"]),
        {"REGIONS 35 I": ["LATAM"], "NRG PRO I": ["PROTRA CHP gas fuels CCS"]},
        ["REGIONS 35 I", "NRG PRO I"],
...
_delayfixed_delay_land_use_efficiency_protra_212 = DelayFixed(
    lambda: xr.DataArray(
        float(
            land_use_efficiency_protra().loc[
                "LATAM", "PROTRA CHP geothermal DEACTIVATED"
            ]
        ),
        {"REGIONS 35 I": ["LATAM"], "NRG PRO I": ["PROTRA CHP geothermal DEACTIVATED"]},
        ["REGIONS 35 I", "NRG PRO I"],
    ),
    lambda: float(protra_lifetime().loc["LATAM", "PROTRA CHP geothermal DEACTIVATED"]),
    lambda: xr.DataArray(
        float(
            land_use_efficiency_protra().loc[
                "LATAM", "PROTRA CHP geothermal DEACTIVATED"
...
_delayfixed_delay_land_use_efficiency_protra_213 = DelayFixed(
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["LATAM", "PROTRA CHP liquid fuels"]),
        {"REGIONS 35 I": ["LATAM"], "NRG PRO I": ["PROTRA CHP liquid fuels"]},
        ["REGIONS 35 I", "NRG PRO I"],
    ),
    lambda: float(protra_lifetime().loc["LATAM", "PROTRA CHP liquid fuels"]),
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["LATAM", "PROTRA CHP liquid fuels"]),
        {"REGIONS 35 I": ["LATAM"], "NRG PRO I": ["PROTRA CHP liquid fuels"]},
        ["REGIONS 35 I", "NRG PRO I"],
...
_delayfixed_delay_land_use_efficiency_protra_214 = DelayFixed(
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["LATAM", "PROTRA CHP liquid fuels CCS"]),
        {"REGIONS 35 I": ["LATAM"], "NRG PRO I": ["PROTRA CHP liquid fuels CCS"]},
        ["REGIONS 35 I", "NRG PRO I"],
    ),
    lambda: float(protra_lifetime().loc["LATAM", "PROTRA CHP liquid fuels CCS"]),
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["LATAM", "PROTRA CHP liquid fuels CCS"]),
        {"REGIONS 35 I": ["LATAM"], "NRG PRO I": ["PROTRA CHP liquid fuels CCS"]},
        ["REGIONS 35 I", "NRG PRO I"],
...
_delayfixed_delay_land_use_efficiency_protra_215 = DelayFixed(
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["LATAM", "PROTRA CHP solid fossil"]),
        {"REGIONS 35 I": ["LATAM"], "NRG PRO I": ["PROTRA CHP solid fossil"]},
        ["REGIONS 35 I", "NRG PRO I"],
    ),
    lambda: float(protra_lifetime().loc["LATAM", "PROTRA CHP solid fossil"]),
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["LATAM", "PROTRA CHP solid fossil"]),
        {"REGIONS 35 I": ["LATAM"], "NRG PRO I": ["PROTRA CHP solid fossil"]},
        ["REGIONS 35 I", "NRG PRO I"],
...
_delayfixed_delay_land_use_efficiency_protra_216 = DelayFixed(
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["LATAM", "PROTRA CHP solid fossil CCS"]),
        {"REGIONS 35 I": ["LATAM"], "NRG PRO I": ["PROTRA CHP solid fossil CCS"]},
        ["REGIONS 35 I", "NRG PRO I"],
    ),
    lambda: float(protra_lifetime().loc["LATAM", "PROTRA CHP solid fossil CCS"]),
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["LATAM", "PROTRA CHP solid fossil CCS"]),
        {"REGIONS 35 I": ["LATAM"], "NRG PRO I": ["PROTRA CHP solid fossil CCS"]},
        ["REGIONS 35 I", "NRG PRO I"],
...
_delayfixed_delay_land_use_efficiency_protra_217 = DelayFixed(
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["LATAM", "PROTRA CHP waste"]),
        {"REGIONS 35 I": ["LATAM"], "NRG PRO I": ["PROTRA CHP waste"]},
        ["REGIONS 35 I", "NRG PRO I"],
    ),
    lambda: float(protra_lifetime().loc["LATAM", "PROTRA CHP waste"]),
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["LATAM", "PROTRA CHP waste"]),
        {"REGIONS 35 I": ["LATAM"], "NRG PRO I": ["PROTRA CHP waste"]},
        ["REGIONS 35 I", "NRG PRO I"],
...
_delayfixed_delay_land_use_efficiency_protra_218 = DelayFixed(
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["LATAM", "PROTRA CHP solid bio"]),
        {"REGIONS 35 I": ["LATAM"], "NRG PRO I": ["PROTRA CHP solid bio"]},
        ["REGIONS 35 I", "NRG PRO I"],
    ),
    lambda: float(protra_lifetime().loc["LATAM", "PROTRA CHP solid bio"]),
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["LATAM", "PROTRA CHP solid bio"]),
        {"REGIONS 35 I": ["LATAM"], "NRG PRO I": ["PROTRA CHP solid bio"]},
        ["REGIONS 35 I", "NRG PRO I"],
...
_delayfixed_delay_land_use_efficiency_protra_219 = DelayFixed(
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["LATAM", "PROTRA CHP solid bio CCS"]),
        {"REGIONS 35 I": ["LATAM"], "NRG PRO I": ["PROTRA CHP solid bio CCS"]},
        ["REGIONS 35 I", "NRG PRO I"],
    ),
    lambda: float(protra_lifetime().loc["LATAM", "PROTRA CHP solid bio CCS"]),
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["LATAM", "PROTRA CHP solid bio CCS"]),
        {"REGIONS 35 I": ["LATAM"], "NRG PRO I": ["PROTRA CHP solid bio CCS"]},
        ["REGIONS 35 I", "NRG PRO I"],
...
_delayfixed_delay_land_use_efficiency_protra_220 = DelayFixed(
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["LATAM", "PROTRA HP gas fuels"]),
        {"REGIONS 35 I": ["LATAM"], "NRG PRO I": ["PROTRA HP gas fuels"]},
        ["REGIONS 35 I", "NRG PRO I"],
    ),
    lambda: float(protra_lifetime().loc["LATAM", "PROTRA HP gas fuels"]),
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["LATAM", "PROTRA HP gas fuels"]),
        {"REGIONS 35 I": ["LATAM"], "NRG PRO I": ["PROTRA HP gas fuels"]},
        ["REGIONS 35 I", "NRG PRO I"],
...
_delayfixed_delay_land_use_efficiency_protra_221 = DelayFixed(
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["LATAM", "PROTRA HP solid bio"]),
        {"REGIONS 35 I": ["LATAM"], "NRG PRO I": ["PROTRA HP solid bio"]},
        ["REGIONS 35 I", "NRG PRO I"],
    ),
    lambda: float(protra_lifetime().loc["LATAM", "PROTRA HP solid bio"]),
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["LATAM", "PROTRA HP solid bio"]),
        {"REGIONS 35 I": ["LATAM"], "NRG PRO I": ["PROTRA HP solid bio"]},
        ["REGIONS 35 I", "NRG PRO I"],
...
_delayfixed_delay_land_use_efficiency_protra_222 = DelayFixed(
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["LATAM", "PROTRA HP geothermal"]),
        {"REGIONS 35 I": ["LATAM"], "NRG PRO I": ["PROTRA HP geothermal"]},
        ["REGIONS 35 I", "NRG PRO I"],
    ),
    lambda: float(protra_lifetime().loc["LATAM", "PROTRA HP geothermal"]),
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["LATAM", "PROTRA HP geothermal"]),
        {"REGIONS 35 I": ["LATAM"], "NRG PRO I": ["PROTRA HP geothermal"]},
        ["REGIONS 35 I", "NRG PRO I"],
...
_delayfixed_delay_land_use_efficiency_protra_223 = DelayFixed(
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["LATAM", "PROTRA HP liquid fuels"]),
        {"REGIONS 35 I": ["LATAM"], "NRG PRO I": ["PROTRA HP liquid fuels"]},
        ["REGIONS 35 I", "NRG PRO I"],
    ),
    lambda: float(protra_lifetime().loc["LATAM", "PROTRA HP liquid fuels"]),
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["LATAM", "PROTRA HP liquid fuels"]),
        {"REGIONS 35 I": ["LATAM"], "NRG PRO I": ["PROTRA HP liquid fuels"]},
        ["REGIONS 35 I", "NRG PRO I"],
...
_delayfixed_delay_land_use_efficiency_protra_224 = DelayFixed(
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["LATAM", "PROTRA HP solar DEACTIVATED"]),
        {"REGIONS 35 I": ["LATAM"], "NRG PRO I": ["PROTRA HP solar DEACTIVATED"]},
        ["REGIONS 35 I", "NRG PRO I"],
    ),
    lambda: float(protra_lifetime().loc["LATAM", "PROTRA HP solar DEACTIVATED"]),
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["LATAM", "PROTRA HP solar DEACTIVATED"]),
        {"REGIONS 35 I": ["LATAM"], "NRG PRO I": ["PROTRA HP solar DEACTIVATED"]},
        ["REGIONS 35 I", "NRG PRO I"],
...
_delayfixed_delay_land_use_efficiency_protra_225 = DelayFixed(
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["LATAM", "PROTRA HP solid fossil"]),
        {"REGIONS 35 I": ["LATAM"], "NRG PRO I": ["PROTRA HP solid fossil"]},
        ["REGIONS 35 I", "NRG PRO I"],
    ),
    lambda: float(protra_lifetime().loc["LATAM", "PROTRA HP solid fossil"]),
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["LATAM", "PROTRA HP solid fossil"]),
        {"REGIONS 35 I": ["LATAM"], "NRG PRO I": ["PROTRA HP solid fossil"]},
        ["REGIONS 35 I", "NRG PRO I"],
...
_delayfixed_delay_land_use_efficiency_protra_226 = DelayFixed(
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["LATAM", "PROTRA HP waste"]),
        {"REGIONS 35 I": ["LATAM"], "NRG PRO I": ["PROTRA HP waste"]},
        ["REGIONS 35 I", "NRG PRO I"],
    ),
    lambda: float(protra_lifetime().loc["LATAM", "PROTRA HP waste"]),
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["LATAM", "PROTRA HP waste"]),
        {"REGIONS 35 I": ["LATAM"], "NRG PRO I": ["PROTRA HP waste"]},
        ["REGIONS 35 I", "NRG PRO I"],
...
_delayfixed_delay_land_use_efficiency_protra_227 = DelayFixed(
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["LATAM", "PROTRA PP solid bio"]),
        {"REGIONS 35 I": ["LATAM"], "NRG PRO I": ["PROTRA PP solid bio"]},
        ["REGIONS 35 I", "NRG PRO I"],
    ),
    lambda: float(protra_lifetime().loc["LATAM", "PROTRA PP solid bio"]),
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["LATAM", "PROTRA PP solid bio"]),
        {"REGIONS 35 I": ["LATAM"], "NRG PRO I": ["PROTRA PP solid bio"]},
        ["REGIONS 35 I", "NRG PRO I"],
...
_delayfixed_delay_land_use_efficiency_protra_228 = DelayFixed(
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["LATAM", "PROTRA PP solid bio CCS"]),
        {"REGIONS 35 I": ["LATAM"], "NRG PRO I": ["PROTRA PP solid bio CCS"]},
        ["REGIONS 35 I", "NRG PRO I"],
    ),
    lambda: float(protra_lifetime().loc["LATAM", "PROTRA PP solid bio CCS"]),
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["LATAM", "PROTRA PP solid bio CCS"]),
        {"REGIONS 35 I": ["LATAM"], "NRG PRO I": ["PROTRA PP solid bio CCS"]},
        ["REGIONS 35 I", "NRG PRO I"],
...
_delayfixed_delay_land_use_efficiency_protra_229 = DelayFixed(
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["LATAM", "PROTRA PP gas fuels"]),
        {"REGIONS 35 I": ["LATAM"], "NRG PRO I": ["PROTRA PP gas fuels"]},
        ["REGIONS 35 I", "NRG PRO I"],
    ),
    lambda: float(protra_lifetime().loc["LATAM", "PROTRA PP gas fuels"]),
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["LATAM", "PROTRA PP gas fuels"]),
        {"REGIONS 35 I": ["LATAM"], "NRG PRO I": ["PROTRA PP gas fuels"]},
        ["REGIONS 35 I", "NRG PRO I"],
...
_delayfixed_delay_land_use_efficiency_protra_230 = DelayFixed(
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["LATAM", "PROTRA PP gas fuels CCS"]),
        {"REGIONS 35 I": ["LATAM"], "NRG PRO I": ["PROTRA PP gas fuels CCS"]},
        ["REGIONS 35 I", "NRG PRO I"],
    ),
    lambda: float(protra_lifetime().loc["LATAM", "PROTRA PP gas fuels CCS"]),
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["LATAM", "PROTRA PP gas fuels CCS"]),
        {"REGIONS 35 I": ["LATAM"], "NRG PRO I": ["PROTRA PP gas fuels CCS"]},
        ["REGIONS 35 I", "NRG PRO I"],
...
_delayfixed_delay_land_use_efficiency_protra_231 = DelayFixed(
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["LATAM", "PROTRA PP geothermal"]),
        {"REGIONS 35 I": ["LATAM"], "NRG PRO I": ["PROTRA PP geothermal"]},
        ["REGIONS 35 I", "NRG PRO I"],
    ),
    lambda: float(protra_lifetime().loc["LATAM", "PROTRA PP geothermal"]),
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["LATAM", "PROTRA PP geothermal"]),
        {"REGIONS 35 I": ["LATAM"], "NRG PRO I": ["PROTRA PP geothermal"]},
        ["REGIONS 35 I", "NRG PRO I"],
...
_delayfixed_delay_land_use_efficiency_protra_232 = DelayFixed(
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["LATAM", "PROTRA PP hydropower dammed"]),
        {"REGIONS 35 I": ["LATAM"], "NRG PRO I": ["PROTRA PP hydropower dammed"]},
        ["REGIONS 35 I", "NRG PRO I"],
    ),
    lambda: float(protra_lifetime().loc["LATAM", "PROTRA PP hydropower dammed"]),
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["LATAM", "PROTRA PP hydropower dammed"]),
        {"REGIONS 35 I": ["LATAM"], "NRG PRO I": ["PROTRA PP hydropower dammed"]},
        ["REGIONS 35 I", "NRG PRO I"],
...
_delayfixed_delay_land_use_efficiency_protra_233 = DelayFixed(
    lambda: xr.DataArray(
        float(
            land_use_efficiency_protra().loc[
                "LATAM", "PROTRA PP hydropower run of river"
            ]
        ),
        {"REGIONS 35 I": ["LATAM"], "NRG PRO I": ["PROTRA PP hydropower run of river"]},
        ["REGIONS 35 I", "NRG PRO I"],
    ),
    lambda: float(protra_lifetime().loc["LATAM", "PROTRA PP hydropower run of river"]),
    lambda: xr.DataArray(
        float(
            land_use_efficiency_protra().loc[
                "LATAM", "PROTRA PP hydropower run of river"
...
_delayfixed_delay_land_use_efficiency_protra_234 = DelayFixed(
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["LATAM", "PROTRA PP liquid fuels"]),
        {"REGIONS 35 I": ["LATAM"], "NRG PRO I": ["PROTRA PP liquid fuels"]},
        ["REGIONS 35 I", "NRG PRO I"],
    ),
    lambda: float(protra_lifetime().loc["LATAM", "PROTRA PP liquid fuels"]),
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["LATAM", "PROTRA PP liquid fuels"]),
        {"REGIONS 35 I": ["LATAM"], "NRG PRO I": ["PROTRA PP liquid fuels"]},
        ["REGIONS 35 I", "NRG PRO I"],
...
_delayfixed_delay_land_use_efficiency_protra_235 = DelayFixed(
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["LATAM", "PROTRA PP liquid fuels CCS"]),
        {"REGIONS 35 I": ["LATAM"], "NRG PRO I": ["PROTRA PP liquid fuels CCS"]},
        ["REGIONS 35 I", "NRG PRO I"],
    ),
    lambda: float(protra_lifetime().loc["LATAM", "PROTRA PP liquid fuels CCS"]),
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["LATAM", "PROTRA PP liquid fuels CCS"]),
        {"REGIONS 35 I": ["LATAM"], "NRG PRO I": ["PROTRA PP liquid fuels CCS"]},
        ["REGIONS 35 I", "NRG PRO I"],
...
_delayfixed_delay_land_use_efficiency_protra_236 = DelayFixed(
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["LATAM", "PROTRA PP nuclear"]),
        {"REGIONS 35 I": ["LATAM"], "NRG PRO I": ["PROTRA PP nuclear"]},
        ["REGIONS 35 I", "NRG PRO I"],
    ),
    lambda: float(protra_lifetime().loc["LATAM", "PROTRA PP nuclear"]),
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["LATAM", "PROTRA PP nuclear"]),
        {"REGIONS 35 I": ["LATAM"], "NRG PRO I": ["PROTRA PP nuclear"]},
        ["REGIONS 35 I", "NRG PRO I"],
...
_delayfixed_delay_land_use_efficiency_protra_237 = DelayFixed(
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["LATAM", "PROTRA PP oceanic"]),
        {"REGIONS 35 I": ["LATAM"], "NRG PRO I": ["PROTRA PP oceanic"]},
        ["REGIONS 35 I", "NRG PRO I"],
    ),
    lambda: float(protra_lifetime().loc["LATAM", "PROTRA PP oceanic"]),
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["LATAM", "PROTRA PP oceanic"]),
        {"REGIONS 35 I": ["LATAM"], "NRG PRO I": ["PROTRA PP oceanic"]},
        ["REGIONS 35 I", "NRG PRO I"],
...
_delayfixed_delay_land_use_efficiency_protra_238 = DelayFixed(
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["LATAM", "PROTRA PP solar CSP"]),
        {"REGIONS 35 I": ["LATAM"], "NRG PRO I": ["PROTRA PP solar CSP"]},
        ["REGIONS 35 I", "NRG PRO I"],
    ),
    lambda: float(protra_lifetime().loc["LATAM", "PROTRA PP solar CSP"]),
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["LATAM", "PROTRA PP solar CSP"]),
        {"REGIONS 35 I": ["LATAM"], "NRG PRO I": ["PROTRA PP solar CSP"]},
        ["REGIONS 35 I", "NRG PRO I"],
...
_delayfixed_delay_land_use_efficiency_protra_239 = DelayFixed(
    lambda: xr.DataArray(
        float(
            land_use_efficiency_protra().loc["LATAM", "PROTRA PP solar open space PV"]
        ),
        {"REGIONS 35 I": ["LATAM"], "NRG PRO I": ["PROTRA PP solar open space PV"]},
        ["REGIONS 35 I", "NRG PRO I"],
    ),
    lambda: float(protra_lifetime().loc["LATAM", "PROTRA PP solar open space PV"]),
    lambda: xr.DataArray(
        float(
            land_use_efficiency_protra().loc["LATAM", "PROTRA PP solar open space PV"]
        ),
...
_delayfixed_delay_land_use_efficiency_protra_240 = DelayFixed(
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["LATAM", "PROTRA PP solar urban PV"]),
        {"REGIONS 35 I": ["LATAM"], "NRG PRO I": ["PROTRA PP solar urban PV"]},
        ["REGIONS 35 I", "NRG PRO I"],
    ),
    lambda: float(protra_lifetime().loc["LATAM", "PROTRA PP solar urban PV"]),
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["LATAM", "PROTRA PP solar urban PV"]),
        {"REGIONS 35 I": ["LATAM"], "NRG PRO I": ["PROTRA PP solar urban PV"]},
        ["REGIONS 35 I", "NRG PRO I"],
...
_delayfixed_delay_land_use_efficiency_protra_241 = DelayFixed(
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["LATAM", "PROTRA PP solid fossil"]),
        {"REGIONS 35 I": ["LATAM"], "NRG PRO I": ["PROTRA PP solid fossil"]},
        ["REGIONS 35 I", "NRG PRO I"],
    ),
    lambda: float(protra_lifetime().loc["LATAM", "PROTRA PP solid fossil"]),
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["LATAM", "PROTRA PP solid fossil"]),
        {"REGIONS 35 I": ["LATAM"], "NRG PRO I": ["PROTRA PP solid fossil"]},
        ["REGIONS 35 I", "NRG PRO I"],
...
_delayfixed_delay_land_use_efficiency_protra_242 = DelayFixed(
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["LATAM", "PROTRA PP solid fossil CCS"]),
        {"REGIONS 35 I": ["LATAM"], "NRG PRO I": ["PROTRA PP solid fossil CCS"]},
        ["REGIONS 35 I", "NRG PRO I"],
    ),
    lambda: float(protra_lifetime().loc["LATAM", "PROTRA PP solid fossil CCS"]),
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["LATAM", "PROTRA PP solid fossil CCS"]),
        {"REGIONS 35 I": ["LATAM"], "NRG PRO I": ["PROTRA PP solid fossil CCS"]},
        ["REGIONS 35 I", "NRG PRO I"],
...
_delayfixed_delay_land_use_efficiency_protra_243 = DelayFixed(
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["LATAM", "PROTRA PP waste"]),
        {"REGIONS 35 I": ["LATAM"], "NRG PRO I": ["PROTRA PP waste"]},
        ["REGIONS 35 I", "NRG PRO I"],
    ),
    lambda: float(protra_lifetime().loc["LATAM", "PROTRA PP waste"]),
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["LATAM", "PROTRA PP waste"]),
        {"REGIONS 35 I": ["LATAM"], "NRG PRO I": ["PROTRA PP waste"]},
        ["REGIONS 35 I", "NRG PRO I"],
...
_delayfixed_delay_land_use_efficiency_protra_244 = DelayFixed(
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["LATAM", "PROTRA PP waste CCS"]),
        {"REGIONS 35 I": ["LATAM"], "NRG PRO I": ["PROTRA PP waste CCS"]},
        ["REGIONS 35 I", "NRG PRO I"],
    ),
    lambda: float(protra_lifetime().loc["LATAM", "PROTRA PP waste CCS"]),
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["LATAM", "PROTRA PP waste CCS"]),
        {"REGIONS 35 I": ["LATAM"], "NRG PRO I": ["PROTRA PP waste CCS"]},
        ["REGIONS 35 I", "NRG PRO I"],
...
_delayfixed_delay_land_use_efficiency_protra_245 = DelayFixed(
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["LATAM", "PROTRA PP wind offshore"]),
        {"REGIONS 35 I": ["LATAM"], "NRG PRO I": ["PROTRA PP wind offshore"]},
        ["REGIONS 35 I", "NRG PRO I"],
    ),
    lambda: float(protra_lifetime().loc["LATAM", "PROTRA PP wind offshore"]),
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["LATAM", "PROTRA PP wind offshore"]),
        {"REGIONS 35 I": ["LATAM"], "NRG PRO I": ["PROTRA PP wind offshore"]},
        ["REGIONS 35 I", "NRG PRO I"],
...
_delayfixed_delay_land_use_efficiency_protra_246 = DelayFixed(
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["LATAM", "PROTRA PP wind onshore"]),
        {"REGIONS 35 I": ["LATAM"], "NRG PRO I": ["PROTRA PP wind onshore"]},
        ["REGIONS 35 I", "NRG PRO I"],
    ),
    lambda: float(protra_lifetime().loc["LATAM", "PROTRA PP wind onshore"]),
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["LATAM", "PROTRA PP wind onshore"]),
        {"REGIONS 35 I": ["LATAM"], "NRG PRO I": ["PROTRA PP wind onshore"]},
        ["REGIONS 35 I", "NRG PRO I"],
...
_delayfixed_delay_land_use_efficiency_protra_247 = DelayFixed(
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["LATAM", "PROTRA blending gas fuels"]),
        {"REGIONS 35 I": ["LATAM"], "NRG PRO I": ["PROTRA blending gas fuels"]},
        ["REGIONS 35 I", "NRG PRO I"],
    ),
    lambda: float(protra_lifetime().loc["LATAM", "PROTRA blending gas fuels"]),
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["LATAM", "PROTRA blending gas fuels"]),
        {"REGIONS 35 I": ["LATAM"], "NRG PRO I": ["PROTRA blending gas fuels"]},
        ["REGIONS 35 I", "NRG PRO I"],
...
_delayfixed_delay_land_use_efficiency_protra_248 = DelayFixed(
    lambda: xr.DataArray(
        float(
            land_use_efficiency_protra().loc["LATAM", "PROTRA blending liquid fuels"]
        ),
        {"REGIONS 35 I": ["LATAM"], "NRG PRO I": ["PROTRA blending liquid fuels"]},
        ["REGIONS 35 I", "NRG PRO I"],
    ),
    lambda: float(protra_lifetime().loc["LATAM", "PROTRA blending liquid fuels"]),
    lambda: xr.DataArray(
        float(
            land_use_efficiency_protra().loc["LATAM", "PROTRA blending liquid fuels"]
        ),
...
_delayfixed_delay_land_use_efficiency_protra_249 = DelayFixed(
    lambda: xr.DataArray(
        float(
            land_use_efficiency_protra().loc["LATAM", "PROTRA no process TI hydrogen"]
        ),
        {"REGIONS 35 I": ["LATAM"], "NRG PRO I": ["PROTRA no process TI hydrogen"]},
        ["REGIONS 35 I", "NRG PRO I"],
    ),
    lambda: float(protra_lifetime().loc["LATAM", "PROTRA no process TI hydrogen"]),
    lambda: xr.DataArray(
        float(
            land_use_efficiency_protra().loc["LATAM", "PROTRA no process TI hydrogen"]
        ),
...
_delayfixed_delay_land_use_efficiency_protra_250 = DelayFixed(
    lambda: xr.DataArray(
        float(
            land_use_efficiency_protra().loc["LATAM", "PROTRA no process TI solid bio"]
        ),
        {"REGIONS 35 I": ["LATAM"], "NRG PRO I": ["PROTRA no process TI solid bio"]},
        ["REGIONS 35 I", "NRG PRO I"],
    ),
    lambda: float(protra_lifetime().loc["LATAM", "PROTRA no process TI solid bio"]),
    lambda: xr.DataArray(
        float(
            land_use_efficiency_protra().loc["LATAM", "PROTRA no process TI solid bio"]
        ),
...
_delayfixed_delay_land_use_efficiency_protra_251 = DelayFixed(
    lambda: xr.DataArray(
        float(
            land_use_efficiency_protra().loc[
                "LATAM", "PROTRA no process TI solid fossil"
            ]
        ),
        {"REGIONS 35 I": ["LATAM"], "NRG PRO I": ["PROTRA no process TI solid fossil"]},
        ["REGIONS 35 I", "NRG PRO I"],
    ),
    lambda: float(protra_lifetime().loc["LATAM", "PROTRA no process TI solid fossil"]),
    lambda: xr.DataArray(
        float(
            land_use_efficiency_protra().loc[
                "LATAM", "PROTRA no process TI solid fossil"
...
_delayfixed_delay_land_use_efficiency_protra_252 = DelayFixed(
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["RUSSIA", "PROTRA CHP gas fuels"]),
        {"REGIONS 35 I": ["RUSSIA"], "NRG PRO I": ["PROTRA CHP gas fuels"]},
        ["REGIONS 35 I", "NRG PRO I"],
    ),
    lambda: float(protra_lifetime().loc["RUSSIA", "PROTRA CHP gas fuels"]),
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["RUSSIA", "PROTRA CHP gas fuels"]),
        {"REGIONS 35 I": ["RUSSIA"], "NRG PRO I": ["PROTRA CHP gas fuels"]},
        ["REGIONS 35 I", "NRG PRO I"],
...
_delayfixed_delay_land_use_efficiency_protra_253 = DelayFixed(
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["RUSSIA", "PROTRA CHP gas fuels CCS"]),
        {"REGIONS 35 I": ["RUSSIA"], "NRG PRO I": ["PROTRA CHP gas fuels CCS"]},
        ["REGIONS 35 I", "NRG PRO I"],
    ),
    lambda: float(protra_lifetime().loc["RUSSIA", "PROTRA CHP gas fuels CCS"]),
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["RUSSIA", "PROTRA CHP gas fuels CCS"]),
        {"REGIONS 35 I": ["RUSSIA"], "NRG PRO I": ["PROTRA CHP gas fuels CCS"]},
        ["REGIONS 35 I", "NRG PRO I"],
...
_delayfixed_delay_land_use_efficiency_protra_254 = DelayFixed(
    lambda: xr.DataArray(
        float(
            land_use_efficiency_protra().loc[
                "RUSSIA", "PROTRA CHP geothermal DEACTIVATED"
            ]
        ),
        {
            "REGIONS 35 I": ["RUSSIA"],
            "NRG PRO I": ["PROTRA CHP geothermal DEACTIVATED"],
        },
        ["REGIONS 35 I", "NRG PRO I"],
    ),
    lambda: float(protra_lifetime().loc["RUSSIA", "PROTRA CHP geothermal DEACTIVATED"]),
    lambda: xr.DataArray(
        float(
            land_use_efficiency_protra().loc[
                "RUSSIA", "PROTRA CHP geothermal DEACTIVATED"
...
_delayfixed_delay_land_use_efficiency_protra_255 = DelayFixed(
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["RUSSIA", "PROTRA CHP liquid fuels"]),
        {"REGIONS 35 I": ["RUSSIA"], "NRG PRO I": ["PROTRA CHP liquid fuels"]},
        ["REGIONS 35 I", "NRG PRO I"],
    ),
    lambda: float(protra_lifetime().loc["RUSSIA", "PROTRA CHP liquid fuels"]),
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["RUSSIA", "PROTRA CHP liquid fuels"]),
        {"REGIONS 35 I": ["RUSSIA"], "NRG PRO I": ["PROTRA CHP liquid fuels"]},
        ["REGIONS 35 I", "NRG PRO I"],
...
_delayfixed_delay_land_use_efficiency_protra_256 = DelayFixed(
    lambda: xr.DataArray(
        float(
            land_use_efficiency_protra().loc["RUSSIA", "PROTRA CHP liquid fuels CCS"]
        ),
        {"REGIONS 35 I": ["RUSSIA"], "NRG PRO I": ["PROTRA CHP liquid fuels CCS"]},
        ["REGIONS 35 I", "NRG PRO I"],
    ),
    lambda: float(protra_lifetime().loc["RUSSIA", "PROTRA CHP liquid fuels CCS"]),
    lambda: xr.DataArray(
        float(
            land_use_efficiency_protra().loc["RUSSIA", "PROTRA CHP liquid fuels CCS"]
        ),
...
_delayfixed_delay_land_use_efficiency_protra_257 = DelayFixed(
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["RUSSIA", "PROTRA CHP solid fossil"]),
        {"REGIONS 35 I": ["RUSSIA"], "NRG PRO I": ["PROTRA CHP solid fossil"]},
        ["REGIONS 35 I", "NRG PRO I"],
    ),
    lambda: float(protra_lifetime().loc["RUSSIA", "PROTRA CHP solid fossil"]),
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["RUSSIA", "PROTRA CHP solid fossil"]),
        {"REGIONS 35 I": ["RUSSIA"], "NRG PRO I": ["PROTRA CHP solid fossil"]},
        ["REGIONS 35 I", "NRG PRO I"],
...
_delayfixed_delay_land_use_efficiency_protra_258 = DelayFixed(
    lambda: xr.DataArray(
        float(
            land_use_efficiency_protra().loc["RUSSIA", "PROTRA CHP solid fossil CCS"]
        ),
        {"REGIONS 35 I": ["RUSSIA"], "NRG PRO I": ["PROTRA CHP solid fossil CCS"]},
        ["REGIONS 35 I", "NRG PRO I"],
    ),
    lambda: float(protra_lifetime().loc["RUSSIA", "PROTRA CHP solid fossil CCS"]),
    lambda: xr.DataArray(
        float(
            land_use_efficiency_protra().loc["RUSSIA", "PROTRA CHP solid fossil CCS"]
        ),
...
_delayfixed_delay_land_use_efficiency_protra_259 = DelayFixed(
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["RUSSIA", "PROTRA CHP waste"]),
        {"REGIONS 35 I": ["RUSSIA"], "NRG PRO I": ["PROTRA CHP waste"]},
        ["REGIONS 35 I", "NRG PRO I"],
    ),
    lambda: float(protra_lifetime().loc["RUSSIA", "PROTRA CHP waste"]),
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["RUSSIA", "PROTRA CHP waste"]),
        {"REGIONS 35 I": ["RUSSIA"], "NRG PRO I": ["PROTRA CHP waste"]},
        ["REGIONS 35 I", "NRG PRO I"],
...
_delayfixed_delay_land_use_efficiency_protra_260 = DelayFixed(
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["RUSSIA", "PROTRA CHP solid bio"]),
        {"REGIONS 35 I": ["RUSSIA"], "NRG PRO I": ["PROTRA CHP solid bio"]},
        ["REGIONS 35 I", "NRG PRO I"],
    ),
    lambda: float(protra_lifetime().loc["RUSSIA", "PROTRA CHP solid bio"]),
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["RUSSIA", "PROTRA CHP solid bio"]),
        {"REGIONS 35 I": ["RUSSIA"], "NRG PRO I": ["PROTRA CHP solid bio"]},
        ["REGIONS 35 I", "NRG PRO I"],
...
_delayfixed_delay_land_use_efficiency_protra_261 = DelayFixed(
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["RUSSIA", "PROTRA CHP solid bio CCS"]),
        {"REGIONS 35 I": ["RUSSIA"], "NRG PRO I": ["PROTRA CHP solid bio CCS"]},
        ["REGIONS 35 I", "NRG PRO I"],
    ),
    lambda: float(protra_lifetime().loc["RUSSIA", "PROTRA CHP solid bio CCS"]),
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["RUSSIA", "PROTRA CHP solid bio CCS"]),
        {"REGIONS 35 I": ["RUSSIA"], "NRG PRO I": ["PROTRA CHP solid bio CCS"]},
        ["REGIONS 35 I", "NRG PRO I"],
...
_delayfixed_delay_land_use_efficiency_protra_262 = DelayFixed(
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["RUSSIA", "PROTRA HP gas fuels"]),
        {"REGIONS 35 I": ["RUSSIA"], "NRG PRO I": ["PROTRA HP gas fuels"]},
        ["REGIONS 35 I", "NRG PRO I"],
    ),
    lambda: float(protra_lifetime().loc["RUSSIA", "PROTRA HP gas fuels"]),
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["RUSSIA", "PROTRA HP gas fuels"]),
        {"REGIONS 35 I": ["RUSSIA"], "NRG PRO I": ["PROTRA HP gas fuels"]},
        ["REGIONS 35 I", "NRG PRO I"],
...
_delayfixed_delay_land_use_efficiency_protra_263 = DelayFixed(
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["RUSSIA", "PROTRA HP solid bio"]),
        {"REGIONS 35 I": ["RUSSIA"], "NRG PRO I": ["PROTRA HP solid bio"]},
        ["REGIONS 35 I", "NRG PRO I"],
    ),
    lambda: float(protra_lifetime().loc["RUSSIA", "PROTRA HP solid bio"]),
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["RUSSIA", "PROTRA HP solid bio"]),
        {"REGIONS 35 I": ["RUSSIA"], "NRG PRO I": ["PROTRA HP solid bio"]},
        ["REGIONS 35 I", "NRG PRO I"],
...
_delayfixed_delay_land_use_efficiency_protra_264 = DelayFixed(
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["RUSSIA", "PROTRA HP geothermal"]),
        {"REGIONS 35 I": ["RUSSIA"], "NRG PRO I": ["PROTRA HP geothermal"]},
        ["REGIONS 35 I", "NRG PRO I"],
    ),
    lambda: float(protra_lifetime().loc["RUSSIA", "PROTRA HP geothermal"]),
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["RUSSIA", "PROTRA HP geothermal"]),
        {"REGIONS 35 I": ["RUSSIA"], "NRG PRO I": ["PROTRA HP geothermal"]},
        ["REGIONS 35 I", "NRG PRO I"],
...
_delayfixed_delay_land_use_efficiency_protra_265 = DelayFixed(
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["RUSSIA", "PROTRA HP liquid fuels"]),
        {"REGIONS 35 I": ["RUSSIA"], "NRG PRO I": ["PROTRA HP liquid fuels"]},
        ["REGIONS 35 I", "NRG PRO I"],
    ),
    lambda: float(protra_lifetime().loc["RUSSIA", "PROTRA HP liquid fuels"]),
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["RUSSIA", "PROTRA HP liquid fuels"]),
        {"REGIONS 35 I": ["RUSSIA"], "NRG PRO I": ["PROTRA HP liquid fuels"]},
        ["REGIONS 35 I", "NRG PRO I"],
...
_delayfixed_delay_land_use_efficiency_protra_266 = DelayFixed(
    lambda: xr.DataArray(
        float(
            land_use_efficiency_protra().loc["RUSSIA", "PROTRA HP solar DEACTIVATED"]
        ),
        {"REGIONS 35 I": ["RUSSIA"], "NRG PRO I": ["PROTRA HP solar DEACTIVATED"]},
        ["REGIONS 35 I", "NRG PRO I"],
    ),
    lambda: float(protra_lifetime().loc["RUSSIA", "PROTRA HP solar DEACTIVATED"]),
    lambda: xr.DataArray(
        float(
            land_use_efficiency_protra().loc["RUSSIA", "PROTRA HP solar DEACTIVATED"]
        ),
...
_delayfixed_delay_land_use_efficiency_protra_267 = DelayFixed(
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["RUSSIA", "PROTRA HP solid fossil"]),
        {"REGIONS 35 I": ["RUSSIA"], "NRG PRO I": ["PROTRA HP solid fossil"]},
        ["REGIONS 35 I", "NRG PRO I"],
    ),
    lambda: float(protra_lifetime().loc["RUSSIA", "PROTRA HP solid fossil"]),
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["RUSSIA", "PROTRA HP solid fossil"]),
        {"REGIONS 35 I": ["RUSSIA"], "NRG PRO I": ["PROTRA HP solid fossil"]},
        ["REGIONS 35 I", "NRG PRO I"],
...
_delayfixed_delay_land_use_efficiency_protra_268 = DelayFixed(
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["RUSSIA", "PROTRA HP waste"]),
        {"REGIONS 35 I": ["RUSSIA"], "NRG PRO I": ["PROTRA HP waste"]},
        ["REGIONS 35 I", "NRG PRO I"],
    ),
    lambda: float(protra_lifetime().loc["RUSSIA", "PROTRA HP waste"]),
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["RUSSIA", "PROTRA HP waste"]),
        {"REGIONS 35 I": ["RUSSIA"], "NRG PRO I": ["PROTRA HP waste"]},
        ["REGIONS 35 I", "NRG PRO I"],
...
_delayfixed_delay_land_use_efficiency_protra_269 = DelayFixed(
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["RUSSIA", "PROTRA PP solid bio"]),
        {"REGIONS 35 I": ["RUSSIA"], "NRG PRO I": ["PROTRA PP solid bio"]},
        ["REGIONS 35 I", "NRG PRO I"],
    ),
    lambda: float(protra_lifetime().loc["RUSSIA", "PROTRA PP solid bio"]),
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["RUSSIA", "PROTRA PP solid bio"]),
        {"REGIONS 35 I": ["RUSSIA"], "NRG PRO I": ["PROTRA PP solid bio"]},
        ["REGIONS 35 I", "NRG PRO I"],
...
_delayfixed_delay_land_use_efficiency_protra_270 = DelayFixed(
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["RUSSIA", "PROTRA PP solid bio CCS"]),
        {"REGIONS 35 I": ["RUSSIA"], "NRG PRO I": ["PROTRA PP solid bio CCS"]},
        ["REGIONS 35 I", "NRG PRO I"],
    ),
    lambda: float(protra_lifetime().loc["RUSSIA", "PROTRA PP solid bio CCS"]),
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["RUSSIA", "PROTRA PP solid bio CCS"]),
        {"REGIONS 35 I": ["RUSSIA"], "NRG PRO I": ["PROTRA PP solid bio CCS"]},
        ["REGIONS 35 I", "NRG PRO I"],
...
_delayfixed_delay_land_use_efficiency_protra_271 = DelayFixed(
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["RUSSIA", "PROTRA PP gas fuels"]),
        {"REGIONS 35 I": ["RUSSIA"], "NRG PRO I": ["PROTRA PP gas fuels"]},
        ["REGIONS 35 I", "NRG PRO I"],
    ),
    lambda: float(protra_lifetime().loc["RUSSIA", "PROTRA PP gas fuels"]),
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["RUSSIA", "PROTRA PP gas fuels"]),
        {"REGIONS 35 I": ["RUSSIA"], "NRG PRO I": ["PROTRA PP gas fuels"]},
        ["REGIONS 35 I", "NRG PRO I"],
...
_delayfixed_delay_land_use_efficiency_protra_272 = DelayFixed(
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["RUSSIA", "PROTRA PP gas fuels CCS"]),
        {"REGIONS 35 I": ["RUSSIA"], "NRG PRO I": ["PROTRA PP gas fuels CCS"]},
        ["REGIONS 35 I", "NRG PRO I"],
    ),
    lambda: float(protra_lifetime().loc["RUSSIA", "PROTRA PP gas fuels CCS"]),
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["RUSSIA", "PROTRA PP gas fuels CCS"]),
        {"REGIONS 35 I": ["RUSSIA"], "NRG PRO I": ["PROTRA PP gas fuels CCS"]},
        ["REGIONS 35 I", "NRG PRO I"],
...
_delayfixed_delay_land_use_efficiency_protra_273 = DelayFixed(
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["RUSSIA", "PROTRA PP geothermal"]),
        {"REGIONS 35 I": ["RUSSIA"], "NRG PRO I": ["PROTRA PP geothermal"]},
        ["REGIONS 35 I", "NRG PRO I"],
    ),
    lambda: float(protra_lifetime().loc["RUSSIA", "PROTRA PP geothermal"]),
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["RUSSIA", "PROTRA PP geothermal"]),
        {"REGIONS 35 I": ["RUSSIA"], "NRG PRO I": ["PROTRA PP geothermal"]},
        ["REGIONS 35 I", "NRG PRO I"],
...
_delayfixed_delay_land_use_efficiency_protra_274 = DelayFixed(
    lambda: xr.DataArray(
        float(
            land_use_efficiency_protra().loc["RUSSIA", "PROTRA PP hydropower dammed"]
        ),
        {"REGIONS 35 I": ["RUSSIA"], "NRG PRO I": ["PROTRA PP hydropower dammed"]},
        ["REGIONS 35 I", "NRG PRO I"],
    ),
    lambda: float(protra_lifetime().loc["RUSSIA", "PROTRA PP hydropower dammed"]),
    lambda: xr.DataArray(
        float(
            land_use_efficiency_protra().loc["RUSSIA", "PROTRA PP hydropower dammed"]
        ),
...
_delayfixed_delay_land_use_efficiency_protra_275 = DelayFixed(
    lambda: xr.DataArray(
        float(
            land_use_efficiency_protra().loc[
                "RUSSIA", "PROTRA PP hydropower run of river"
            ]
        ),
        {
            "REGIONS 35 I": ["RUSSIA"],
            "NRG PRO I": ["PROTRA PP hydropower run of river"],
        },
        ["REGIONS 35 I", "NRG PRO I"],
    ),
    lambda: float(protra_lifetime().loc["RUSSIA", "PROTRA PP hydropower run of river"]),
    lambda: xr.DataArray(
        float(
            land_use_efficiency_protra().loc[
                "RUSSIA", "PROTRA PP hydropower run of river"
...
_delayfixed_delay_land_use_efficiency_protra_276 = DelayFixed(
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["RUSSIA", "PROTRA PP liquid fuels"]),
        {"REGIONS 35 I": ["RUSSIA"], "NRG PRO I": ["PROTRA PP liquid fuels"]},
        ["REGIONS 35 I", "NRG PRO I"],
    ),
    lambda: float(protra_lifetime().loc["RUSSIA", "PROTRA PP liquid fuels"]),
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["RUSSIA", "PROTRA PP liquid fuels"]),
        {"REGIONS 35 I": ["RUSSIA"], "NRG PRO I": ["PROTRA PP liquid fuels"]},
        ["REGIONS 35 I", "NRG PRO I"],
...
_delayfixed_delay_land_use_efficiency_protra_277 = DelayFixed(
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["RUSSIA", "PROTRA PP liquid fuels CCS"]),
        {"REGIONS 35 I": ["RUSSIA"], "NRG PRO I": ["PROTRA PP liquid fuels CCS"]},
        ["REGIONS 35 I", "NRG PRO I"],
    ),
    lambda: float(protra_lifetime().loc["RUSSIA", "PROTRA PP liquid fuels CCS"]),
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["RUSSIA", "PROTRA PP liquid fuels CCS"]),
        {"REGIONS 35 I": ["RUSSIA"], "NRG PRO I": ["PROTRA PP liquid fuels CCS"]},
        ["REGIONS 35 I", "NRG PRO I"],
...
_delayfixed_delay_land_use_efficiency_protra_278 = DelayFixed(
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["RUSSIA", "PROTRA PP nuclear"]),
        {"REGIONS 35 I": ["RUSSIA"], "NRG PRO I": ["PROTRA PP nuclear"]},
        ["REGIONS 35 I", "NRG PRO I"],
    ),
    lambda: float(protra_lifetime().loc["RUSSIA", "PROTRA PP nuclear"]),
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["RUSSIA", "PROTRA PP nuclear"]),
        {"REGIONS 35 I": ["RUSSIA"], "NRG PRO I": ["PROTRA PP nuclear"]},
        ["REGIONS 35 I", "NRG PRO I"],
...
_delayfixed_delay_land_use_efficiency_protra_279 = DelayFixed(
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["RUSSIA", "PROTRA PP oceanic"]),
        {"REGIONS 35 I": ["RUSSIA"], "NRG PRO I": ["PROTRA PP oceanic"]},
        ["REGIONS 35 I", "NRG PRO I"],
    ),
    lambda: float(protra_lifetime().loc["RUSSIA", "PROTRA PP oceanic"]),
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["RUSSIA", "PROTRA PP oceanic"]),
        {"REGIONS 35 I": ["RUSSIA"], "NRG PRO I": ["PROTRA PP oceanic"]},
        ["REGIONS 35 I", "NRG PRO I"],
...
_delayfixed_delay_land_use_efficiency_protra_280 = DelayFixed(
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["RUSSIA", "PROTRA PP solar CSP"]),
        {"REGIONS 35 I": ["RUSSIA"], "NRG PRO I": ["PROTRA PP solar CSP"]},
        ["REGIONS 35 I", "NRG PRO I"],
    ),
    lambda: float(protra_lifetime().loc["RUSSIA", "PROTRA PP solar CSP"]),
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["RUSSIA", "PROTRA PP solar CSP"]),
        {"REGIONS 35 I": ["RUSSIA"], "NRG PRO I": ["PROTRA PP solar CSP"]},
        ["REGIONS 35 I", "NRG PRO I"],
...
_delayfixed_delay_land_use_efficiency_protra_281 = DelayFixed(
    lambda: xr.DataArray(
        float(
            land_use_efficiency_protra().loc["RUSSIA", "PROTRA PP solar open space PV"]
        ),
        {"REGIONS 35 I": ["RUSSIA"], "NRG PRO I": ["PROTRA PP solar open space PV"]},
        ["REGIONS 35 I", "NRG PRO I"],
    ),
    lambda: float(protra_lifetime().loc["RUSSIA", "PROTRA PP solar open space PV"]),
    lambda: xr.DataArray(
        float(
            land_use_efficiency_protra().loc["RUSSIA", "PROTRA PP solar open space PV"]
        ),
...
_delayfixed_delay_land_use_efficiency_protra_282 = DelayFixed(
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["RUSSIA", "PROTRA PP solar urban PV"]),
        {"REGIONS 35 I": ["RUSSIA"], "NRG PRO I": ["PROTRA PP solar urban PV"]},
        ["REGIONS 35 I", "NRG PRO I"],
    ),
    lambda: float(protra_lifetime().loc["RUSSIA", "PROTRA PP solar urban PV"]),
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["RUSSIA", "PROTRA PP solar urban PV"]),
        {"REGIONS 35 I": ["RUSSIA"], "NRG PRO I": ["PROTRA PP solar urban PV"]},
        ["REGIONS 35 I", "NRG PRO I"],
...
_delayfixed_delay_land_use_efficiency_protra_283 = DelayFixed(
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["RUSSIA", "PROTRA PP solid fossil"]),
        {"REGIONS 35 I": ["RUSSIA"], "NRG PRO I": ["PROTRA PP solid fossil"]},
        ["REGIONS 35 I", "NRG PRO I"],
    ),
    lambda: float(protra_lifetime().loc["RUSSIA", "PROTRA PP solid fossil"]),
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["RUSSIA", "PROTRA PP solid fossil"]),
        {"REGIONS 35 I": ["RUSSIA"], "NRG PRO I": ["PROTRA PP solid fossil"]},
        ["REGIONS 35 I", "NRG PRO I"],
...
_delayfixed_delay_land_use_efficiency_protra_284 = DelayFixed(
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["RUSSIA", "PROTRA PP solid fossil CCS"]),
        {"REGIONS 35 I": ["RUSSIA"], "NRG PRO I": ["PROTRA PP solid fossil CCS"]},
        ["REGIONS 35 I", "NRG PRO I"],
    ),
    lambda: float(protra_lifetime().loc["RUSSIA", "PROTRA PP solid fossil CCS"]),
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["RUSSIA", "PROTRA PP solid fossil CCS"]),
        {"REGIONS 35 I": ["RUSSIA"], "NRG PRO I": ["PROTRA PP solid fossil CCS"]},
        ["REGIONS 35 I", "NRG PRO I"],
...
_delayfixed_delay_land_use_efficiency_protra_285 = DelayFixed(
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["RUSSIA", "PROTRA PP waste"]),
        {"REGIONS 35 I": ["RUSSIA"], "NRG PRO I": ["PROTRA PP waste"]},
        ["REGIONS 35 I", "NRG PRO I"],
    ),
    lambda: float(protra_lifetime().loc["RUSSIA", "PROTRA PP waste"]),
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["RUSSIA", "PROTRA PP waste"]),
        {"REGIONS 35 I": ["RUSSIA"], "NRG PRO I": ["PROTRA PP waste"]},
        ["REGIONS 35 I", "NRG PRO I"],
...
_delayfixed_delay_land_use_efficiency_protra_286 = DelayFixed(
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["RUSSIA", "PROTRA PP waste CCS"]),
        {"REGIONS 35 I": ["RUSSIA"], "NRG PRO I": ["PROTRA PP waste CCS"]},
        ["REGIONS 35 I", "NRG PRO I"],
    ),
    lambda: float(protra_lifetime().loc["RUSSIA", "PROTRA PP waste CCS"]),
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["RUSSIA", "PROTRA PP waste CCS"]),
        {"REGIONS 35 I": ["RUSSIA"], "NRG PRO I": ["PROTRA PP waste CCS"]},
        ["REGIONS 35 I", "NRG PRO I"],
...
_delayfixed_delay_land_use_efficiency_protra_287 = DelayFixed(
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["RUSSIA", "PROTRA PP wind offshore"]),
        {"REGIONS 35 I": ["RUSSIA"], "NRG PRO I": ["PROTRA PP wind offshore"]},
        ["REGIONS 35 I", "NRG PRO I"],
    ),
    lambda: float(protra_lifetime().loc["RUSSIA", "PROTRA PP wind offshore"]),
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["RUSSIA", "PROTRA PP wind offshore"]),
        {"REGIONS 35 I": ["RUSSIA"], "NRG PRO I": ["PROTRA PP wind offshore"]},
        ["REGIONS 35 I", "NRG PRO I"],
...
_delayfixed_delay_land_use_efficiency_protra_288 = DelayFixed(
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["RUSSIA", "PROTRA PP wind onshore"]),
        {"REGIONS 35 I": ["RUSSIA"], "NRG PRO I": ["PROTRA PP wind onshore"]},
        ["REGIONS 35 I", "NRG PRO I"],
    ),
    lambda: float(protra_lifetime().loc["RUSSIA", "PROTRA PP wind onshore"]),
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["RUSSIA", "PROTRA PP wind onshore"]),
        {"REGIONS 35 I": ["RUSSIA"], "NRG PRO I": ["PROTRA PP wind onshore"]},
        ["REGIONS 35 I", "NRG PRO I"],
...
_delayfixed_delay_land_use_efficiency_protra_289 = DelayFixed(
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["RUSSIA", "PROTRA blending gas fuels"]),
        {"REGIONS 35 I": ["RUSSIA"], "NRG PRO I": ["PROTRA blending gas fuels"]},
        ["REGIONS 35 I", "NRG PRO I"],
    ),
    lambda: float(protra_lifetime().loc["RUSSIA", "PROTRA blending gas fuels"]),
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["RUSSIA", "PROTRA blending gas fuels"]),
        {"REGIONS 35 I": ["RUSSIA"], "NRG PRO I": ["PROTRA blending gas fuels"]},
        ["REGIONS 35 I", "NRG PRO I"],
...
_delayfixed_delay_land_use_efficiency_protra_290 = DelayFixed(
    lambda: xr.DataArray(
        float(
            land_use_efficiency_protra().loc["RUSSIA", "PROTRA blending liquid fuels"]
        ),
        {"REGIONS 35 I": ["RUSSIA"], "NRG PRO I": ["PROTRA blending liquid fuels"]},
        ["REGIONS 35 I", "NRG PRO I"],
    ),
    lambda: float(protra_lifetime().loc["RUSSIA", "PROTRA blending liquid fuels"]),
    lambda: xr.DataArray(
        float(
            land_use_efficiency_protra().loc["RUSSIA", "PROTRA blending liquid fuels"]
        ),
...
_delayfixed_delay_land_use_efficiency_protra_291 = DelayFixed(
    lambda: xr.DataArray(
        float(
            land_use_efficiency_protra().loc["RUSSIA", "PROTRA no process TI hydrogen"]
        ),
        {"REGIONS 35 I": ["RUSSIA"], "NRG PRO I": ["PROTRA no process TI hydrogen"]},
        ["REGIONS 35 I", "NRG PRO I"],
    ),
    lambda: float(protra_lifetime().loc["RUSSIA", "PROTRA no process TI hydrogen"]),
    lambda: xr.DataArray(
        float(
            land_use_efficiency_protra().loc["RUSSIA", "PROTRA no process TI hydrogen"]
        ),
...
_delayfixed_delay_land_use_efficiency_protra_292 = DelayFixed(
    lambda: xr.DataArray(
        float(
            land_use_efficiency_protra().loc["RUSSIA", "PROTRA no process TI solid bio"]
        ),
        {"REGIONS 35 I": ["RUSSIA"], "NRG PRO I": ["PROTRA no process TI solid bio"]},
        ["REGIONS 35 I", "NRG PRO I"],
    ),
    lambda: float(protra_lifetime().loc["RUSSIA", "PROTRA no process TI solid bio"]),
    lambda: xr.DataArray(
        float(
            land_use_efficiency_protra().loc["RUSSIA", "PROTRA no process TI solid bio"]
        ),
...
_delayfixed_delay_land_use_efficiency_protra_293 = DelayFixed(
    lambda: xr.DataArray(
        float(
            land_use_efficiency_protra().loc[
                "RUSSIA", "PROTRA no process TI solid fossil"
            ]
        ),
        {
            "REGIONS 35 I": ["RUSSIA"],
            "NRG PRO I": ["PROTRA no process TI solid fossil"],
        },
        ["REGIONS 35 I", "NRG PRO I"],
    ),
    lambda: float(protra_lifetime().loc["RUSSIA", "PROTRA no process TI solid fossil"]),
    lambda: xr.DataArray(
        float(
            land_use_efficiency_protra().loc[
                "RUSSIA", "PROTRA no process TI solid fossil"
...
_delayfixed_delay_land_use_efficiency_protra_294 = DelayFixed(
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["USMCA", "PROTRA CHP gas fuels"]),
        {"REGIONS 35 I": ["USMCA"], "NRG PRO I": ["PROTRA CHP gas fuels"]},
        ["REGIONS 35 I", "NRG PRO I"],
    ),
    lambda: float(protra_lifetime().loc["USMCA", "PROTRA CHP gas fuels"]),
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["USMCA", "PROTRA CHP gas fuels"]),
        {"REGIONS 35 I": ["USMCA"], "NRG PRO I": ["PROTRA CHP gas fuels"]},
        ["REGIONS 35 I", "NRG PRO I"],
...
_delayfixed_delay_land_use_efficiency_protra_295 = DelayFixed(
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["USMCA", "PROTRA CHP gas fuels CCS"]),
        {"REGIONS 35 I": ["USMCA"], "NRG PRO I": ["PROTRA CHP gas fuels CCS"]},
        ["REGIONS 35 I", "NRG PRO I"],
    ),
    lambda: float(protra_lifetime().loc["USMCA", "PROTRA CHP gas fuels CCS"]),
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["USMCA", "PROTRA CHP gas fuels CCS"]),
        {"REGIONS 35 I": ["USMCA"], "NRG PRO I": ["PROTRA CHP gas fuels CCS"]},
        ["REGIONS 35 I", "NRG PRO I"],
...
_delayfixed_delay_land_use_efficiency_protra_296 = DelayFixed(
    lambda: xr.DataArray(
        float(
            land_use_efficiency_protra().loc[
                "USMCA", "PROTRA CHP geothermal DEACTIVATED"
            ]
        ),
        {"REGIONS 35 I": ["USMCA"], "NRG PRO I": ["PROTRA CHP geothermal DEACTIVATED"]},
        ["REGIONS 35 I", "NRG PRO I"],
    ),
    lambda: float(protra_lifetime().loc["USMCA", "PROTRA CHP geothermal DEACTIVATED"]),
    lambda: xr.DataArray(
        float(
            land_use_efficiency_protra().loc[
                "USMCA", "PROTRA CHP geothermal DEACTIVATED"
...
_delayfixed_delay_land_use_efficiency_protra_297 = DelayFixed(
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["USMCA", "PROTRA CHP liquid fuels"]),
        {"REGIONS 35 I": ["USMCA"], "NRG PRO I": ["PROTRA CHP liquid fuels"]},
        ["REGIONS 35 I", "NRG PRO I"],
    ),
    lambda: float(protra_lifetime().loc["USMCA", "PROTRA CHP liquid fuels"]),
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["USMCA", "PROTRA CHP liquid fuels"]),
        {"REGIONS 35 I": ["USMCA"], "NRG PRO I": ["PROTRA CHP liquid fuels"]},
        ["REGIONS 35 I", "NRG PRO I"],
...
_delayfixed_delay_land_use_efficiency_protra_298 = DelayFixed(
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["USMCA", "PROTRA CHP liquid fuels CCS"]),
        {"REGIONS 35 I": ["USMCA"], "NRG PRO I": ["PROTRA CHP liquid fuels CCS"]},
        ["REGIONS 35 I", "NRG PRO I"],
    ),
    lambda: float(protra_lifetime().loc["USMCA", "PROTRA CHP liquid fuels CCS"]),
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["USMCA", "PROTRA CHP liquid fuels CCS"]),
        {"REGIONS 35 I": ["USMCA"], "NRG PRO I": ["PROTRA CHP liquid fuels CCS"]},
        ["REGIONS 35 I", "NRG PRO I"],
...
_delayfixed_delay_land_use_efficiency_protra_299 = DelayFixed(
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["USMCA", "PROTRA CHP solid fossil"]),
        {"REGIONS 35 I": ["USMCA"], "NRG PRO I": ["PROTRA CHP solid fossil"]},
        ["REGIONS 35 I", "NRG PRO I"],
    ),
    lambda: float(protra_lifetime().loc["USMCA", "PROTRA CHP solid fossil"]),
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["USMCA", "PROTRA CHP solid fossil"]),
        {"REGIONS 35 I": ["USMCA"], "NRG PRO I": ["PROTRA CHP solid fossil"]},
        ["REGIONS 35 I", "NRG PRO I"],
...
_delayfixed_delay_land_use_efficiency_protra_300 = DelayFixed(
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["USMCA", "PROTRA CHP solid fossil CCS"]),
        {"REGIONS 35 I": ["USMCA"], "NRG PRO I": ["PROTRA CHP solid fossil CCS"]},
        ["REGIONS 35 I", "NRG PRO I"],
    ),
    lambda: float(protra_lifetime().loc["USMCA", "PROTRA CHP solid fossil CCS"]),
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["USMCA", "PROTRA CHP solid fossil CCS"]),
        {"REGIONS 35 I": ["USMCA"], "NRG PRO I": ["PROTRA CHP solid fossil CCS"]},
        ["REGIONS 35 I", "NRG PRO I"],
...
_delayfixed_delay_land_use_efficiency_protra_301 = DelayFixed(
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["USMCA", "PROTRA CHP waste"]),
        {"REGIONS 35 I": ["USMCA"], "NRG PRO I": ["PROTRA CHP waste"]},
        ["REGIONS 35 I", "NRG PRO I"],
    ),
    lambda: float(protra_lifetime().loc["USMCA", "PROTRA CHP waste"]),
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["USMCA", "PROTRA CHP waste"]),
        {"REGIONS 35 I": ["USMCA"], "NRG PRO I": ["PROTRA CHP waste"]},
        ["REGIONS 35 I", "NRG PRO I"],
...
_delayfixed_delay_land_use_efficiency_protra_302 = DelayFixed(
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["USMCA", "PROTRA CHP solid bio"]),
        {"REGIONS 35 I": ["USMCA"], "NRG PRO I": ["PROTRA CHP solid bio"]},
        ["REGIONS 35 I", "NRG PRO I"],
    ),
    lambda: float(protra_lifetime().loc["USMCA", "PROTRA CHP solid bio"]),
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["USMCA", "PROTRA CHP solid bio"]),
        {"REGIONS 35 I": ["USMCA"], "NRG PRO I": ["PROTRA CHP solid bio"]},
        ["REGIONS 35 I", "NRG PRO I"],
...
_delayfixed_delay_land_use_efficiency_protra_303 = DelayFixed(
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["USMCA", "PROTRA CHP solid bio CCS"]),
        {"REGIONS 35 I": ["USMCA"], "NRG PRO I": ["PROTRA CHP solid bio CCS"]},
        ["REGIONS 35 I", "NRG PRO I"],
    ),
    lambda: float(protra_lifetime().loc["USMCA", "PROTRA CHP solid bio CCS"]),
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["USMCA", "PROTRA CHP solid bio CCS"]),
        {"REGIONS 35 I": ["USMCA"], "NRG PRO I": ["PROTRA CHP solid bio CCS"]},
        ["REGIONS 35 I", "NRG PRO I"],
...
_delayfixed_delay_land_use_efficiency_protra_304 = DelayFixed(
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["USMCA", "PROTRA HP gas fuels"]),
        {"REGIONS 35 I": ["USMCA"], "NRG PRO I": ["PROTRA HP gas fuels"]},
        ["REGIONS 35 I", "NRG PRO I"],
    ),
    lambda: float(protra_lifetime().loc["USMCA", "PROTRA HP gas fuels"]),
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["USMCA", "PROTRA HP gas fuels"]),
        {"REGIONS 35 I": ["USMCA"], "NRG PRO I": ["PROTRA HP gas fuels"]},
        ["REGIONS 35 I", "NRG PRO I"],
...
_delayfixed_delay_land_use_efficiency_protra_305 = DelayFixed(
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["USMCA", "PROTRA HP solid bio"]),
        {"REGIONS 35 I": ["USMCA"], "NRG PRO I": ["PROTRA HP solid bio"]},
        ["REGIONS 35 I", "NRG PRO I"],
    ),
    lambda: float(protra_lifetime().loc["USMCA", "PROTRA HP solid bio"]),
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["USMCA", "PROTRA HP solid bio"]),
        {"REGIONS 35 I": ["USMCA"], "NRG PRO I": ["PROTRA HP solid bio"]},
        ["REGIONS 35 I", "NRG PRO I"],
...
_delayfixed_delay_land_use_efficiency_protra_306 = DelayFixed(
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["USMCA", "PROTRA HP geothermal"]),
        {"REGIONS 35 I": ["USMCA"], "NRG PRO I": ["PROTRA HP geothermal"]},
        ["REGIONS 35 I", "NRG PRO I"],
    ),
    lambda: float(protra_lifetime().loc["USMCA", "PROTRA HP geothermal"]),
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["USMCA", "PROTRA HP geothermal"]),
        {"REGIONS 35 I": ["USMCA"], "NRG PRO I": ["PROTRA HP geothermal"]},
        ["REGIONS 35 I", "NRG PRO I"],
...
_delayfixed_delay_land_use_efficiency_protra_307 = DelayFixed(
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["USMCA", "PROTRA HP liquid fuels"]),
        {"REGIONS 35 I": ["USMCA"], "NRG PRO I": ["PROTRA HP liquid fuels"]},
        ["REGIONS 35 I", "NRG PRO I"],
    ),
    lambda: float(protra_lifetime().loc["USMCA", "PROTRA HP liquid fuels"]),
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["USMCA", "PROTRA HP liquid fuels"]),
        {"REGIONS 35 I": ["USMCA"], "NRG PRO I": ["PROTRA HP liquid fuels"]},
        ["REGIONS 35 I", "NRG PRO I"],
...
_delayfixed_delay_land_use_efficiency_protra_308 = DelayFixed(
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["USMCA", "PROTRA HP solar DEACTIVATED"]),
        {"REGIONS 35 I": ["USMCA"], "NRG PRO I": ["PROTRA HP solar DEACTIVATED"]},
        ["REGIONS 35 I", "NRG PRO I"],
    ),
    lambda: float(protra_lifetime().loc["USMCA", "PROTRA HP solar DEACTIVATED"]),
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["USMCA", "PROTRA HP solar DEACTIVATED"]),
        {"REGIONS 35 I": ["USMCA"], "NRG PRO I": ["PROTRA HP solar DEACTIVATED"]},
        ["REGIONS 35 I", "NRG PRO I"],
...
_delayfixed_delay_land_use_efficiency_protra_309 = DelayFixed(
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["USMCA", "PROTRA HP solid fossil"]),
        {"REGIONS 35 I": ["USMCA"], "NRG PRO I": ["PROTRA HP solid fossil"]},
        ["REGIONS 35 I", "NRG PRO I"],
    ),
    lambda: float(protra_lifetime().loc["USMCA", "PROTRA HP solid fossil"]),
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["USMCA", "PROTRA HP solid fossil"]),
        {"REGIONS 35 I": ["USMCA"], "NRG PRO I": ["PROTRA HP solid fossil"]},
        ["REGIONS 35 I", "NRG PRO I"],
...
_delayfixed_delay_land_use_efficiency_protra_310 = DelayFixed(
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["USMCA", "PROTRA HP waste"]),
        {"REGIONS 35 I": ["USMCA"], "NRG PRO I": ["PROTRA HP waste"]},
        ["REGIONS 35 I", "NRG PRO I"],
    ),
    lambda: float(protra_lifetime().loc["USMCA", "PROTRA HP waste"]),
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["USMCA", "PROTRA HP waste"]),
        {"REGIONS 35 I": ["USMCA"], "NRG PRO I": ["PROTRA HP waste"]},
        ["REGIONS 35 I", "NRG PRO I"],
...
_delayfixed_delay_land_use_efficiency_protra_311 = DelayFixed(
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["USMCA", "PROTRA PP solid bio"]),
        {"REGIONS 35 I": ["USMCA"], "NRG PRO I": ["PROTRA PP solid bio"]},
        ["REGIONS 35 I", "NRG PRO I"],
    ),
    lambda: float(protra_lifetime().loc["USMCA", "PROTRA PP solid bio"]),
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["USMCA", "PROTRA PP solid bio"]),
        {"REGIONS 35 I": ["USMCA"], "NRG PRO I": ["PROTRA PP solid bio"]},
        ["REGIONS 35 I", "NRG PRO I"],
...
_delayfixed_delay_land_use_efficiency_protra_312 = DelayFixed(
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["USMCA", "PROTRA PP solid bio CCS"]),
        {"REGIONS 35 I": ["USMCA"], "NRG PRO I": ["PROTRA PP solid bio CCS"]},
        ["REGIONS 35 I", "NRG PRO I"],
    ),
    lambda: float(protra_lifetime().loc["USMCA", "PROTRA PP solid bio CCS"]),
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["USMCA", "PROTRA PP solid bio CCS"]),
        {"REGIONS 35 I": ["USMCA"], "NRG PRO I": ["PROTRA PP solid bio CCS"]},
        ["REGIONS 35 I", "NRG PRO I"],
...
_delayfixed_delay_land_use_efficiency_protra_313 = DelayFixed(
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["USMCA", "PROTRA PP gas fuels"]),
        {"REGIONS 35 I": ["USMCA"], "NRG PRO I": ["PROTRA PP gas fuels"]},
        ["REGIONS 35 I", "NRG PRO I"],
    ),
    lambda: float(protra_lifetime().loc["USMCA", "PROTRA PP gas fuels"]),
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["USMCA", "PROTRA PP gas fuels"]),
        {"REGIONS 35 I": ["USMCA"], "NRG PRO I": ["PROTRA PP gas fuels"]},
        ["REGIONS 35 I", "NRG PRO I"],
...
_delayfixed_delay_land_use_efficiency_protra_314 = DelayFixed(
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["USMCA", "PROTRA PP gas fuels CCS"]),
        {"REGIONS 35 I": ["USMCA"], "NRG PRO I": ["PROTRA PP gas fuels CCS"]},
        ["REGIONS 35 I", "NRG PRO I"],
    ),
    lambda: float(protra_lifetime().loc["USMCA", "PROTRA PP gas fuels CCS"]),
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["USMCA", "PROTRA PP gas fuels CCS"]),
        {"REGIONS 35 I": ["USMCA"], "NRG PRO I": ["PROTRA PP gas fuels CCS"]},
        ["REGIONS 35 I", "NRG PRO I"],
...
_delayfixed_delay_land_use_efficiency_protra_315 = DelayFixed(
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["USMCA", "PROTRA PP geothermal"]),
        {"REGIONS 35 I": ["USMCA"], "NRG PRO I": ["PROTRA PP geothermal"]},
        ["REGIONS 35 I", "NRG PRO I"],
    ),
    lambda: float(protra_lifetime().loc["USMCA", "PROTRA PP geothermal"]),
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["USMCA", "PROTRA PP geothermal"]),
        {"REGIONS 35 I": ["USMCA"], "NRG PRO I": ["PROTRA PP geothermal"]},
        ["REGIONS 35 I", "NRG PRO I"],
...
_delayfixed_delay_land_use_efficiency_protra_316 = DelayFixed(
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["USMCA", "PROTRA PP hydropower dammed"]),
        {"REGIONS 35 I": ["USMCA"], "NRG PRO I": ["PROTRA PP hydropower dammed"]},
        ["REGIONS 35 I", "NRG PRO I"],
    ),
    lambda: float(protra_lifetime().loc["USMCA", "PROTRA PP hydropower dammed"]),
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["USMCA", "PROTRA PP hydropower dammed"]),
        {"REGIONS 35 I": ["USMCA"], "NRG PRO I": ["PROTRA PP hydropower dammed"]},
        ["REGIONS 35 I", "NRG PRO I"],
...
_delayfixed_delay_land_use_efficiency_protra_317 = DelayFixed(
    lambda: xr.DataArray(
        float(
            land_use_efficiency_protra().loc[
                "USMCA", "PROTRA PP hydropower run of river"
            ]
        ),
        {"REGIONS 35 I": ["USMCA"], "NRG PRO I": ["PROTRA PP hydropower run of river"]},
        ["REGIONS 35 I", "NRG PRO I"],
    ),
    lambda: float(protra_lifetime().loc["USMCA", "PROTRA PP hydropower run of river"]),
    lambda: xr.DataArray(
        float(
            land_use_efficiency_protra().loc[
                "USMCA", "PROTRA PP hydropower run of river"
...
_delayfixed_delay_land_use_efficiency_protra_318 = DelayFixed(
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["USMCA", "PROTRA PP liquid fuels"]),
        {"REGIONS 35 I": ["USMCA"], "NRG PRO I": ["PROTRA PP liquid fuels"]},
        ["REGIONS 35 I", "NRG PRO I"],
    ),
    lambda: float(protra_lifetime().loc["USMCA", "PROTRA PP liquid fuels"]),
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["USMCA", "PROTRA PP liquid fuels"]),
        {"REGIONS 35 I": ["USMCA"], "NRG PRO I": ["PROTRA PP liquid fuels"]},
        ["REGIONS 35 I", "NRG PRO I"],
...
_delayfixed_delay_land_use_efficiency_protra_319 = DelayFixed(
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["USMCA", "PROTRA PP liquid fuels CCS"]),
        {"REGIONS 35 I": ["USMCA"], "NRG PRO I": ["PROTRA PP liquid fuels CCS"]},
        ["REGIONS 35 I", "NRG PRO I"],
    ),
    lambda: float(protra_lifetime().loc["USMCA", "PROTRA PP liquid fuels CCS"]),
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["USMCA", "PROTRA PP liquid fuels CCS"]),
        {"REGIONS 35 I": ["USMCA"], "NRG PRO I": ["PROTRA PP liquid fuels CCS"]},
        ["REGIONS 35 I", "NRG PRO I"],
...
_delayfixed_delay_land_use_efficiency_protra_320 = DelayFixed(
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["USMCA", "PROTRA PP nuclear"]),
        {"REGIONS 35 I": ["USMCA"], "NRG PRO I": ["PROTRA PP nuclear"]},
        ["REGIONS 35 I", "NRG PRO I"],
    ),
    lambda: float(protra_lifetime().loc["USMCA", "PROTRA PP nuclear"]),
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["USMCA", "PROTRA PP nuclear"]),
        {"REGIONS 35 I": ["USMCA"], "NRG PRO I": ["PROTRA PP nuclear"]},
        ["REGIONS 35 I", "NRG PRO I"],
...
_delayfixed_delay_land_use_efficiency_protra_321 = DelayFixed(
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["USMCA", "PROTRA PP oceanic"]),
        {"REGIONS 35 I": ["USMCA"], "NRG PRO I": ["PROTRA PP oceanic"]},
        ["REGIONS 35 I", "NRG PRO I"],
    ),
    lambda: float(protra_lifetime().loc["USMCA", "PROTRA PP oceanic"]),
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["USMCA", "PROTRA PP oceanic"]),
        {"REGIONS 35 I": ["USMCA"], "NRG PRO I": ["PROTRA PP oceanic"]},
        ["REGIONS 35 I", "NRG PRO I"],
...
_delayfixed_delay_land_use_efficiency_protra_322 = DelayFixed(
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["USMCA", "PROTRA PP solar CSP"]),
        {"REGIONS 35 I": ["USMCA"], "NRG PRO I": ["PROTRA PP solar CSP"]},
        ["REGIONS 35 I", "NRG PRO I"],
    ),
    lambda: float(protra_lifetime().loc["USMCA", "PROTRA PP solar CSP"]),
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["USMCA", "PROTRA PP solar CSP"]),
        {"REGIONS 35 I": ["USMCA"], "NRG PRO I": ["PROTRA PP solar CSP"]},
        ["REGIONS 35 I", "NRG PRO I"],
...
_delayfixed_delay_land_use_efficiency_protra_323 = DelayFixed(
    lambda: xr.DataArray(
        float(
            land_use_efficiency_protra().loc["USMCA", "PROTRA PP solar open space PV"]
        ),
        {"REGIONS 35 I": ["USMCA"], "NRG PRO I": ["PROTRA PP solar open space PV"]},
        ["REGIONS 35 I", "NRG PRO I"],
    ),
    lambda: float(protra_lifetime().loc["USMCA", "PROTRA PP solar open space PV"]),
    lambda: xr.DataArray(
        float(
            land_use_efficiency_protra().loc["USMCA", "PROTRA PP solar open space PV"]
        ),
...
_delayfixed_delay_land_use_efficiency_protra_324 = DelayFixed(
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["USMCA", "PROTRA PP solar urban PV"]),
        {"REGIONS 35 I": ["USMCA"], "NRG PRO I": ["PROTRA PP solar urban PV"]},
        ["REGIONS 35 I", "NRG PRO I"],
    ),
    lambda: float(protra_lifetime().loc["USMCA", "PROTRA PP solar urban PV"]),
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["USMCA", "PROTRA PP solar urban PV"]),
        {"REGIONS 35 I": ["USMCA"], "NRG PRO I": ["PROTRA PP solar urban PV"]},
        ["REGIONS 35 I", "NRG PRO I"],
...
_delayfixed_delay_land_use_efficiency_protra_325 = DelayFixed(
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["USMCA", "PROTRA PP solid fossil"]),
        {"REGIONS 35 I": ["USMCA"], "NRG PRO I": ["PROTRA PP solid fossil"]},
        ["REGIONS 35 I", "NRG PRO I"],
    ),
    lambda: float(protra_lifetime().loc["USMCA", "PROTRA PP solid fossil"]),
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["USMCA", "PROTRA PP solid fossil"]),
        {"REGIONS 35 I": ["USMCA"], "NRG PRO I": ["PROTRA PP solid fossil"]},
        ["REGIONS 35 I", "NRG PRO I"],
...
_delayfixed_delay_land_use_efficiency_protra_326 = DelayFixed(
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["USMCA", "PROTRA PP solid fossil CCS"]),
        {"REGIONS 35 I": ["USMCA"], "NRG PRO I": ["PROTRA PP solid fossil CCS"]},
        ["REGIONS 35 I", "NRG PRO I"],
    ),
    lambda: float(protra_lifetime().loc["USMCA", "PROTRA PP solid fossil CCS"]),
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["USMCA", "PROTRA PP solid fossil CCS"]),
        {"REGIONS 35 I": ["USMCA"], "NRG PRO I": ["PROTRA PP solid fossil CCS"]},
        ["REGIONS 35 I", "NRG PRO I"],
...
_delayfixed_delay_land_use_efficiency_protra_327 = DelayFixed(
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["USMCA", "PROTRA PP waste"]),
        {"REGIONS 35 I": ["USMCA"], "NRG PRO I": ["PROTRA PP waste"]},
        ["REGIONS 35 I", "NRG PRO I"],
    ),
    lambda: float(protra_lifetime().loc["USMCA", "PROTRA PP waste"]),
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["USMCA", "PROTRA PP waste"]),
        {"REGIONS 35 I": ["USMCA"], "NRG PRO I": ["PROTRA PP waste"]},
        ["REGIONS 35 I", "NRG PRO I"],
...
_delayfixed_delay_land_use_efficiency_protra_328 = DelayFixed(
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["USMCA", "PROTRA PP waste CCS"]),
        {"REGIONS 35 I": ["USMCA"], "NRG PRO I": ["PROTRA PP waste CCS"]},
        ["REGIONS 35 I", "NRG PRO I"],
    ),
    lambda: float(protra_lifetime().loc["USMCA", "PROTRA PP waste CCS"]),
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["USMCA", "PROTRA PP waste CCS"]),
        {"REGIONS 35 I": ["USMCA"], "NRG PRO I": ["PROTRA PP waste CCS"]},
        ["REGIONS 35 I", "NRG PRO I"],
...
_delayfixed_delay_land_use_efficiency_protra_329 = DelayFixed(
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["USMCA", "PROTRA PP wind offshore"]),
        {"REGIONS 35 I": ["USMCA"], "NRG PRO I": ["PROTRA PP wind offshore"]},
        ["REGIONS 35 I", "NRG PRO I"],
    ),
    lambda: float(protra_lifetime().loc["USMCA", "PROTRA PP wind offshore"]),
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["USMCA", "PROTRA PP wind offshore"]),
        {"REGIONS 35 I": ["USMCA"], "NRG PRO I": ["PROTRA PP wind offshore"]},
        ["REGIONS 35 I", "NRG PRO I"],
...
_delayfixed_delay_land_use_efficiency_protra_330 = DelayFixed(
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["USMCA", "PROTRA PP wind onshore"]),
        {"REGIONS 35 I": ["USMCA"], "NRG PRO I": ["PROTRA PP wind onshore"]},
        ["REGIONS 35 I", "NRG PRO I"],
    ),
    lambda: float(protra_lifetime().loc["USMCA", "PROTRA PP wind onshore"]),
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["USMCA", "PROTRA PP wind onshore"]),
        {"REGIONS 35 I": ["USMCA"], "NRG PRO I": ["PROTRA PP wind onshore"]},
        ["REGIONS 35 I", "NRG PRO I"],
...
_delayfixed_delay_land_use_efficiency_protra_331 = DelayFixed(
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["USMCA", "PROTRA blending gas fuels"]),
        {"REGIONS 35 I": ["USMCA"], "NRG PRO I": ["PROTRA blending gas fuels"]},
        ["REGIONS 35 I", "NRG PRO I"],
    ),
    lambda: float(protra_lifetime().loc["USMCA", "PROTRA blending gas fuels"]),
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["USMCA", "PROTRA blending gas fuels"]),
        {"REGIONS 35 I": ["USMCA"], "NRG PRO I": ["PROTRA blending gas fuels"]},
        ["REGIONS 35 I", "NRG PRO I"],
...
_delayfixed_delay_land_use_efficiency_protra_332 = DelayFixed(
    lambda: xr.DataArray(
        float(
            land_use_efficiency_protra().loc["USMCA", "PROTRA blending liquid fuels"]
        ),
        {"REGIONS 35 I": ["USMCA"], "NRG PRO I": ["PROTRA blending liquid fuels"]},
        ["REGIONS 35 I", "NRG PRO I"],
    ),
    lambda: float(protra_lifetime().loc["USMCA", "PROTRA blending liquid fuels"]),
    lambda: xr.DataArray(
        float(
            land_use_efficiency_protra().loc["USMCA", "PROTRA blending liquid fuels"]
        ),
...
_delayfixed_delay_land_use_efficiency_protra_333 = DelayFixed(
    lambda: xr.DataArray(
        float(
            land_use_efficiency_protra().loc["USMCA", "PROTRA no process TI hydrogen"]
        ),
        {"REGIONS 35 I": ["USMCA"], "NRG PRO I": ["PROTRA no process TI hydrogen"]},
        ["REGIONS 35 I", "NRG PRO I"],
    ),
    lambda: float(protra_lifetime().loc["USMCA", "PROTRA no process TI hydrogen"]),
    lambda: xr.DataArray(
        float(
            land_use_efficiency_protra().loc["USMCA", "PROTRA no process TI hydrogen"]
        ),
...
_delayfixed_delay_land_use_efficiency_protra_334 = DelayFixed(
    lambda: xr.DataArray(
        float(
            land_use_efficiency_protra().loc["USMCA", "PROTRA no process TI solid bio"]
        ),
        {"REGIONS 35 I": ["USMCA"], "NRG PRO I": ["PROTRA no process TI solid bio"]},
        ["REGIONS 35 I", "NRG PRO I"],
    ),
    lambda: float(protra_lifetime().loc["USMCA", "PROTRA no process TI solid bio"]),
    lambda: xr.DataArray(
        float(
            land_use_efficiency_protra().loc["USMCA", "PROTRA no process TI solid bio"]
        ),
...
_delayfixed_delay_land_use_efficiency_protra_335 = DelayFixed(
    lambda: xr.DataArray(
        float(
            land_use_efficiency_protra().loc[
                "USMCA", "PROTRA no process TI solid fossil"
            ]
        ),
        {"REGIONS 35 I": ["USMCA"], "NRG PRO I": ["PROTRA no process TI solid fossil"]},
        ["REGIONS 35 I", "NRG PRO I"],
    ),
    lambda: float(protra_lifetime().loc["USMCA", "PROTRA no process TI solid fossil"]),
    lambda: xr.DataArray(
        float(
            land_use_efficiency_protra().loc[
                "USMCA", "PROTRA no process TI solid fossil"
...
_delayfixed_delay_land_use_efficiency_protra_336 = DelayFixed(
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["LROW", "PROTRA CHP gas fuels"]),
        {"REGIONS 35 I": ["LROW"], "NRG PRO I": ["PROTRA CHP gas fuels"]},
        ["REGIONS 35 I", "NRG PRO I"],
    ),
    lambda: float(protra_lifetime().loc["LROW", "PROTRA CHP gas fuels"]),
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["LROW", "PROTRA CHP gas fuels"]),
        {"REGIONS 35 I": ["LROW"], "NRG PRO I": ["PROTRA CHP gas fuels"]},
        ["REGIONS 35 I", "NRG PRO I"],
...
_delayfixed_delay_land_use_efficiency_protra_337 = DelayFixed(
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["LROW", "PROTRA CHP gas fuels CCS"]),
        {"REGIONS 35 I": ["LROW"], "NRG PRO I": ["PROTRA CHP gas fuels CCS"]},
        ["REGIONS 35 I", "NRG PRO I"],
    ),
    lambda: float(protra_lifetime().loc["LROW", "PROTRA CHP gas fuels CCS"]),
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["LROW", "PROTRA CHP gas fuels CCS"]),
        {"REGIONS 35 I": ["LROW"], "NRG PRO I": ["PROTRA CHP gas fuels CCS"]},
        ["REGIONS 35 I", "NRG PRO I"],
...
_delayfixed_delay_land_use_efficiency_protra_338 = DelayFixed(
    lambda: xr.DataArray(
        float(
            land_use_efficiency_protra().loc[
                "LROW", "PROTRA CHP geothermal DEACTIVATED"
            ]
        ),
        {"REGIONS 35 I": ["LROW"], "NRG PRO I": ["PROTRA CHP geothermal DEACTIVATED"]},
        ["REGIONS 35 I", "NRG PRO I"],
    ),
    lambda: float(protra_lifetime().loc["LROW", "PROTRA CHP geothermal DEACTIVATED"]),
    lambda: xr.DataArray(
        float(
            land_use_efficiency_protra().loc[
                "LROW", "PROTRA CHP geothermal DEACTIVATED"
...
_delayfixed_delay_land_use_efficiency_protra_339 = DelayFixed(
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["LROW", "PROTRA CHP liquid fuels"]),
        {"REGIONS 35 I": ["LROW"], "NRG PRO I": ["PROTRA CHP liquid fuels"]},
        ["REGIONS 35 I", "NRG PRO I"],
    ),
    lambda: float(protra_lifetime().loc["LROW", "PROTRA CHP liquid fuels"]),
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["LROW", "PROTRA CHP liquid fuels"]),
        {"REGIONS 35 I": ["LROW"], "NRG PRO I": ["PROTRA CHP liquid fuels"]},
        ["REGIONS 35 I", "NRG PRO I"],
...
_delayfixed_delay_land_use_efficiency_protra_340 = DelayFixed(
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["LROW", "PROTRA CHP liquid fuels CCS"]),
        {"REGIONS 35 I": ["LROW"], "NRG PRO I": ["PROTRA CHP liquid fuels CCS"]},
        ["REGIONS 35 I", "NRG PRO I"],
    ),
    lambda: float(protra_lifetime().loc["LROW", "PROTRA CHP liquid fuels CCS"]),
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["LROW", "PROTRA CHP liquid fuels CCS"]),
        {"REGIONS 35 I": ["LROW"], "NRG PRO I": ["PROTRA CHP liquid fuels CCS"]},
        ["REGIONS 35 I", "NRG PRO I"],
...
_delayfixed_delay_land_use_efficiency_protra_341 = DelayFixed(
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["LROW", "PROTRA CHP solid fossil"]),
        {"REGIONS 35 I": ["LROW"], "NRG PRO I": ["PROTRA CHP solid fossil"]},
        ["REGIONS 35 I", "NRG PRO I"],
    ),
    lambda: float(protra_lifetime().loc["LROW", "PROTRA CHP solid fossil"]),
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["LROW", "PROTRA CHP solid fossil"]),
        {"REGIONS 35 I": ["LROW"], "NRG PRO I": ["PROTRA CHP solid fossil"]},
        ["REGIONS 35 I", "NRG PRO I"],
...
_delayfixed_delay_land_use_efficiency_protra_342 = DelayFixed(
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["LROW", "PROTRA CHP solid fossil CCS"]),
        {"REGIONS 35 I": ["LROW"], "NRG PRO I": ["PROTRA CHP solid fossil CCS"]},
        ["REGIONS 35 I", "NRG PRO I"],
    ),
    lambda: float(protra_lifetime().loc["LROW", "PROTRA CHP solid fossil CCS"]),
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["LROW", "PROTRA CHP solid fossil CCS"]),
        {"REGIONS 35 I": ["LROW"], "NRG PRO I": ["PROTRA CHP solid fossil CCS"]},
        ["REGIONS 35 I", "NRG PRO I"],
...
_delayfixed_delay_land_use_efficiency_protra_343 = DelayFixed(
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["LROW", "PROTRA CHP waste"]),
        {"REGIONS 35 I": ["LROW"], "NRG PRO I": ["PROTRA CHP waste"]},
        ["REGIONS 35 I", "NRG PRO I"],
    ),
    lambda: float(protra_lifetime().loc["LROW", "PROTRA CHP waste"]),
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["LROW", "PROTRA CHP waste"]),
        {"REGIONS 35 I": ["LROW"], "NRG PRO I": ["PROTRA CHP waste"]},
        ["REGIONS 35 I", "NRG PRO I"],
...
_delayfixed_delay_land_use_efficiency_protra_344 = DelayFixed(
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["LROW", "PROTRA CHP solid bio"]),
        {"REGIONS 35 I": ["LROW"], "NRG PRO I": ["PROTRA CHP solid bio"]},
        ["REGIONS 35 I", "NRG PRO I"],
    ),
    lambda: float(protra_lifetime().loc["LROW", "PROTRA CHP solid bio"]),
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["LROW", "PROTRA CHP solid bio"]),
        {"REGIONS 35 I": ["LROW"], "NRG PRO I": ["PROTRA CHP solid bio"]},
        ["REGIONS 35 I", "NRG PRO I"],
...
_delayfixed_delay_land_use_efficiency_protra_345 = DelayFixed(
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["LROW", "PROTRA CHP solid bio CCS"]),
        {"REGIONS 35 I": ["LROW"], "NRG PRO I": ["PROTRA CHP solid bio CCS"]},
        ["REGIONS 35 I", "NRG PRO I"],
    ),
    lambda: float(protra_lifetime().loc["LROW", "PROTRA CHP solid bio CCS"]),
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["LROW", "PROTRA CHP solid bio CCS"]),
        {"REGIONS 35 I": ["LROW"], "NRG PRO I": ["PROTRA CHP solid bio CCS"]},
        ["REGIONS 35 I", "NRG PRO I"],
...
_delayfixed_delay_land_use_efficiency_protra_346 = DelayFixed(
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["LROW", "PROTRA HP gas fuels"]),
        {"REGIONS 35 I": ["LROW"], "NRG PRO I": ["PROTRA HP gas fuels"]},
        ["REGIONS 35 I", "NRG PRO I"],
    ),
    lambda: float(protra_lifetime().loc["LROW", "PROTRA HP gas fuels"]),
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["LROW", "PROTRA HP gas fuels"]),
        {"REGIONS 35 I": ["LROW"], "NRG PRO I": ["PROTRA HP gas fuels"]},
        ["REGIONS 35 I", "NRG PRO I"],
...
_delayfixed_delay_land_use_efficiency_protra_347 = DelayFixed(
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["LROW", "PROTRA HP solid bio"]),
        {"REGIONS 35 I": ["LROW"], "NRG PRO I": ["PROTRA HP solid bio"]},
        ["REGIONS 35 I", "NRG PRO I"],
    ),
    lambda: float(protra_lifetime().loc["LROW", "PROTRA HP solid bio"]),
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["LROW", "PROTRA HP solid bio"]),
        {"REGIONS 35 I": ["LROW"], "NRG PRO I": ["PROTRA HP solid bio"]},
        ["REGIONS 35 I", "NRG PRO I"],
...
_delayfixed_delay_land_use_efficiency_protra_348 = DelayFixed(
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["LROW", "PROTRA HP geothermal"]),
        {"REGIONS 35 I": ["LROW"], "NRG PRO I": ["PROTRA HP geothermal"]},
        ["REGIONS 35 I", "NRG PRO I"],
    ),
    lambda: float(protra_lifetime().loc["LROW", "PROTRA HP geothermal"]),
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["LROW", "PROTRA HP geothermal"]),
        {"REGIONS 35 I": ["LROW"], "NRG PRO I": ["PROTRA HP geothermal"]},
        ["REGIONS 35 I", "NRG PRO I"],
...
_delayfixed_delay_land_use_efficiency_protra_349 = DelayFixed(
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["LROW", "PROTRA HP liquid fuels"]),
        {"REGIONS 35 I": ["LROW"], "NRG PRO I": ["PROTRA HP liquid fuels"]},
        ["REGIONS 35 I", "NRG PRO I"],
    ),
    lambda: float(protra_lifetime().loc["LROW", "PROTRA HP liquid fuels"]),
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["LROW", "PROTRA HP liquid fuels"]),
        {"REGIONS 35 I": ["LROW"], "NRG PRO I": ["PROTRA HP liquid fuels"]},
        ["REGIONS 35 I", "NRG PRO I"],
...
_delayfixed_delay_land_use_efficiency_protra_350 = DelayFixed(
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["LROW", "PROTRA HP solar DEACTIVATED"]),
        {"REGIONS 35 I": ["LROW"], "NRG PRO I": ["PROTRA HP solar DEACTIVATED"]},
        ["REGIONS 35 I", "NRG PRO I"],
    ),
    lambda: float(protra_lifetime().loc["LROW", "PROTRA HP solar DEACTIVATED"]),
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["LROW", "PROTRA HP solar DEACTIVATED"]),
        {"REGIONS 35 I": ["LROW"], "NRG PRO I": ["PROTRA HP solar DEACTIVATED"]},
        ["REGIONS 35 I", "NRG PRO I"],
...
_delayfixed_delay_land_use_efficiency_protra_351 = DelayFixed(
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["LROW", "PROTRA HP solid fossil"]),
        {"REGIONS 35 I": ["LROW"], "NRG PRO I": ["PROTRA HP solid fossil"]},
        ["REGIONS 35 I", "NRG PRO I"],
    ),
    lambda: float(protra_lifetime().loc["LROW", "PROTRA HP solid fossil"]),
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["LROW", "PROTRA HP solid fossil"]),
        {"REGIONS 35 I": ["LROW"], "NRG PRO I": ["PROTRA HP solid fossil"]},
        ["REGIONS 35 I", "NRG PRO I"],
...
_delayfixed_delay_land_use_efficiency_protra_352 = DelayFixed(
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["LROW", "PROTRA HP waste"]),
        {"REGIONS 35 I": ["LROW"], "NRG PRO I": ["PROTRA HP waste"]},
        ["REGIONS 35 I", "NRG PRO I"],
    ),
    lambda: float(protra_lifetime().loc["LROW", "PROTRA HP waste"]),
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["LROW", "PROTRA HP waste"]),
        {"REGIONS 35 I": ["LROW"], "NRG PRO I": ["PROTRA HP waste"]},
        ["REGIONS 35 I", "NRG PRO I"],
...
_delayfixed_delay_land_use_efficiency_protra_353 = DelayFixed(
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["LROW", "PROTRA PP solid bio"]),
        {"REGIONS 35 I": ["LROW"], "NRG PRO I": ["PROTRA PP solid bio"]},
        ["REGIONS 35 I", "NRG PRO I"],
    ),
    lambda: float(protra_lifetime().loc["LROW", "PROTRA PP solid bio"]),
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["LROW", "PROTRA PP solid bio"]),
        {"REGIONS 35 I": ["LROW"], "NRG PRO I": ["PROTRA PP solid bio"]},
        ["REGIONS 35 I", "NRG PRO I"],
...
_delayfixed_delay_land_use_efficiency_protra_354 = DelayFixed(
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["LROW", "PROTRA PP solid bio CCS"]),
        {"REGIONS 35 I": ["LROW"], "NRG PRO I": ["PROTRA PP solid bio CCS"]},
        ["REGIONS 35 I", "NRG PRO I"],
    ),
    lambda: float(protra_lifetime().loc["LROW", "PROTRA PP solid bio CCS"]),
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["LROW", "PROTRA PP solid bio CCS"]),
        {"REGIONS 35 I": ["LROW"], "NRG PRO I": ["PROTRA PP solid bio CCS"]},
        ["REGIONS 35 I", "NRG PRO I"],
...
_delayfixed_delay_land_use_efficiency_protra_355 = DelayFixed(
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["LROW", "PROTRA PP gas fuels"]),
        {"REGIONS 35 I": ["LROW"], "NRG PRO I": ["PROTRA PP gas fuels"]},
        ["REGIONS 35 I", "NRG PRO I"],
    ),
    lambda: float(protra_lifetime().loc["LROW", "PROTRA PP gas fuels"]),
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["LROW", "PROTRA PP gas fuels"]),
        {"REGIONS 35 I": ["LROW"], "NRG PRO I": ["PROTRA PP gas fuels"]},
        ["REGIONS 35 I", "NRG PRO I"],
...
_delayfixed_delay_land_use_efficiency_protra_356 = DelayFixed(
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["LROW", "PROTRA PP gas fuels CCS"]),
        {"REGIONS 35 I": ["LROW"], "NRG PRO I": ["PROTRA PP gas fuels CCS"]},
        ["REGIONS 35 I", "NRG PRO I"],
    ),
    lambda: float(protra_lifetime().loc["LROW", "PROTRA PP gas fuels CCS"]),
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["LROW", "PROTRA PP gas fuels CCS"]),
        {"REGIONS 35 I": ["LROW"], "NRG PRO I": ["PROTRA PP gas fuels CCS"]},
        ["REGIONS 35 I", "NRG PRO I"],
...
_delayfixed_delay_land_use_efficiency_protra_357 = DelayFixed(
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["LROW", "PROTRA PP geothermal"]),
        {"REGIONS 35 I": ["LROW"], "NRG PRO I": ["PROTRA PP geothermal"]},
        ["REGIONS 35 I", "NRG PRO I"],
    ),
    lambda: float(protra_lifetime().loc["LROW", "PROTRA PP geothermal"]),
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["LROW", "PROTRA PP geothermal"]),
        {"REGIONS 35 I": ["LROW"], "NRG PRO I": ["PROTRA PP geothermal"]},
        ["REGIONS 35 I", "NRG PRO I"],
...
_delayfixed_delay_land_use_efficiency_protra_358 = DelayFixed(
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["LROW", "PROTRA PP hydropower dammed"]),
        {"REGIONS 35 I": ["LROW"], "NRG PRO I": ["PROTRA PP hydropower dammed"]},
        ["REGIONS 35 I", "NRG PRO I"],
    ),
    lambda: float(protra_lifetime().loc["LROW", "PROTRA PP hydropower dammed"]),
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["LROW", "PROTRA PP hydropower dammed"]),
        {"REGIONS 35 I": ["LROW"], "NRG PRO I": ["PROTRA PP hydropower dammed"]},
        ["REGIONS 35 I", "NRG PRO I"],
...
_delayfixed_delay_land_use_efficiency_protra_359 = DelayFixed(
    lambda: xr.DataArray(
        float(
            land_use_efficiency_protra().loc[
                "LROW", "PROTRA PP hydropower run of river"
            ]
        ),
        {"REGIONS 35 I": ["LROW"], "NRG PRO I": ["PROTRA PP hydropower run of river"]},
        ["REGIONS 35 I", "NRG PRO I"],
    ),
    lambda: float(protra_lifetime().loc["LROW", "PROTRA PP hydropower run of river"]),
    lambda: xr.DataArray(
        float(
            land_use_efficiency_protra().loc[
                "LROW", "PROTRA PP hydropower run of river"
...
_delayfixed_delay_land_use_efficiency_protra_360 = DelayFixed(
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["LROW", "PROTRA PP liquid fuels"]),
        {"REGIONS 35 I": ["LROW"], "NRG PRO I": ["PROTRA PP liquid fuels"]},
        ["REGIONS 35 I", "NRG PRO I"],
    ),
    lambda: float(protra_lifetime().loc["LROW", "PROTRA PP liquid fuels"]),
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["LROW", "PROTRA PP liquid fuels"]),
        {"REGIONS 35 I": ["LROW"], "NRG PRO I": ["PROTRA PP liquid fuels"]},
        ["REGIONS 35 I", "NRG PRO I"],
...
_delayfixed_delay_land_use_efficiency_protra_361 = DelayFixed(
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["LROW", "PROTRA PP liquid fuels CCS"]),
        {"REGIONS 35 I": ["LROW"], "NRG PRO I": ["PROTRA PP liquid fuels CCS"]},
        ["REGIONS 35 I", "NRG PRO I"],
    ),
    lambda: float(protra_lifetime().loc["LROW", "PROTRA PP liquid fuels CCS"]),
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["LROW", "PROTRA PP liquid fuels CCS"]),
        {"REGIONS 35 I": ["LROW"], "NRG PRO I": ["PROTRA PP liquid fuels CCS"]},
        ["REGIONS 35 I", "NRG PRO I"],
...
_delayfixed_delay_land_use_efficiency_protra_362 = DelayFixed(
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["LROW", "PROTRA PP nuclear"]),
        {"REGIONS 35 I": ["LROW"], "NRG PRO I": ["PROTRA PP nuclear"]},
        ["REGIONS 35 I", "NRG PRO I"],
    ),
    lambda: float(protra_lifetime().loc["LROW", "PROTRA PP nuclear"]),
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["LROW", "PROTRA PP nuclear"]),
        {"REGIONS 35 I": ["LROW"], "NRG PRO I": ["PROTRA PP nuclear"]},
        ["REGIONS 35 I", "NRG PRO I"],
...
_delayfixed_delay_land_use_efficiency_protra_363 = DelayFixed(
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["LROW", "PROTRA PP oceanic"]),
        {"REGIONS 35 I": ["LROW"], "NRG PRO I": ["PROTRA PP oceanic"]},
        ["REGIONS 35 I", "NRG PRO I"],
    ),
    lambda: float(protra_lifetime().loc["LROW", "PROTRA PP oceanic"]),
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["LROW", "PROTRA PP oceanic"]),
        {"REGIONS 35 I": ["LROW"], "NRG PRO I": ["PROTRA PP oceanic"]},
        ["REGIONS 35 I", "NRG PRO I"],
...
_delayfixed_delay_land_use_efficiency_protra_364 = DelayFixed(
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["LROW", "PROTRA PP solar CSP"]),
        {"REGIONS 35 I": ["LROW"], "NRG PRO I": ["PROTRA PP solar CSP"]},
        ["REGIONS 35 I", "NRG PRO I"],
    ),
    lambda: float(protra_lifetime().loc["LROW", "PROTRA PP solar CSP"]),
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["LROW", "PROTRA PP solar CSP"]),
        {"REGIONS 35 I": ["LROW"], "NRG PRO I": ["PROTRA PP solar CSP"]},
        ["REGIONS 35 I", "NRG PRO I"],
...
_delayfixed_delay_land_use_efficiency_protra_365 = DelayFixed(
    lambda: xr.DataArray(
        float(
            land_use_efficiency_protra().loc["LROW", "PROTRA PP solar open space PV"]
        ),
        {"REGIONS 35 I": ["LROW"], "NRG PRO I": ["PROTRA PP solar open space PV"]},
        ["REGIONS 35 I", "NRG PRO I"],
    ),
    lambda: float(protra_lifetime().loc["LROW", "PROTRA PP solar open space PV"]),
    lambda: xr.DataArray(
        float(
            land_use_efficiency_protra().loc["LROW", "PROTRA PP solar open space PV"]
        ),
...
_delayfixed_delay_land_use_efficiency_protra_366 = DelayFixed(
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["LROW", "PROTRA PP solar urban PV"]),
        {"REGIONS 35 I": ["LROW"], "NRG PRO I": ["PROTRA PP solar urban PV"]},
        ["REGIONS 35 I", "NRG PRO I"],
    ),
    lambda: float(protra_lifetime().loc["LROW", "PROTRA PP solar urban PV"]),
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["LROW", "PROTRA PP solar urban PV"]),
        {"REGIONS 35 I": ["LROW"], "NRG PRO I": ["PROTRA PP solar urban PV"]},
        ["REGIONS 35 I", "NRG PRO I"],
...
_delayfixed_delay_land_use_efficiency_protra_367 = DelayFixed(
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["LROW", "PROTRA PP solid fossil"]),
        {"REGIONS 35 I": ["LROW"], "NRG PRO I": ["PROTRA PP solid fossil"]},
        ["REGIONS 35 I", "NRG PRO I"],
    ),
    lambda: float(protra_lifetime().loc["LROW", "PROTRA PP solid fossil"]),
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["LROW", "PROTRA PP solid fossil"]),
        {"REGIONS 35 I": ["LROW"], "NRG PRO I": ["PROTRA PP solid fossil"]},
        ["REGIONS 35 I", "NRG PRO I"],
...
_delayfixed_delay_land_use_efficiency_protra_368 = DelayFixed(
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["LROW", "PROTRA PP solid fossil CCS"]),
        {"REGIONS 35 I": ["LROW"], "NRG PRO I": ["PROTRA PP solid fossil CCS"]},
        ["REGIONS 35 I", "NRG PRO I"],
    ),
    lambda: float(protra_lifetime().loc["LROW", "PROTRA PP solid fossil CCS"]),
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["LROW", "PROTRA PP solid fossil CCS"]),
        {"REGIONS 35 I": ["LROW"], "NRG PRO I": ["PROTRA PP solid fossil CCS"]},
        ["REGIONS 35 I", "NRG PRO I"],
...
_delayfixed_delay_land_use_efficiency_protra_369 = DelayFixed(
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["LROW", "PROTRA PP waste"]),
        {"REGIONS 35 I": ["LROW"], "NRG PRO I": ["PROTRA PP waste"]},
        ["REGIONS 35 I", "NRG PRO I"],
    ),
    lambda: float(protra_lifetime().loc["LROW", "PROTRA PP waste"]),
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["LROW", "PROTRA PP waste"]),
        {"REGIONS 35 I": ["LROW"], "NRG PRO I": ["PROTRA PP waste"]},
        ["REGIONS 35 I", "NRG PRO I"],
...
_delayfixed_delay_land_use_efficiency_protra_370 = DelayFixed(
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["LROW", "PROTRA PP waste CCS"]),
        {"REGIONS 35 I": ["LROW"], "NRG PRO I": ["PROTRA PP waste CCS"]},
        ["REGIONS 35 I", "NRG PRO I"],
    ),
    lambda: float(protra_lifetime().loc["LROW", "PROTRA PP waste CCS"]),
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["LROW", "PROTRA PP waste CCS"]),
        {"REGIONS 35 I": ["LROW"], "NRG PRO I": ["PROTRA PP waste CCS"]},
        ["REGIONS 35 I", "NRG PRO I"],
...
_delayfixed_delay_land_use_efficiency_protra_371 = DelayFixed(
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["LROW", "PROTRA PP wind offshore"]),
        {"REGIONS 35 I": ["LROW"], "NRG PRO I": ["PROTRA PP wind offshore"]},
        ["REGIONS 35 I", "NRG PRO I"],
    ),
    lambda: float(protra_lifetime().loc["LROW", "PROTRA PP wind offshore"]),
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["LROW", "PROTRA PP wind offshore"]),
        {"REGIONS 35 I": ["LROW"], "NRG PRO I": ["PROTRA PP wind offshore"]},
        ["REGIONS 35 I", "NRG PRO I"],
...
_delayfixed_delay_land_use_efficiency_protra_372 = DelayFixed(
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["LROW", "PROTRA PP wind onshore"]),
        {"REGIONS 35 I": ["LROW"], "NRG PRO I": ["PROTRA PP wind onshore"]},
        ["REGIONS 35 I", "NRG PRO I"],
    ),
    lambda: float(protra_lifetime().loc["LROW", "PROTRA PP wind onshore"]),
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["LROW", "PROTRA PP wind onshore"]),
        {"REGIONS 35 I": ["LROW"], "NRG PRO I": ["PROTRA PP wind onshore"]},
        ["REGIONS 35 I", "NRG PRO I"],
...
_delayfixed_delay_land_use_efficiency_protra_373 = DelayFixed(
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["LROW", "PROTRA blending gas fuels"]),
        {"REGIONS 35 I": ["LROW"], "NRG PRO I": ["PROTRA blending gas fuels"]},
        ["REGIONS 35 I", "NRG PRO I"],
    ),
    lambda: float(protra_lifetime().loc["LROW", "PROTRA blending gas fuels"]),
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["LROW", "PROTRA blending gas fuels"]),
        {"REGIONS 35 I": ["LROW"], "NRG PRO I": ["PROTRA blending gas fuels"]},
        ["REGIONS 35 I", "NRG PRO I"],
...
_delayfixed_delay_land_use_efficiency_protra_374 = DelayFixed(
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["LROW", "PROTRA blending liquid fuels"]),
        {"REGIONS 35 I": ["LROW"], "NRG PRO I": ["PROTRA blending liquid fuels"]},
        ["REGIONS 35 I", "NRG PRO I"],
    ),
    lambda: float(protra_lifetime().loc["LROW", "PROTRA blending liquid fuels"]),
    lambda: xr.DataArray(
        float(land_use_efficiency_protra().loc["LROW", "PROTRA blending liquid fuels"]),
        {"REGIONS 35 I": ["LROW"], "NRG PRO I": ["PROTRA blending liquid fuels"]},
        ["REGIONS 35 I", "NRG PRO I"],
...
_delayfixed_delay_land_use_efficiency_protra_375 = DelayFixed(
    lambda: xr.DataArray(
        float(
            land_use_efficiency_protra().loc["LROW", "PROTRA no process TI hydrogen"]
        ),
        {"REGIONS 35 I": ["LROW"], "NRG PRO I": ["PROTRA no process TI hydrogen"]},
        ["REGIONS 35 I", "NRG PRO I"],
    ),
    lambda: float(protra_lifetime().loc["LROW", "PROTRA no process TI hydrogen"]),
    lambda: xr.DataArray(
        float(
            land_use_efficiency_protra().loc["LROW", "PROTRA no process TI hydrogen"]
        ),
...
_delayfixed_delay_land_use_efficiency_protra_376 = DelayFixed(
    lambda: xr.DataArray(
        float(
            land_use_efficiency_protra().loc["LROW", "PROTRA no process TI solid bio"]
        ),
        {"REGIONS 35 I": ["LROW"], "NRG PRO I": ["PROTRA no process TI solid bio"]},
        ["REGIONS 35 I", "NRG PRO I"],
    ),
    lambda: float(protra_lifetime().loc["LROW", "PROTRA no process TI solid bio"]),
    lambda: xr.DataArray(
        float(
            land_use_efficiency_protra().loc["LROW", "PROTRA no process TI solid bio"]
        ),
...
_delayfixed_delay_land_use_efficiency_protra_377 = DelayFixed(
    lambda: xr.DataArray(
        float(
            land_use_efficiency_protra().loc[
                "LROW", "PROTRA no process TI solid fossil"
            ]
        ),
        {"REGIONS 35 I": ["LROW"], "NRG PRO I": ["PROTRA no process TI solid fossil"]},
        ["REGIONS 35 I", "NRG PRO I"],
    ),
    lambda: float(protra_lifetime().loc["LROW", "PROTRA no process TI solid fossil"]),
    lambda: xr.DataArray(
        float(
            land_use_efficiency_protra().loc[
                "LROW", "PROTRA no process TI solid fossil"
...
@component.add(
    name="INITIAL TOTAL LAND PROTRA",
    units="km2",
    subscripts=["NRG PROTRA I", "REGIONS 9 I"],
    comp_type="Auxiliary",
    comp_subtype="Normal",
    depends_on={
...
def initial_total_land_protra():
    ...
    ).transpose("NRG PROTRA I", "REGIONS 9 I")


@component.add(
    name="land decommissioned PROTRA",
    units="km2/Year",
...
@component.add(
    name="LAND USE EFFICIENCY EXOGENOUS PROTRA",
    units="MW/km2",
...
@component.add(
    name="LAND USE EFFICIENCY EXOGENOUS PROTRA HIGH",
    units="MW/km2",
    subscripts=["NRG PROTRA I"],
    comp_type="Constant",
    comp_subtype="External",
...
@component.add(
    name="LAND USE EFFICIENCY EXOGENOUS PROTRA LOW",
    units="MW/km2",
    subscripts=["NRG PROTRA I"],
    comp_type="Constant",
    comp_subtype="External",
...
@component.add(
    name="LAND USE EFFICIENCY EXOGENOUS PROTRA MEDIUM",
    units="MW/km2",
    subscripts=["NRG PROTRA I"],
    comp_type="Constant",
    comp_subtype="External",
...
@component.add(
    name="land use efficiency PROTRA",
    units="MW/km2",
    subscripts=["REGIONS 9 I", "NRG PROTRA I"],
    comp_type="Auxiliary",
    comp_subtype="Normal",
...
@component.add(
    name="LAND USE EFFICIENCY WIND FARM AREA",
    units="MW/km2",
    subscripts=["PROTRA WIND I"],
    comp_type="Auxiliary",
    comp_subtype="Normal",
    depends_on={
        "select_land_use_efficiency_exogenous_protra": 2,
...
@component.add(
    name="LAND USE EFFICIENCY WIND FARM AREA HIGH",
    units="MW/km2",
    subscripts=["PROTRA WIND I"],
    comp_type="Constant",
    comp_subtype="External",
...
@component.add(
    name="LAND USE EFFICIENCY WIND FARM AREA LOW",
    units="MW/km2",
    subscripts=["PROTRA WIND I"],
    comp_type="Constant",
    comp_subtype="External",
...
@component.add(
    name="LAND USE EFFICIENCY WIND FARM AREA MEDIUM",
    units="MW/km2",
    subscripts=["PROTRA WIND I"],
    comp_type="Constant",
    comp_subtype="External",
...
@component.add(
    name="LUE solar PV by technology",
    units="MW/km2",
...
def lue_solar_pv_by_technology():
    ...
    ).transpose("REGIONS 36 I", "PROTRA PP SOLAR PV SUBTECHNOLOGIES I")


@component.add(
    name="net new land requirements PROTRA on built up land",
    units="km2/Year",
    subscripts=["REGIONS 9 I"],
    comp_type="Auxiliary",
    comp_subtype="Normal",
...
def net_new_land_requirements_protra_on_built_up_land():
    ...
    return sum(
        ...
        .loc[:, :, _subscript_dict["PROTRA BUILT UP LAND I"]]
        .rename({"NRG TO I": "NRG TO I!", "NRG PROTRA I": "PROTRA BUILT UP LAND I!"}),
        dim=["NRG TO I!", "PROTRA BUILT UP LAND I!"],
    ) - sum(
...
@component.add(
    name="net new land requirements solar on land",
    units="km2/Year",
    subscripts=["REGIONS 9 I"],
    comp_type="Auxiliary",
    comp_subtype="Normal",
...
@component.add(
    name="new land requirements PROTRA",
    units="km2/Year",
    subscripts=["REGIONS 9 I", "NRG TO I", "NRG PROTRA I"],
    comp_type="Auxiliary",
    comp_subtype="Normal",
...
@component.add(
    name="PV GENERATOR TO SYSTEM AREA RATIO",
    units="DMNL",
    comp_type="Constant",
    comp_subtype="External",
...
@component.add(
    name="SELECT LAND USE EFFICIENCY EXOGENOUS PROTRA",
    units="DMNL",
    comp_type="Constant",
    comp_subtype="External",
    depends_on={
...
@component.add(
    name="total sea area use PROTRA",
    units="km2",
    subscripts=["REGIONS 9 I"],
    comp_type="Auxiliary",
    comp_subtype="Normal",
...
def total_sea_area_use_protra():
    ...
    return land_use_by_protra().loc[
        :, "TO elec", "PROTRA PP wind offshore"
    ].reset_coords(drop=True) + land_use_by_protra().loc[
        :, "TO elec", "PROTRA PP oceanic"
    ].reset_coords(
        drop=True
    )
...
@component.add(
    name="wind farm area",
    units="km2",
    subscripts=["REGIONS 9 I", "PROTRA WIND I"],
    comp_type="Auxiliary",
    comp_subtype="Normal",
    depends_on={
        "protra_operative_capacity_stock_selected": 1,
