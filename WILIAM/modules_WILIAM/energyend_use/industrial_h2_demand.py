...
@component.add(
    name="FERTILIZER TO AMMONIA INTENSITY",
    units="tonnes/tonnes",
    subscripts=["REGIONS 9 I"],
    comp_type="Constant",
    comp_subtype="External",
...
@component.add(
    name="H2 demand to produce ammonia",
    units="tonnes/Year",
    subscripts=["REGIONS 9 I"],
    comp_type="Auxiliary",
    comp_subtype="Normal",
...
@component.add(
    name="H2 INTENSITY AMMONIA PRODUCTION",
    units="tonnes/tonnes",
    comp_type="Constant",
    comp_subtype="External",
...
@component.add(
    name="H2 INTENSITY OIL REFINING",
    units="tonnes/toe",
    comp_type="Constant",
    comp_subtype="External",
...
@component.add(
    name="H2 total demand in tonnes",
    units="tonnes/Year",
    subscripts=["REGIONS 9 I"],
    comp_type="Auxiliary",
    comp_subtype="Normal",
...
@component.add(
    name="H2 total demand LHV basis",
    units="TJ/Year",
    subscripts=["REGIONS 9 I"],
    comp_type="Auxiliary",
    comp_subtype="Normal",
...
def pe_oil_demand():
    ...
    """
    return pe_by_commodity().loc[:, "PE oil"].reset_coords(drop=True)


@component.add(
    name="PE OIL DEMAND 2005",
    units="EJ/Year",
    subscripts=["REGIONS 9 I"],
    comp_type="Constant",
    comp_subtype="External",
